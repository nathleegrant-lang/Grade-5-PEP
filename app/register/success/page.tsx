        ...
        <div className="w-full max-w-2xl overflow-hidden rounded-2xl border border-sky-200 bg-white shadow-sm">
          <div className="bg-[#072247] px-6 py-10 flex justify-center">
            <div className="rounded-xl bg-white p-4 shadow-lg">
              <Image src="/images/pep-practice-grade5-primary.jpg" alt="PEP PRACTICE Grade 5 — Practice, Review, Confidence" width={700} height={251} className="h-auto w-[280px] object-contain" priority />
            </div>
          </div>

          <div className="px-6 py-10 text-center">
            <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-sky-100">
              <MailCheck className="h-10 w-10 text-sky-700" />
            </div>
            ...
            <p className="mx-auto max-w-xl text-lg leading-8 text-slate-600">
              If this registration can be completed, we&apos;ll send the next step to the email address you provided. Please check your inbox and spam/junk folder.
            </p>
            <p className="mx-auto mt-4 max-w-xl text-sm leading-6 text-slate-500">
              For privacy, this page does not confirm whether an account already exists or whether an email address has already been confirmed.
            </p>
