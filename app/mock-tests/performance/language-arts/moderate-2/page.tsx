        ...
        <main className="container mx-auto px-4 py-10">
          ...
          <Card className="mx-auto max-w-3xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              <CardTitle className="text-2xl text-amber-800">Grade 5 Language Arts Performance Task Moderate 2</CardTitle>
              <p className="text-slate-600">Topic: School Uniform Policy</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
              <div className="rounded-lg border border-amber-200 bg-white p-4">
                <h3 className="mb-2 font-semibold text-slate-800">Task Scenario</h3>
                <p className="text-slate-700">Your school is reviewing its uniform policy and wants students to share their views. Read the information, answer the questions, and complete the writing task.</p>
              </div>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              ...
              <p className="text-slate-600">Grade 5 Language Arts Performance Task Moderate 2</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
...
I am writing to share my thoughts about our school uniform policy. I believe uniforms are an important part of school life, but there is one change that could make them even better.

First, uniforms help all students feel equal. When everyone wears the same clothing, students are judged by their character and effort rather than by the brands they wear. This creates a fairer and more respectful school environment. Second, uniforms save families money in the long run. Instead of buying many different outfits, parents only need to purchase a few sets of uniform items.

However, I think students should be allowed to choose between trousers or shorts (for boys) and between a skirt or trousers (for girls). Giving students a small amount of choice within the uniform rules would allow them to feel comfortable and respected while still maintaining the unity that uniforms provide.

I hope you will consider this suggestion. Thank you for listening to the students' views.
      ...
      <main className="container mx-auto px-4 py-10">
        <div className="mx-auto max-w-4xl space-y-6">
          <div className="flex items-center justify-between rounded-lg bg-slate-800 p-4 text-white">
            <div>
              <h1 className="font-bold">Grade 5 Language Arts Performance Task Moderate 2</h1>
              <p className="text-sm text-slate-200">School Uniform Policy</p>
            </div>
          ...
          <Card className="border-blue-200">
            ...
            <CardContent className="space-y-4 p-6 text-slate-700">
              <p>Most primary schools in Jamaica require students to wear a uniform. The uniform usually includes specific colours for shirts, pants or skirts, and shoes. Uniforms are intended to create a sense of unity, reduce pressure to wear expensive clothes, and make it easier to identify students as members of the school.</p>
              <p>Some students and parents feel that uniforms are too restrictive and do not allow students to express their personality. Others argue that wearing the same clothing helps students focus on learning rather than appearance. Schools that enforce the uniform policy consistently tend to report fewer disagreements about clothing.</p>
              <p>If a school changes its uniform policy, it must consider the cost to families, the practicality of the new design, and how the change would be communicated to the school community. Any successful change would require input from students, parents, teachers, and school leaders.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-200">
            ...
            <CardContent className="space-y-4 p-6">
              <p className="text-slate-700">Write a letter to your school principal sharing your opinion on the school uniform policy. Give at least TWO reasons to support your view and suggest ONE change that could make the policy better for all students.</p>
