...
const mcqs: MCQ[] = [
{
    "question": "Which action would MOST effectively create lasting water conservation habits in a school community, based on the source?",
    "options": [
      "Fixing one leaking tap and considering the problem resolved",
      "Posting one notice about conservation and leaving it unchanged",
      "Combining infrastructure improvements (repairing leaks, rainwater tanks) with ongoing student education — addressing both physical waste and the behaviours that cause it simultaneously",
      "Only purchasing bottled water to avoid using piped water"
    ],
    "answer": 2
  },
  {
    "question": "Which school action would MOST directly reduce water waste?",
    "options": [
      "Painting the water tanks",
      "Fixing leaking taps and installing rainwater collection tanks",
      "Closing the school during dry season",
      "Buying bottled water for students"
    ],
    "answer": 1
  },
  {
    "question": "According to the passage, what is an important outcome of students learning water conservation at school?",
    "options": [
      "They will fail their exams",
      "They are more likely to practise conservation at home and influence their families",
      "They will argue with their teachers",
      "They will move to drier parishes"
    ],
    "answer": 1
  },
  {
    "question": "What does the source suggest about setting clear goals for a conservation programme?",
    "options": [
      "Goals are unnecessary",
      "Only the principal should set goals",
      "Clear goals like reducing the monthly water bill by 15% help track progress and keep everyone motivated",
      "Goals should be kept secret from students"
    ],
    "answer": 2
  },
  {
    "question": "Which approach shows the BEST collaboration in running a school water conservation programme?",
    "options": [
      "Only the science teacher manages it",
      "Only students are responsible",
      "Teachers, students, parents, and school administration cooperate and share responsibility",
      "The NWC runs the programme alone"
    ],
    "answer": 2
  }
]
...
const shortAnswers: ShortAnswer[] = [
  {
    "question": "State TWO simple changes a school can make to conserve water.",
    "answer": "A school can fix leaking taps to stop water being wasted and install rainwater collection tanks to store rainwater for later use."
  },
  {
    "question": "Explain why recognising students who meet conservation targets is useful.",
    "answer": "Recognising students who meet conservation targets encourages them to continue their efforts and motivates other students to participate, making the programme more effective across the whole school."
  }
]

export default function PerformanceModerate3Page() {
  ...
  const sourceBodyText = `Water is one of Jamaica's most important natural resources, but it is not always available in every community. Some parishes experience water shortages during the dry season, making it necessary for schools, homes, and businesses to use water carefully. The National Water Commission (NWC) urges all Jamaicans to reduce water waste to protect this vital resource. Schools play a key role in teaching communities about water conservation. Simple changes such as fixing leaking taps, installing rainwater collection tanks, and running awareness campaigns can make a significant difference. Students who learn good water habits at school are more likely to practise them at home and encourage their families to do the same. A successful water conservation programme in a school requires cooperation between teachers, students, parents, and the school administration. Setting clear goals — such as reducing the school's monthly water bill by 15% — and tracking progress helps everyone stay motivated. Recognising students and classes that meet conservation targets can also encourage wider participation.`
  const writingPromptText = `Write a letter to your Parish Councillor proposing at least TWO specific ways your school could help the community conserve water. Explain why these actions are important and how students could lead the effort.`
        ...
        <main className="container mx-auto px-4 py-10">
          ...
          <Card className="mx-auto max-w-3xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              <CardTitle className="text-2xl text-amber-800">Grade 5 Language Arts Performance Task Moderate 3</CardTitle>
              <p className="text-slate-600">Topic: Water Conservation in Our Community</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
              <div className="rounded-lg border border-amber-200 bg-white p-4">
                <h3 className="mb-2 font-semibold text-slate-800">Task Overview</h3>
                <p className="text-slate-700">Your class has been asked to advise your Parish Council on how schools can help conserve water in the community. Read the information below, answer the questions, and complete the writing task.</p>
              </div>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              ...
              <p className="text-slate-600">Grade 5 Language Arts Performance Task Moderate 3</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mx-auto max-w-4xl space-y-6">
          <div className="flex items-center justify-between rounded-lg bg-slate-800 p-4 text-white">
            <div>
              <h1 className="font-bold">Grade 5 Language Arts Performance Task Moderate 3</h1>
              <p className="text-sm text-slate-200">Water Conservation in Our Community</p>
            </div>
          ...
          <Card className="border-blue-200">
            ...
            <CardContent className="space-y-4 p-6 text-slate-700">
              <p>Water is one of Jamaica's most important natural resources, but it is not always available in every community. Some parishes experience water shortages during the dry season, making it necessary for schools, homes, and businesses to use water carefully. The National Water Commission (NWC) urges all Jamaicans to reduce water waste to protect this vital resource.</p>
              <p>Schools play a key role in teaching communities about water conservation. Simple changes such as fixing leaking taps, installing rainwater collection tanks, and running awareness campaigns can make a significant difference. Students who learn good water habits at school are more likely to practise them at home and encourage their families to do the same.</p>
              <p>A successful water conservation programme in a school requires cooperation between teachers, students, parents, and the school administration. Setting clear goals — such as reducing the school's monthly water bill by 15% — and tracking progress helps everyone stay motivated. Recognising students and classes that meet conservation targets can also encourage wider participation.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-200">
            ...
            <CardContent className="space-y-4 p-6">
              <p className="text-slate-700">Write a letter to your Parish Councillor proposing at least TWO specific ways your school could help the community conserve water. Explain why these actions are important and how students could lead the effort.</p>
