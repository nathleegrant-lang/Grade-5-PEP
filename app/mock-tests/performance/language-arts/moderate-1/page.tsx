...
const mcqs: MCQ[] = [
  {
    "question": "Based on the source, what can you CONCLUDE about children's vulnerability to poor air quality?",
    "options": [
      "Children are unaffected by air quality because they are young and healthy",
      "Children are less vulnerable than adults because they spend more time outside",
      "Children are especially at risk because their lungs are still developing and they spend more time outdoors where pollution is most concentrated",
      "Children only suffer from air pollution during exercise"
    ],
    "answer": 2
  },
  {
    "question": "According to the source, which action reduces vehicle emissions at a community level?",
    "options": [
      "Planting more trees in school gardens",
      "Burning garbage in controlled fires",
      "Advocating for improved public transport to reduce the number of private vehicles on the road",
      "Keeping all windows closed in homes and classrooms"
    ],
    "answer": 2
  },
  {
    "question": "According to the source, what benefit do trees planted along roadsides provide?",
    "options": [
      "They slow traffic and reduce accidents",
      "They absorb pollutants and produce oxygen, creating a natural barrier against air pollution",
      "They are only useful for providing shade on hot days",
      "They mark the boundary of community land"
    ],
    "answer": 1
  },
  {
    "question": "Based on the source, which approach to improving air quality addresses BOTH the cause and the solution simultaneously?",
    "options": [
      "Wearing a mask every day and ignoring the cause",
      "Educating students about air pollution so they advocate for cleaner community practices while holding leaders accountable for environmental decisions",
      "Only reporting problems to the government and waiting for action",
      "Burning garbage quickly rather than letting it accumulate"
    ],
    "answer": 1
  },
  {
    "question": "What role does the source suggest schools should play in addressing air quality issues?",
    "options": [
      "Schools should only teach about air quality in Science class",
      "Schools should measure air quality and keep the results private",
      "Schools should educate students to be advocates for change AND share local air quality data with the Parish Council to influence policy improvements",
      "Schools have no meaningful role in improving community air quality"
    ],
    "answer": 2
  }
]
...
const shortAnswers: ShortAnswer[] = [
  {
    "question": "Explain TWO actions a community can take to improve air quality, based on the source.",
    "answer": "A community can plant trees along roadsides to absorb pollutants and produce clean oxygen, creating a natural barrier against vehicle emissions. They can also encourage proper waste management and stop burning garbage, which releases harmful smoke into the air and worsens respiratory conditions."
  },
  {
    "question": "How can students at your school help improve air quality in the community, based on the source?",
    "answer": "Students can learn about the causes and effects of air pollution through science projects and then use this knowledge to advocate for change in their homes and community. They can share findings with local leaders or the Parish Council, providing real data that supports policy improvements such as better public transport or stricter regulations on burning."
  }
]
...
export default function PerformanceModerate1Page() {
  ...
  const sourceBodyText = `Air quality refers to the cleanliness of the air we breathe. Poor air quality — caused by vehicle emissions, burning of garbage, dust from construction, and industrial pollution — can lead to serious health problems including asthma, allergies, and respiratory infections. Children are especially vulnerable because their lungs are still developing and they spend more time outdoors. Communities can improve air quality through a combination of individual actions and collective effort. Planting trees along roadsides provides a natural barrier that absorbs pollutants and produces oxygen. Avoiding the burning of garbage and encouraging proper waste management reduces smoke pollution. Communities that advocate for improved public transport reduce the number of private vehicles on the road, which significantly lowers emissions. Schools have an important role in educating young people about air quality. When students learn about the causes and effects of air pollution, they become advocates for change — encouraging their families to adopt cleaner practices and holding community leaders accountable for environmental decisions. Schools that run science projects measuring local air quality, and that share results with the Parish Council, provide valuable data that can lead to policy improvements.`
  const writingPromptText = `Write a letter to your Parish Councillor explaining why air quality in your community is a concern, identifying TWO causes of the problem and recommending TWO specific actions the council should take to improve it. Use evidence from the source to support your recommendations.`
        ...
        <main className="container mx-auto px-4 py-10">
          ...
          <Card className="mx-auto max-w-3xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              <CardTitle className="text-2xl text-amber-800">Grade 5 Language Arts Performance Task Moderate 1</CardTitle>
              <p className="text-slate-600">Topic: Improving Air Quality in Our Community</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
              <div className="rounded-lg border border-amber-200 bg-white p-4">
                <h3 className="mb-2 font-semibold text-slate-800">Task Overview</h3>
                <p className="text-slate-700">Your community has noticed increased dust and smoke in the air near the main road. Read the source, answer the questions, and complete the writing task.</p>
              </div>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              ...
              <p className="text-slate-600">Grade 5 Language Arts Performance Task Moderate 1</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mx-auto max-w-4xl space-y-6">
          <div className="flex items-center justify-between rounded-lg bg-slate-800 p-4 text-white">
            <div>
              <h1 className="font-bold">Grade 5 Language Arts Performance Task Moderate 1</h1>
              <p className="text-sm text-slate-200">Improving Air Quality in Our Community</p>
            </div>
          ...
          <Card className="border-blue-200">
            ...
            <CardContent className="space-y-4 p-6 text-slate-700">
              <p>Air quality refers to the cleanliness of the air we breathe. Poor air quality — caused by vehicle emissions, burning of garbage, dust from construction, and industrial pollution — can lead to serious health problems including asthma, allergies, and respiratory infections. Children are especially vulnerable because their lungs are still developing and they spend more time outdoors.</p>
              <p>Communities can improve air quality through a combination of individual actions and collective effort. Planting trees along roadsides provides a natural barrier that absorbs pollutants and produces oxygen. Avoiding the burning of garbage and encouraging proper waste management reduces smoke pollution. Communities that advocate for improved public transport reduce the number of private vehicles on the road, which significantly lowers emissions.</p>
              <p>Schools have an important role in educating young people about air quality. When students learn about the causes and effects of air pollution, they become advocates for change — encouraging their families to adopt cleaner practices and holding community leaders accountable for environmental decisions. Schools that run science projects measuring local air quality, and that share results with the Parish Council, provide valuable data that can lead to policy improvements.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-200">
            ...
            <CardContent className="space-y-4 p-6">
              <p className="text-slate-700">Write a letter to your Parish Councillor explaining why air quality in your community is a concern, identifying TWO causes of the problem and recommending TWO specific actions the council should take to improve it. Use evidence from the source to support your recommendations.</p>
