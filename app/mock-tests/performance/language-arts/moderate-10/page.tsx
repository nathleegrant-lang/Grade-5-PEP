...
const mcqs: MCQ[] = [
{
    "question": "Based on the source, why is it important for STUDENTS — not only teachers and administrators — to take an active role in creating a safer school environment?",
    "options": [
      "Students are more effective enforcers of rules than teachers because they are peers",
      "Teachers and administrators cannot create a safe school without full student enforcement",
      "Students shape the daily social climate of the school — when they model respect, speak up against unkindness, and actively include isolated peers, they create a culture of safety that no adult policy alone can fully achieve",
      "Student involvement in school safety should only occur when serious problems arise"
    ],
    "answer": 2
  },
  {
    "question": "Which strategy does the source mention for helping students feel protected at school?",
    "options": [
      "Making school rules secret",
      "A clear anti-bullying policy and a confidential system for reporting concerns",
      "Punishing all students equally for any conflict",
      "Only prefects monitoring behaviour"
    ],
    "answer": 1
  },
  {
    "question": "What role do PEER SUPPORT PROGRAMMES play, according to the source?",
    "options": [
      "They replace teachers",
      "They reduce isolation and improve wellbeing by having older students mentor younger ones",
      "They are only for students with academic problems",
      "They create more competition between students"
    ],
    "answer": 1
  },
  {
    "question": "According to the source, how can students themselves contribute to a safer school climate?",
    "options": [
      "By reporting all friends to the principal",
      "By speaking up against unkind behaviour, including isolated classmates, and modelling respect",
      "By avoiding all social interaction",
      "By competing with each other"
    ],
    "answer": 1
  },
  {
    "question": "Which approach does the source suggest helps reinforce positive values continuously?",
    "options": [
      "Only celebrating academic achievements",
      "Holding regular discussions about respect and values, and celebrating students who show kindness and leadership",
      "Ignoring unkind behaviour",
      "Only punishing negative behaviour"
    ],
    "answer": 1
  }
]
...
const shortAnswers: ShortAnswer[] = [
  {
    "question": "Explain why a positive school climate benefits the whole school, not just individual students.",
    "answer": "When all students feel safe and respected, they can focus on learning without fear or distraction, which improves academic performance across the school. A positive climate also reduces disruptions caused by bullying or conflict, creating a more productive environment for teachers and students alike."
  },
  {
    "question": "Describe ONE way students can take a leadership role in making the school a safer place.",
    "answer": "Students can lead by example by consistently treating classmates with respect and kindness, speaking up calmly when they witness unkind behaviour, and actively including classmates who seem isolated \u2014 demonstrating the values the whole school community wants to promote."
  }
]

export default function PerformanceModerate10Page() {
  ...
  const sourceBodyText = `A safe school environment is one where every student feels respected, included, and free from bullying, harassment, or physical danger. Research shows that students learn more effectively when they feel safe and supported. A positive school climate — one that values kindness, fairness, and mutual respect — benefits not only individual students but also the overall academic performance of the entire school. Schools can create a safer environment through several strategies. Clear anti-bullying policies, counselling services for students in need, and a system for reporting concerns confidentially all help students feel protected. Training teachers to recognise signs of distress and respond compassionately is equally important. Peer support programmes — where older students mentor younger ones — can also reduce isolation and improve wellbeing across the school. Students themselves play a powerful role in shaping the school's climate. When students speak up against unkind behaviour, include classmates who may feel left out, and model respectful behaviour, they create a culture where everyone feels they belong. Schools that hold regular discussions about respect and values, and that celebrate students who demonstrate kindness and leadership, reinforce these positive norms continuously.`
  const writingPromptText = `Write a proposal to your school council recommending TWO specific changes that would make the school a safer and more welcoming place for all students. Explain why each change is important and describe how students, teachers, and parents can each contribute to creating a better school environment.`
        ...
        <main className="container mx-auto px-4 py-10">
          ...
          <Card className="mx-auto max-w-3xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              <CardTitle className="text-2xl text-amber-800">Grade 5 Language Arts Performance Task Moderate 10</CardTitle>
              <p className="text-slate-600">Topic: Creating a Safer School Environment</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
              <div className="rounded-lg border border-amber-200 bg-white p-4">
                <h3 className="mb-2 font-semibold text-slate-800">Task Overview</h3>
                <p className="text-slate-700">Your school council has asked students to recommend ways to make the school a safer, more welcoming place. Read the information and complete all parts of the task.</p>
              </div>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              ...
              <p className="text-slate-600">Grade 5 Language Arts Performance Task Moderate 10</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mx-auto max-w-4xl space-y-6">
          <div className="flex items-center justify-between rounded-lg bg-slate-800 p-4 text-white">
            <div>
              <h1 className="font-bold">Grade 5 Language Arts Performance Task Moderate 10</h1>
              <p className="text-sm text-slate-200">Creating a Safer School Environment</p>
            </div>
          ...
          <Card className="border-blue-200">
            ...
            <CardContent className="space-y-4 p-6 text-slate-700">
              <p>A safe school environment is one where every student feels respected, included, and free from bullying, harassment, or physical danger. Research shows that students learn more effectively when they feel safe and supported. A positive school climate — one that values kindness, fairness, and mutual respect — benefits not only individual students but also the overall academic performance of the entire school.</p>
              <p>Schools can create a safer environment through several strategies. Clear anti-bullying policies, counselling services for students in need, and a system for reporting concerns confidentially all help students feel protected. Training teachers to recognise signs of distress and respond compassionately is equally important. Peer support programmes — where older students mentor younger ones — can also reduce isolation and improve wellbeing across the school.</p>
              <p>Students themselves play a powerful role in shaping the school's climate. When students speak up against unkind behaviour, include classmates who may feel left out, and model respectful behaviour, they create a culture where everyone feels they belong. Schools that hold regular discussions about respect and values, and that celebrate students who demonstrate kindness and leadership, reinforce these positive norms continuously.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-200">
            ...
            <CardContent className="space-y-4 p-6">
              <p className="text-slate-700">Write a proposal to your school council recommending TWO specific changes that would make the school a safer and more welcoming place for all students. Explain why each change is important and describe how students, teachers, and parents can each contribute to creating a better school environment.</p>
