...
const mcqs: MCQ[] = [
{
    "question": "Based on the source, what can you INFER about Jamaica's water supply if deforestation continues?",
    "options": [
      "Water supply will improve as less vegetation uses up groundwater",
      "Water supply will remain unchanged because rivers are fed by rainfall only",
      "Water supply will deteriorate as forests that recharge aquifers and regulate river flow are lost, worsening droughts",
      "Deforestation only affects air quality, not water"
    ],
    "answer": 2
  },
  {
    "question": "Which response to deforestation is MOST consistent with the evidence in the source?",
    "options": [
      "Plant any available trees anywhere to compensate for losses",
      "Wait for forests to regrow naturally without intervention",
      "Combine targeted reforestation with native species, enforcement against illegal logging, and community education to address causes and restore function",
      "Remove all human settlements from forest areas"
    ],
    "answer": 2
  },
  {
    "question": "The source suggests that the effects of deforestation extend beyond the forest itself. Which conclusion is BEST supported?",
    "options": [
      "Deforestation only affects wildlife directly in the area where trees are cut",
      "Forests have cascading effects on water, climate, soil, and communities — so their loss creates interconnected problems requiring coordinated solutions",
      "Replanting trees immediately and fully reverses all deforestation damage",
      "Deforestation is primarily an aesthetic problem with few practical consequences"
    ],
    "answer": 1
  },
  {
...
export default function PerformanceDifficult3Page() {
  ...
  const sourceBodyText = `Deforestation is the clearing or removal of forests. In Jamaica, forests are cut down for farming, logging, and to make way for roads and buildings. The country has lost a significant portion of its original forest cover over the past century, putting many plant and animal species at risk. Forests are essential to Jamaica's environment and people. They capture rainfall and allow it to soak into the ground, feeding rivers and underground water sources. They prevent soil erosion on hillsides and provide habitat for endemic species — plants and animals found nowhere else on Earth. When forests are removed, rivers can dry up in the dry season and flood more severely during heavy rain. Landslides become more frequent in deforested hillside areas. The loss of trees also contributes to climate change because trees store carbon dioxide, a greenhouse gas. Reforestation — the planting of trees to replace those lost — is one important response. Government programmes, schools, and community groups in Jamaica have organised tree-planting campaigns. However, reforestation takes decades to restore the full value of a mature forest, so preventing further deforestation is equally important.`
  const writingPromptText = `Write a report for your school's science fair explaining the problem of deforestation in Jamaica. Include TWO causes, TWO effects, and recommend TWO actions that the school community could take. Use evidence from the source to support your points.`
      ...
      try {
        ...
        if (user) {
          ...
          await supabase.from("student_test_results").insert({
            ...
            test_name: "Performance Task - Difficult 3",
            score: percentage,
            total_questions: 1,
        ...
        <main className="container mx-auto px-4 pb-10 pt-32 lg:pt-10">
          ...
          <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
            <CardHeader className="bg-blue-700 text-center rounded-t-lg">
              <CardTitle className="text-2xl text-white">Language Arts Performance Task Difficult 3</CardTitle>
              <p className="text-blue-100 text-sm mt-1">Topic: Deforestation and Reforestation in Jamaica</p>
            </CardHeader>
        ...
        <main className="container mx-auto px-4 pb-10 pt-32 lg:pt-10">
          <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
            <CardHeader className="bg-blue-700 text-center rounded-t-lg">
              ...
              <CardTitle className="text-2xl text-white">Model Answers & AI Feedback — Language Arts Performance Task Difficult 3</CardTitle>
              <p className="text-blue-100 text-sm mt-1">Language Arts Performance Task Difficult 3</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
