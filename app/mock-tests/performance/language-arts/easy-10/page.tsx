...
const mcqs: MCQ[] = [
  {
    "question": "According to the source, what is ONE benefit of playing sport for students?",
    "options": [
      "It replaces classroom learning",
      "It helps develop physical fitness, discipline, and fair play",
      "It is only useful for future athletes",
      "It reduces the need for homework"
    ],
    "answer": 1
  },
  {
    "question": "Which skill learned in team sports is also useful in school and work, according to the source?",
    "options": [
      "Running very fast",
      "Knowing the rules of cricket",
      "Communicating clearly and supporting teammates",
      "Winning every competition"
    ],
    "answer": 2
  },
  {
    "question": "What does a successful sports day require, according to the source?",
    "options": [
      "Only the fastest students",
      "Expensive equipment",
      "Preparation, cooperation, and enthusiasm",
...
const shortAnswers: ShortAnswer[] = [
  {
    "question": "State ONE lesson a student can learn from sport even if they do not win.",
    "answer": "A student who does not win can still learn resilience and the importance of giving their best effort regardless of the outcome."
  },
  {
    "question": "Give ONE reason why teamwork is important for a school sports team.",
    "answer": "Teamwork allows players to support each other, use their different strengths, and perform better together than they would individually."
  }
]

export default function PerformanceEasy10Page() {
  ...
  const sourceBodyText = `Sport is an important part of life at Jamaican primary schools. Students take part in athletics, football, netball, cricket, and many other games. Sport helps students develop physical fitness, discipline, and a spirit of fair play. Jamaica is world-famous for its athletes, particularly in track and field. Team sports teach skills that go beyond the playing field. When students work together in a team, they learn to communicate clearly, trust their teammates, and support each other even when things are difficult. These are the same skills needed to succeed in school, work, and life. Coaches often say that the lessons learned in sport are just as important as the trophies won. A successful sports day requires preparation, cooperation, and enthusiasm. Students must train regularly, listen to their coaches, and encourage each other. Even students who do not win a race learn valuable lessons about effort, resilience, and being a gracious competitor. Sports day is a celebration of every student's hard work.`
  const writingPromptText = `Write a speech to be delivered at your school sports day to motivate your classmates. Include the importance of both winning and losing, and give at least TWO reasons why sport is valuable for every student, not just those who are very athletic.`
        ...
        <main className="container mx-auto px-4 py-10">
          <Link href="/mock-tests/performance/language-arts">
            <Button variant="ghost" className="mb-6">
              ...
              Back to Language Arts Performance Task Mock Tests
            </Button>
          </Link>
          <Card className="mx-auto max-w-3xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              <CardTitle className="text-2xl text-amber-800">Grade 5 Language Arts Performance Task Easy 10</CardTitle>
              <p className="text-slate-600">Topic: Sports and Teamwork</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
              <div className="rounded-lg border border-amber-200 bg-white p-4">
                <h3 className="mb-2 font-semibold text-slate-800">Task Scenario</h3>
                <p className="text-slate-700">Your school is preparing for its annual sports day. Read the information, answer the questions, and complete the writing task to show what you have learned about sport and teamwork.</p>
              </div>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              ...
              <p className="text-slate-600">Grade 5 Language Arts Performance Task Easy 10</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
              ...
              <div className="rounded-lg border border-sky-200 bg-sky-50 p-4">
                ...
                <p className="text-slate-700">Review your multiple-choice answers and compare your written responses with the sample answers. Strong Grade 5 performance should show clear evidence, complete sentences, and thoughtful ideas.</p>
              </div>
...
Welcome to our annual sports day — a day to celebrate effort, courage, and the spirit of our school!

Today, some of us will cross the finish line first. Others will not. But I want every single student here to know that sport is not just about winning.

First, sport teaches us discipline. Every time you trained, woke up early, and pushed yourself to keep going when you were tired, you were building a habit of hard work. That habit will serve you in every lesson, every exam, and every challenge you face in life. Second, sport teaches us to be part of something bigger than ourselves. When you cheer for your teammate, when you pass the baton, when you help someone up after they fall — you are building the kind of character that truly matters.

So whether you come first or last today, hold your head high. Give everything you have. Support everyone around you. And remember — the greatest victory is not on the track. It is in becoming the best version of yourself.

Let the games begin! Go, team!</p>
              </div>
      ...
      <main className="container mx-auto px-4 py-10">
        <div className="mx-auto max-w-4xl space-y-6">
          <div className="flex items-center justify-between rounded-lg bg-slate-800 p-4 text-white">
            <div>
              <h1 className="font-bold">Grade 5 Language Arts Performance Task Easy 10</h1>
              <p className="text-sm text-slate-200">Sports and Teamwork</p>
            </div>
          ...
          <Card className="border-blue-200">
            ...
            <CardContent className="space-y-4 p-6 text-slate-700">
              <p>Sport is an important part of life at Jamaican primary schools. Students take part in athletics, football, netball, cricket, and many other games. Sport helps students develop physical fitness, discipline, and a spirit of fair play. Jamaica is world-famous for its athletes, particularly in track and field.</p>
              <p>Team sports teach skills that go beyond the playing field. When students work together in a team, they learn to communicate clearly, trust their teammates, and support each other even when things are difficult. These are the same skills needed to succeed in school, work, and life. Coaches often say that the lessons learned in sport are just as important as the trophies won.</p>
              <p>A successful sports day requires preparation, cooperation, and enthusiasm. Students must train regularly, listen to their coaches, and encourage each other. Even students who do not win a race learn valuable lessons about effort, resilience, and being a gracious competitor. Sports day is a celebration of every student's hard work.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-200">
            ...
            <CardContent className="space-y-4 p-6">
              <p className="text-slate-700">Write a speech to be delivered at your school sports day to motivate your classmates. Include the importance of both winning and losing, and give at least TWO reasons why sport is valuable for every student, not just those who are very athletic.</p>
