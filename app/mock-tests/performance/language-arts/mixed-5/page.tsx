...
const mcqs: MCQ[] = [
  {
    "question": "According to the source, what areas does a Green School focus on to reduce environmental impact?",
    "options": [
      "Only sport and recreation",
      "Only academic performance",
      "Energy use, water conservation, waste management, and biodiversity",
      "Only the school garden"
    ],
    "answer": 2
  },
  {
    "question": "How much electricity can LED lighting save, according to the source?",
    "options": [
      "20%",
      "50%",
      "Up to 80%",
  ...
  {
    "question": "What does the source say a composting system does for a school?",
    "options": [
      "It produces electricity",
      "It turns food waste into rich soil for a school garden",
      "It reduces the need for LED lights",
      "It replaces recycling bins"
    ],
    "answer": 1
  },
  {
    "question": "According to the source, what is the GREATEST benefit of becoming a Green School?",
    "options": [
      "Saving the most money",
      "Getting government awards",
      "The long-term cultural change it creates \u2014 habits that extend to homes and communities",
      "Having the cleanest building"
    ],
    "answer": 2
  },
  {
    "question": "How does the source suggest schools can motivate students to continue green practices?",
    "options": [
      "By punishing non-participation",
      "By tracking and celebrating measurable progress, such as waste diverted or rainwater harvested",
      "By making all classes about the environment",
      "By replacing teachers with environmental scientists"
    ],
    "answer": 1
  }
]
...
const shortAnswers: ShortAnswer[] = [
  {
    "question": "Explain how TWO specific Green School practices teach students useful scientific or practical skills.",
    "answer": "Installing a composting system teaches students about decomposition and nutrient cycles in Science, while also developing practical skills in managing organic waste. Rainwater harvesting introduces students to concepts of water conservation and hydrological systems, giving them hands-on experience with technology that addresses real environmental challenges."
  },
  {
    "question": "Describe how a school's environmental habits can benefit the wider community.",
    "answer": "When students practise recycling, water conservation, and composting at school every day, these habits become second nature and naturally extend to their homes and communities. Students become advocates for environmental responsibility, encouraging family members to adopt similar practices, creating a ripple effect that extends the school's green culture far beyond its gates."
  }
]

export default function PerformanceMixed5Page() {
  ...
  const sourceBodyText = `A Green School is one that actively works to reduce its environmental impact through sustainable practices in energy use, water conservation, waste management, and the promotion of biodiversity. Green Schools teach students that environmental responsibility is not just a lesson in a textbook — it is a way of living and making decisions every day. In Jamaica, the government and several non-governmental organisations support schools in adopting green practices. Simple steps can significantly reduce a school's environmental footprint. Switching to LED lighting reduces electricity consumption by up to 80%. Rainwater tanks can supply water for toilets and gardens, reducing dependence on piped water. A composting system turns food waste from the cafeteria into rich soil for a school garden. Each of these changes also teaches students practical science, technology, and environmental stewardship. The greatest benefit of becoming a Green School is the long-term cultural change it creates. When students practise recycling, conserving water, and caring for plants every day at school, these habits extend to their homes and communities. Schools can track and celebrate progress — such as the tonnes of waste diverted from landfill or the litres of rainwater harvested — making environmental stewardship visible, measurable, and rewarding for the entire school community.`
  const writingPromptText = `Write a proposal to your school board recommending THREE specific Green School changes your school should make. For each change, explain what it involves, why it is important for the environment, and what students will learn from it. Use information from the source to support your recommendations.`
      ...
      try {
        ...
        if (user) {
          ...
          await supabase.from("student_test_results").insert({
            ...
            test_name: "Performance Task - Mixed 5",
            score: percentage,
            total_questions: 1,
        ...
        <main className="container mx-auto px-4 py-10">
          ...
          <Card className="mx-auto max-w-3xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              <CardTitle className="text-2xl text-amber-800">Grade 5 Language Arts Performance Task Mixed 5</CardTitle>
              <p className="text-slate-600">Topic: Making Our School More Environmentally Friendly</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
              <div className="rounded-lg border border-amber-200 bg-white p-4">
                <h3 className="mb-2 font-semibold text-slate-800">Task Overview</h3>
                <p className="text-slate-700">Your school has decided to become a 'Green School.' Read the information and complete all parts of the task.</p>
              </div>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              ...
              <p className="text-slate-600">Grade 5 Language Arts Performance Task Mixed 5</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mx-auto max-w-4xl space-y-6">
          <div className="flex items-center justify-between rounded-lg bg-slate-800 p-4 text-white">
            <div>
              <h1 className="font-bold">Grade 5 Language Arts Performance Task Mixed 5</h1>
              <p className="text-sm text-slate-200">Making Our School More Environmentally Friendly</p>
            </div>
          ...
          <Card className="border-blue-200">
            ...
            <CardContent className="space-y-4 p-6 text-slate-700">
              <p>A Green School is one that actively works to reduce its environmental impact through sustainable practices in energy use, water conservation, waste management, and the promotion of biodiversity. Green Schools teach students that environmental responsibility is not just a lesson in a textbook — it is a way of living and making decisions every day. In Jamaica, the government and several non-governmental organisations support schools in adopting green practices.</p>
              <p>Simple steps can significantly reduce a school's environmental footprint. Switching to LED lighting reduces electricity consumption by up to 80%. Rainwater tanks can supply water for toilets and gardens, reducing dependence on piped water. A composting system turns food waste from the cafeteria into rich soil for a school garden. Each of these changes also teaches students practical science, technology, and environmental stewardship.</p>
              <p>The greatest benefit of becoming a Green School is the long-term cultural change it creates. When students practise recycling, conserving water, and caring for plants every day at school, these habits extend to their homes and communities. Schools can track and celebrate progress — such as the tonnes of waste diverted from landfill or the litres of rainwater harvested — making environmental stewardship visible, measurable, and rewarding for the entire school community.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-200">
            ...
            <CardContent className="space-y-4 p-6">
              <p className="text-slate-700">Write a proposal to your school board recommending THREE specific Green School changes your school should make. For each change, explain what it involves, why it is important for the environment, and what students will learn from it. Use information from the source to support your recommendations.</p>
