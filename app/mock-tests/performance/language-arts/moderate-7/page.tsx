...
const mcqs: MCQ[] = [
  {
    "question": "According to the research mentioned in the source, what happens when children eat well at school?",
    "options": [
      "They are more likely to misbehave",
      "They perform better academically and have fewer days of illness",
      "They eat less at home",
      "They prefer to skip lunch"
    ],
    "answer": 1
  },
  {
        ...
        <main className="container mx-auto px-4 py-10">
          ...
          <Card className="mx-auto max-w-3xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              <CardTitle className="text-2xl text-amber-800">Grade 5 Performance Task Moderate 7</CardTitle>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              ...
              <p className="text-slate-600">Grade 5 Performance Task Moderate 7</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mx-auto max-w-4xl space-y-6">
          <div className="flex items-center justify-between rounded-lg bg-slate-800 p-4 text-white">
            <div>
              <h1 className="font-bold">Grade 5 Performance Task Moderate 7</h1>
