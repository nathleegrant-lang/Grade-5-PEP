...
const mcqs: MCQ[] = [
{
    "question": "Based on the source, which change to the school cafeteria would have the GREATEST combined impact on BOTH student nutrition AND reducing food waste?",
    "options": [
      "Serve the same large standardised portion of one food to all students every day",
      "Offer students choices of nutritious local foods in appropriate portion sizes — improving nutrition by matching food to preferences while reducing waste from unwanted meals",
      "Remove the cafeteria so students take full responsibility for their own nutrition",
      "Only serve imported foods with standardised nutritional content labels"
    ],
    "answer": 1
  },
  {
    "question": "Which local foods does the source mention as nutritious and affordable options for school menus?",
    "options": [
      "Pizza and pasta",
      "Callaloo, breadfruit, sweet potato, and locally grown fruits",
      "Imported cereals and canned goods",
      "Fried chicken and chips"
    ],
    "answer": 1
  },
  {
    "question": "What does the source suggest about training cafeteria staff?",
    "options": [
      "It is a waste of time",
      "Only the principal needs training",
      "Training staff in food hygiene and meal preparation can raise the quality and safety of meals",
      "Staff already know everything they need"
    ],
    "answer": 2
  },
  {
    "question": "Which of the following is a way schools can reduce food waste?",
    "options": [
      "Serving very large portions of everything",
      "Throwing away all leftover food",
      "Serving appropriate portions, offering choices, and composting organic scraps",
      "Only serving dry food that doesn't spoil"
    ],
    "answer": 2
  },
  {
    "question": "According to the source, how can students help improve the cafeteria?",
    "options": [
      "By refusing to eat",
      "By giving feedback through surveys or a student cafeteria committee",
      "By cooking all the meals themselves",
      "By complaining to the government"
    ],
    "answer": 1
  }
]
...
const shortAnswers: ShortAnswer[] = [
  {
    "question": "Explain TWO reasons why a nutritious school cafeteria is important for students.",
    "answer": "A nutritious cafeteria supports students' academic performance because eating well improves concentration and energy levels. It also improves students' health, reducing absences caused by illness and allowing them to attend school more consistently."
  },
  {
    "question": "Describe ONE way students can actively contribute to improving the school cafeteria.",
    "answer": "Students could participate in a cafeteria committee or complete regular surveys to share feedback about the meals they prefer and any concerns about food quality, helping cafeteria staff make menus that better meet students' nutritional needs and preferences."
  }
]
        ...
        <main className="container mx-auto px-4 py-10">
          ...
          <Card className="mx-auto max-w-3xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              <CardTitle className="text-2xl text-amber-800">Grade 5 Language Arts Performance Task Moderate 7</CardTitle>
              <p className="text-slate-600">Topic: Improving the School Cafeteria</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
              <div className="rounded-lg border border-amber-200 bg-white p-4">
                <h3 className="mb-2 font-semibold text-slate-800">Task Overview</h3>
                <p className="text-slate-700">Your school's Parent-Teacher Association (PTA) is reviewing the school cafeteria. Read the information and complete all parts of the task.</p>
              </div>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              ...
              <p className="text-slate-600">Grade 5 Language Arts Performance Task Moderate 7</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
        ...
        <div className="mx-auto max-w-4xl space-y-6">
          ...
          <Card className="border-blue-200">
            ...
            <CardContent className="space-y-4 p-6 text-slate-700">
              <p>A healthy school cafeteria provides students with nutritious meals that support concentration, energy, and physical development. Research shows that children who eat well at school perform better academically and have fewer days of illness. In Jamaica, the School Feeding Programme provides meals for many students, but the quality and variety of food served can differ widely between schools.</p>
              <p>Improving the cafeteria requires input from students, parents, teachers, and the cafeteria staff. Students benefit when menus include a variety of local foods — such as callaloo, breadfruit, sweet potato, and locally grown fruits — that are both nutritious and affordable. Training cafeteria staff in food hygiene and meal preparation can also raise the quality and safety of meals served.</p>
              <p>A well-managed cafeteria should also address food waste. Schools can reduce waste by serving appropriate portion sizes, offering students choices where possible, and composting organic scraps. These practices save money, benefit the environment, and teach students the value of not wasting food. Feedback from students through surveys or a student cafeteria committee helps ensure meals meet their needs and preferences.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-200">
            ...
            <CardContent className="space-y-4 p-6">
              <p className="text-slate-700">Write a letter to your school's PTA recommending TWO specific improvements to the school cafeteria. Explain why each improvement is important and suggest how students, parents, and cafeteria staff could work together to make the changes.</p>
