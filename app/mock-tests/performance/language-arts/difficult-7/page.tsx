...
const mcqs: MCQ[] = [
{
    "question": "Based on the source, what can you INFER about an economy that is heavily dependent on tourism?",
    "options": [
      "A tourism-dependent economy is always more stable than a diversified one",
      "Tourism dependency has no measurable risks for national economies",
      "Heavy tourism dependency creates economic vulnerability — global events like pandemics, natural disasters, or recessions can devastate the economy if tourism is the primary revenue source",
      "Countries dependent on tourism always have the highest living standards"
    ],
    "answer": 2
  },
  {
    "question": "The source mentions tourism revenue 'leaking' from the Jamaican economy. Which action is MOST consistent with reducing this leakage?",
    "options": [
      "Reduce the number of tourists to reduce the amount that leaks",
      "Increase import taxes on foreign goods used by tourists",
      "Strengthen linkages between tourism and local agriculture, crafts, and services so a greater share of tourist spending circulates within the Jamaican economy",
      "Remove all locally made products from tourist areas to create a more international experience"
    ],
    "answer": 2
  },
  {
    "question": "Which conclusion about sustainable tourism is BEST supported by the source?",
    "options": [
      "Sustainable tourism necessarily means fewer tourists and lower revenue",
      "Environmental protection and tourism economic growth are always in direct conflict",
      "Protecting the natural and cultural assets that attract tourists in the first place is both environmentally and economically rational — sustainable tourism secures the foundation of the industry's future",
      "Jamaica's tourism industry has no environmental impacts worth considering"
    ],
    "answer": 2
  },
  {
        ...
        <main className="container mx-auto px-4 pb-10 pt-32 lg:pt-10">
          ...
          <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
            <CardHeader className="bg-blue-700 text-center rounded-t-lg">
              <CardTitle className="text-2xl text-white">Language Arts Performance Task Difficult 7</CardTitle>
              <p className="text-blue-100 text-sm mt-1">Topic: Tourism and Jamaica's Economy</p>
            </CardHeader>
        ...
        <main className="container mx-auto px-4 pb-10 pt-32 lg:pt-10">
          <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
            <CardHeader className="bg-blue-700 text-center rounded-t-lg">
              ...
              <CardTitle className="text-2xl text-white">Model Answers & AI Feedback — Language Arts Performance Task Difficult 7</CardTitle>
              <p className="text-blue-100 text-sm mt-1">Language Arts Performance Task Difficult 7</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
