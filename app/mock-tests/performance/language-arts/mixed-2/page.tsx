...
const mcqs: MCQ[] = [
  {
    "question": "According to the source, why are single-use plastics particularly harmful to the environment?",
    "options": [
      "They are made in Jamaica",
      "They biodegrade quickly",
      "They remain in the environment for hundreds of years and can break down into microplastics that contaminate the food chain",
      "They are too expensive"
    ],
    "answer": 2
  },
  {
    "question": "What action did Jamaica take in 2019 to reduce plastic pollution?",
    "options": [
      "Banned all plastic forever",
      "Banned single-use plastic bags and expanded polystyrene",
      "Made plastic more expensive to buy",
      "Required all schools to recycle plastic"
    ],
    "answer": 1
  },
  {
    "question": "Which school action does the source suggest can help reduce plastic pollution?",
    "options": [
      "Using more plastic in the tuck shop",
      "Only teaching about plastic in Science class",
      "Eliminating single-use plastics from tuck shops and organising clean-ups",
      "Ignoring the problem"
    ],
    "answer": 2
  },
  {
    "question": "What does the source say about students as advocates for environmental change?",
    "options": [
      "Students are too young to understand environmental issues",
      "Students who understand pollution science are more effective at communicating with families and communities",
      "Only adults can advocate for change",
      "Students should not discuss environmental issues"
    ],
    "answer": 1
  },
  {
    "question": "According to the source, what is ONE benefit of running a plastic-free challenge at school?",
    "options": [
      "Students get prizes every day",
      "It encourages habits that can last a lifetime",
      "It replaces all classroom lessons",
      "It is required by the Jamaican government"
    ],
    "answer": 1
  }
]
...
const shortAnswers: ShortAnswer[] = [
  {
    "question": "Explain TWO ways that plastic pollution harms Jamaica's environment.",
    "answer": "Plastic waste blocks drains and causes flooding during heavy rainfall, disrupting communities and damaging property. It also breaks down into microplastics in the ocean, contaminating fish and other seafood that Jamaicans depend on for nutrition, ultimately harming human health."
  },
  {
    "question": "Describe how a school plastic-free challenge could benefit students beyond the week it runs.",
    "answer": "A plastic-free challenge teaches students practical strategies for avoiding single-use plastics, such as using reusable bottles and bags. The habits formed during the challenge are likely to continue long after it ends, reducing the student's plastic waste throughout their lifetime and encouraging their families to adopt similar habits."
  }
]
      ...
      try {
        ...
        if (user) {
          ...
          await supabase.from("student_test_results").insert({
            ...
            test_name: "Performance Task - Mixed 2",
            score: percentage,
            total_questions: 1,
        ...
        <main className="container mx-auto px-4 py-10">
          ...
          <Card className="mx-auto max-w-3xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              <CardTitle className="text-2xl text-amber-800">Grade 5 Language Arts Performance Task Mixed 2</CardTitle>
              <p className="text-slate-600">Topic: Reducing Plastic Pollution in Our Community</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
              <div className="rounded-lg border border-amber-200 bg-white p-4">
                <h3 className="mb-2 font-semibold text-slate-800">Task Overview</h3>
                <p className="text-slate-700">Your school has joined a national campaign to reduce plastic waste. Read the information below and complete all parts of the task.</p>
              </div>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              ...
              <p className="text-slate-600">Grade 5 Language Arts Performance Task Mixed 2</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
        ...
        <div className="mx-auto max-w-4xl space-y-6">
          ...
          <Card className="border-blue-200">
            ...
            <CardContent className="space-y-4 p-6 text-slate-700">
              <p>Plastic pollution is one of Jamaica's most serious environmental challenges. Single-use plastics — such as bags, bottles, and straws — are used briefly but remain in the environment for hundreds of years. They block drains (causing flooding), harm wildlife that mistake them for food, and pollute beaches and rivers. Plastic waste that enters the sea breaks down into tiny microplastics that contaminate the food chain, including the fish that Jamaicans eat.</p>
              <p>Many countries and communities have taken action to reduce plastic use. Jamaica banned single-use plastic bags and expanded polystyrene (styrofoam) in 2019. Schools can support this effort by eliminating single-use plastics from tuck shops, organising beach or river clean-ups, and teaching students about the long-term effects of plastic pollution. Small actions, repeated consistently, create meaningful change.</p>
          ...
          <Card className="border-purple-200">
            ...
            <CardContent className="space-y-4 p-6">
              <p className="text-slate-700">Write a persuasive speech for your school assembly urging students to reduce their use of plastic. Include at least TWO specific reasons why reducing plastic matters for Jamaica and suggest TWO actions students can take immediately. Use evidence from the source to support your points.</p>
