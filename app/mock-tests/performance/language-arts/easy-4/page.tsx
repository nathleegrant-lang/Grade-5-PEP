...
const mcqs: MCQ[] = [
  {
    "question": "According to the source, which of the following is a nutritious Jamaican food?",
    "options": [
      "Sugary sweets",
      "Callaloo and fish",
      "Soda drinks",
  ...
  {
    "question": "What effect does eating well have on students, according to the source?",
    "options": [
      "They become sleepy",
      "They concentrate better and have more energy",
      "They eat less",
  ...
  {
    "question": "Which is the BEST action for a school to take to promote healthy eating?",
    "options": [
      "Selling only snacks at the tuck shop",
      "Teaching students about balanced meals and offering nutritious food",
      "Banning all food from school",
      "Giving students prizes for skipping lunch"
    ],
    "answer": 1
  }
]
...
const shortAnswers: ShortAnswer[] = [
  {
    "question": "State ONE way a student can make healthier food choices at school.",
    "answer": "A student can bring fruit or vegetables from home as a snack instead of buying sugary treats at the tuck shop."
  },
  {
    "question": "Give ONE reason why eating breakfast is important for Grade 5 students.",
    "answer": "Eating breakfast gives students energy and helps them concentrate during morning lessons."
  }
]

export default function PerformanceEasy4Page() {
  ...
  const sourceBodyText = `Eating a balanced diet is important for growing children. A healthy meal includes fruits, vegetables, grains, proteins, and dairy products. In Jamaica, traditional foods like yam, breadfruit, callaloo, and fish provide many of the nutrients children need to grow and learn. Research shows that students who eat a nutritious breakfast and lunch tend to concentrate better in class and have more energy for sport and play. Skipping meals or eating too many sugary snacks can cause students to feel tired and find it hard to focus. Schools can promote healthy eating by offering nutritious food at the tuck shop, teaching students about balanced meals, and encouraging students to bring healthy snacks from home. When students understand why good food matters, they are more likely to make better choices.`
  const writingPromptText = `Write a short journal entry as a Grade 5 student explaining what you ate for lunch today and whether it was healthy. Describe at least TWO foods and explain what nutrients they provide. Suggest ONE change you could make to eat more healthily.`
      ...
      try {
        ...
        if (user) {
          ...
          await supabase.from("student_test_results").insert({
            ...
            test_name: "Performance Task - Easy 4",
            score: percentage,
            total_questions: 1,
        ...
        <main className="container mx-auto px-4 py-10">
          ...
          <Card className="mx-auto max-w-3xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              <CardTitle className="text-2xl text-amber-800">Grade 5 Language Arts Performance Task Easy 4</CardTitle>
              <p className="text-slate-600">Topic: Healthy Eating at School</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
              <div className="rounded-lg border border-amber-200 bg-white p-4">
                <h3 className="mb-2 font-semibold text-slate-800">Task Scenario</h3>
                <p className="text-slate-700">Your school is launching a healthy eating campaign. Read the information, answer the questions, and complete the writing task to show what you have learned.</p>
              </div>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              ...
              <p className="text-slate-600">Grade 5 Language Arts Performance Task Easy 4</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
              ...
              <div className="rounded-lg border border-amber-200 bg-amber-50 p-4">
                ...
                <p className="whitespace-pre-line text-slate-700">Today for lunch I ate rice and peas with steamed callaloo and a piece of baked chicken. The callaloo is a leafy green vegetable that provides iron and vitamins, which help my blood carry oxygen around my body. The chicken is a good source of protein, which helps my muscles grow and repair themselves after exercise.

I also drank a cup of water instead of a juice box. Staying hydrated helps my brain work better during afternoon classes.

One change I would like to make is to bring a piece of fruit like a banana or mango for my morning snack instead of buying chips. Fruit gives me natural energy without too much sugar, so I can focus better in class. I think making small healthy choices every day will help me feel and learn better.</p>
              </div>
      ...
      <main className="container mx-auto px-4 py-10">
        <div className="mx-auto max-w-4xl space-y-6">
          <div className="flex items-center justify-between rounded-lg bg-slate-800 p-4 text-white">
            <div>
              <h1 className="font-bold">Grade 5 Language Arts Performance Task Easy 4</h1>
              <p className="text-sm text-slate-200">Healthy Eating at School</p>
            </div>
          ...
          <Card className="border-blue-200">
            ...
            <CardContent className="space-y-4 p-6 text-slate-700">
              <p>Eating a balanced diet is important for growing children. A healthy meal includes fruits, vegetables, grains, proteins, and dairy products. In Jamaica, traditional foods like yam, breadfruit, callaloo, and fish provide many of the nutrients children need to grow and learn.</p>
              <p>Research shows that students who eat a nutritious breakfast and lunch tend to concentrate better in class and have more energy for sport and play. Skipping meals or eating too many sugary snacks can cause students to feel tired and find it hard to focus.</p>
              <p>Schools can promote healthy eating by offering nutritious food at the tuck shop, teaching students about balanced meals, and encouraging students to bring healthy snacks from home. When students understand why good food matters, they are more likely to make better choices.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-200">
            ...
            <CardContent className="space-y-4 p-6">
              <p className="text-slate-700">Write a short journal entry as a Grade 5 student explaining what you ate for lunch today and whether it was healthy. Describe at least TWO foods and explain what nutrients they provide. Suggest ONE change you could make to eat more healthily.</p>
