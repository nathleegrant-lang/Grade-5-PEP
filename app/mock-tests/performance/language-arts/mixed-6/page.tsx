...
const mcqs: MCQ[] = [
  {
    "question": "According to the source, what is ONE benefit of reading for pleasure?",
    "options": [
      "Children become better athletes",
      "Children develop larger vocabularies and stronger writing skills",
      "Children need less sleep",
      "Children do better only in Maths"
    ],
    "answer": 1
  },
  {
    "question": "How is pleasure reading different from required school reading, according to the source?",
    "options": [
      "It is harder than school reading",
      "It uses different words",
      "It is self-directed and intrinsically motivating \u2014 children choose what they read",
      "It is only allowed on weekends"
    ],
    "answer": 2
  },
  {
    "question": "What is 'Drop Everything and Read' (DEAR) time?",
    "options": [
      "A time when students drop their books on the floor",
      "A period when the entire school pauses for 15\u201320 minutes of silent reading",
      "A competition between classes",
      "A type of reading homework"
    ],
    "answer": 1
  },
  {
    "question": "According to the source, what role do families play in sustaining a reading culture?",
    "options": [
      "Families have no role",
      "Families should replace teachers",
      "When parents read with children at home or visit the school library, students see reading as valued beyond school",
      "Families should only buy expensive books"
    ],
    "answer": 2
  },
  {
    "question": "Which initiative does the source mention to help books reach students' homes?",
    "options": [
      "A book burning programme",
      "Compulsory book purchases",
      "A lending library that allows books to travel home with students",
      "Only e-book subscriptions"
    ],
    "answer": 2
  }
]
...
const shortAnswers: ShortAnswer[] = [
  {
    "question": "Explain why having a variety of genres in the classroom library is important.",
    "answer": "A variety of genres \u2014 including fiction, non-fiction, poetry, graphic novels, and biography \u2014 means students with different interests can find something that appeals to them. When students choose books they genuinely want to read, they are more likely to engage with them deeply and develop a lasting enjoyment of reading rather than reading only when required."
  },
  {
    "question": "Describe how a school can involve families in building a reading culture.",
    "answer": "A school can organise family reading nights where parents and children read together at school, and send home book recommendation lists to guide parents. Creating a lending library that allows students to take books home gives families access to a wider range of books and signals that reading is valued as a daily activity at home as well as at school."
  }
]

export default function PerformanceMixed6Page() {
  ...
  const sourceBodyText = `Research consistently shows that children who read for pleasure — reading books, magazines, or other materials they choose themselves — develop larger vocabularies, stronger writing skills, and a greater ability to empathise with others. Unlike required reading for school assignments, pleasure reading is self-directed and intrinsically motivating. In Jamaica, where access to books can be limited in some communities, schools have an important role in making reading accessible and enjoyable for all students. Schools can foster a reading culture through several approaches. Well-stocked classroom libraries with a variety of genres — fiction, non-fiction, poetry, biography, graphic novels — give students choices that match their interests. 'Drop Everything and Read' (DEAR) time, where the entire school pauses for 15–20 minutes of silent reading, signals that reading is valued. Author visits, book clubs, and reading challenges with meaningful rewards also motivate reluctant readers. Family involvement is crucial to sustaining a reading culture. When parents read alongside their children at home or visit the school library, students see reading as a valued activity beyond school walls. Schools can send home book recommendations, organise family reading nights, and create lending libraries that allow books to travel home with students. Students who read at home as well as at school make the most significant gains in literacy.`
  const writingPromptText = `Write a letter to the parents and guardians of your school, persuading them to support a new reading initiative. Explain why reading for pleasure is important for their children, suggest TWO specific ways they can encourage reading at home, and describe what the school is doing to help. Use information from the source to support your points.`
      ...
      try {
        ...
        if (user) {
          ...
          await supabase.from("student_test_results").insert({
            ...
            test_name: "Performance Task - Mixed 6",
            score: percentage,
            total_questions: 1,
        ...
        <main className="container mx-auto px-4 py-10">
          ...
          <Card className="mx-auto max-w-3xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              <CardTitle className="text-2xl text-amber-800">Grade 5 Language Arts Performance Task Mixed 6</CardTitle>
              <p className="text-slate-600">Topic: Reading for Pleasure in Our School</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
              <div className="rounded-lg border border-amber-200 bg-white p-4">
                <h3 className="mb-2 font-semibold text-slate-800">Task Overview</h3>
                <p className="text-slate-700">Your school wants to encourage more students to read for enjoyment. Read the information and complete all parts of the task.</p>
              </div>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              ...
              <p className="text-slate-600">Grade 5 Language Arts Performance Task Mixed 6</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mx-auto max-w-4xl space-y-6">
          <div className="flex items-center justify-between rounded-lg bg-slate-800 p-4 text-white">
            <div>
              <h1 className="font-bold">Grade 5 Language Arts Performance Task Mixed 6</h1>
              <p className="text-sm text-slate-200">Reading for Pleasure in Our School</p>
            </div>
          ...
          <Card className="border-blue-200">
            ...
            <CardContent className="space-y-4 p-6 text-slate-700">
              <p>Research consistently shows that children who read for pleasure — reading books, magazines, or other materials they choose themselves — develop larger vocabularies, stronger writing skills, and a greater ability to empathise with others. Unlike required reading for school assignments, pleasure reading is self-directed and intrinsically motivating. In Jamaica, where access to books can be limited in some communities, schools have an important role in making reading accessible and enjoyable for all students.</p>
              <p>Schools can foster a reading culture through several approaches. Well-stocked classroom libraries with a variety of genres — fiction, non-fiction, poetry, biography, graphic novels — give students choices that match their interests. 'Drop Everything and Read' (DEAR) time, where the entire school pauses for 15–20 minutes of silent reading, signals that reading is valued. Author visits, book clubs, and reading challenges with meaningful rewards also motivate reluctant readers.</p>
              <p>Family involvement is crucial to sustaining a reading culture. When parents read alongside their children at home or visit the school library, students see reading as a valued activity beyond school walls. Schools can send home book recommendations, organise family reading nights, and create lending libraries that allow books to travel home with students. Students who read at home as well as at school make the most significant gains in literacy.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-200">
            ...
            <CardContent className="space-y-4 p-6">
              <p className="text-slate-700">Write a letter to the parents and guardians of your school, persuading them to support a new reading initiative. Explain why reading for pleasure is important for their children, suggest TWO specific ways they can encourage reading at home, and describe what the school is doing to help. Use information from the source to support your points.</p>
