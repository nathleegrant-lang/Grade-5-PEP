...
const mcqs: MCQ[] = [
  {
    "question": "What is media literacy, according to the source?",
    "options": [
      "Knowing how to turn on a computer",
      "The ability to access, analyse, evaluate, and create media in different forms",
  ...
  },
  {
    ...
    "options": [
      ...
      "Misinformation is shared unknowingly while disinformation is deliberately created to mislead",
      "Misinformation is always about health",
      "Disinformation is less harmful"
    ],
    "answer": 1
  },
  {
    "question": "Which action BEST demonstrates strong media literacy skills?",
    "options": [
      "Sharing every interesting post immediately",
      "Accepting all online information as true",
      "Questioning the source, checking facts, and looking for evidence before believing a claim",
      "Only using one website for all information"
    ],
    "answer": 2
  },
  {
        ...
        <main className="container mx-auto px-4 py-10">
          ...
          <Card className="mx-auto max-w-3xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              <CardTitle className="text-2xl text-amber-800">Grade 5 Performance Task Difficult 10</CardTitle>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              ...
              <p className="text-slate-600">Grade 5 Performance Task Difficult 10</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
      ...
      <main className="container mx-auto px-4 py-10">
        <div className="mx-auto max-w-4xl space-y-6">
          <div className="flex items-center justify-between rounded-lg bg-slate-800 p-4 text-white">
            <div>
              <h1 className="font-bold">Grade 5 Performance Task Difficult 10</h1>
              <p className="text-sm text-slate-200">Media Literacy and Information in the Digital Age</p>
            </div>
