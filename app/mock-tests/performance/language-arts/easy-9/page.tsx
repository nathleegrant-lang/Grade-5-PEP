...
const mcqs: MCQ[] = [
  {
    "question": "According to the source, why is Jamaica's natural environment special?",
    "options": [
      "It has the most rain in the world",
      "It is home to hundreds of unique species found nowhere else",
      "It has the largest forests in the Caribbean",
      "It never experiences pollution"
    ],
    "answer": 1
  },
  {
    "question": "What is ONE effect of littering in rivers, according to the source?",
    "options": [
      "It makes rivers cleaner",
      "It harms wildlife and blocks drains",
  ...
  {
    "question": "Which action can students take to help protect the environment?",
    "options": [
      "Cut down trees",
...
const shortAnswers: ShortAnswer[] = [
  {
    "question": "State ONE human activity that damages the environment and explain its effect.",
    "answer": "Deforestation removes trees, which causes soil to wash away and destroys the habitats of animals that lived in those forests."
  },
  {
    "question": "Give ONE reason why teaching students about environmental care is important.",
    "answer": "Teaching students about the environment helps create responsible citizens who will make better choices to protect nature for future generations."
  }
]

export default function PerformanceEasy9Page() {
  ...
  const sourceBodyText = `The environment includes everything around us — the air, water, land, plants, and animals. In Jamaica, the natural environment is home to hundreds of unique species of plants and animals that are found nowhere else in the world. Protecting this environment is important for the health and wellbeing of all Jamaicans. Human activities such as littering, deforestation, and pollution can damage the environment. When rubbish is thrown in rivers or on the ground, it harms wildlife and blocks drains, causing flooding. When trees are cut down without being replaced, soil can wash away and animals lose their homes. Students can take simple but powerful actions to help. They can pick up litter, plant trees, reduce their use of plastic, and spread the message that a clean environment is everyone's responsibility. Schools that teach environmental care are building a generation of citizens who understand how to protect the natural world.`
  const writingPromptText = `Write a short persuasive paragraph to convince your classmates to join the school's environment club. Give at least TWO reasons why environmental care is important and explain ONE specific action the club could take to help.`
      ...
      try {
        ...
        if (user) {
          ...
          await supabase.from("student_test_results").insert({
            ...
            test_name: "Performance Task - Easy 9",
            score: percentage,
            total_questions: 1,
        ...
        <main className="container mx-auto px-4 py-10">
          ...
          <Card className="mx-auto max-w-3xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              <CardTitle className="text-2xl text-amber-800">Grade 5 Language Arts Performance Task Easy 9</CardTitle>
              <p className="text-slate-600">Topic: Caring for the Environment</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
              <div className="rounded-lg border border-amber-200 bg-white p-4">
                <h3 className="mb-2 font-semibold text-slate-800">Task Scenario</h3>
                <p className="text-slate-700">Your school is starting an environment club. Read the information, answer the questions, and complete the writing task to show how students can help protect Jamaica's environment.</p>
              </div>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              ...
              <p className="text-slate-600">Grade 5 Language Arts Performance Task Easy 9</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
              ...
              <div className="rounded-lg border border-amber-200 bg-amber-50 p-4">
                ...
                <p className="whitespace-pre-line text-slate-700">Do you care about the world you live in? Then join our school environment club — because Jamaica's future depends on what we do today.

Our environment is under threat from pollution, littering, and deforestation. If we do not act now, we risk losing the beautiful rivers, forests, and wildlife that make our island so special. First, a cleaner environment means healthier communities. When we reduce pollution, we improve the air and water that our families depend on. Second, protecting trees and plants helps prevent flooding and keeps our soil rich for farming.

In our environment club, we plan to organise a river clean-up in our community. We will collect rubbish, separate recyclables, and plant new trees along the riverbank. It is a simple action, but together we can make a real difference.

Come and be part of the change. Sign up for the environment club today!</p>
              </div>
      ...
      <main className="container mx-auto px-4 py-10">
        <div className="mx-auto max-w-4xl space-y-6">
          <div className="flex items-center justify-between rounded-lg bg-slate-800 p-4 text-white">
            <div>
              <h1 className="font-bold">Grade 5 Language Arts Performance Task Easy 9</h1>
              <p className="text-sm text-slate-200">Caring for the Environment</p>
            </div>
          ...
          <Card className="border-blue-200">
            ...
            <CardContent className="space-y-4 p-6 text-slate-700">
              <p>The environment includes everything around us — the air, water, land, plants, and animals. In Jamaica, the natural environment is home to hundreds of unique species of plants and animals that are found nowhere else in the world. Protecting this environment is important for the health and wellbeing of all Jamaicans.</p>
              <p>Human activities such as littering, deforestation, and pollution can damage the environment. When rubbish is thrown in rivers or on the ground, it harms wildlife and blocks drains, causing flooding. When trees are cut down without being replaced, soil can wash away and animals lose their homes.</p>
              <p>Students can take simple but powerful actions to help. They can pick up litter, plant trees, reduce their use of plastic, and spread the message that a clean environment is everyone's responsibility. Schools that teach environmental care are building a generation of citizens who understand how to protect the natural world.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-200">
            ...
            <CardContent className="space-y-4 p-6">
              <p className="text-slate-700">Write a short persuasive paragraph to convince your classmates to join the school's environment club. Give at least TWO reasons why environmental care is important and explain ONE specific action the club could take to help.</p>
