...
const taskData = {
  "scenarioTitle": "Sports Day Preparation",
  "scenario": "Your school is preparing for Sports Day. You are helping to organise the relay races and count the medals needed.",
  "parts": [
    {
      "num": 1,
      "title": "Relay Teams",
      "context": "Each relay team has 4 runners. There are 60 students who want to run in the relay.",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Solve problems requiring division",
          "prompt": "(a) How many complete relay teams can be formed?\n(b) How many students will be left over?\n\nShow ALL your working.",
          "modelWorking": "60 \u00f7 4 = 15 teams exactly\n15 \u00d7 4 = 60 \u2014 no remainder\n(a) 15 complete teams\n(b) 0 students left over",
          "modelAnswer": "(a) 15 teams  (b) 0 students left over"
        },
        {
          "num": 2,
          "strand": "Number",
          "objective": "Solve problems involving fractions",
          "prompt": "After the relay, 3 out of every 4 teams that competed received a ribbon.\nIf 12 teams competed, how many teams received a ribbon?\n\nShow ALL your working.",
          "modelWorking": "3/4 of 12 teams = (3 \u00f7 4) \u00d7 12\n= 3 \u00d7 3 = 9 teams",
          "modelAnswer": "9 teams"
        }
      ]
    },
    {
      "num": 2,
      "title": "Medals Needed",
      "context": "Gold, silver, and bronze medals are given for the top 3 places in each of 8 events.",
      "questions": [
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve problems requiring multiplication",
          "prompt": "How many medals are needed in total for all 8 events?\n\nRemember: 3 medals per event (gold, silver, bronze).\n\nShow ALL your working.",
          "modelWorking": "Medals per event = 3 (gold + silver + bronze)\nTotal events = 8\nTotal medals = 8 \u00d7 3 = 24 medals",
          "modelAnswer": "24 medals"
        },
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve multi-step problems involving money",
          "prompt": "Medals cost $120 each.\nWhat is the total cost of all the medals needed?\n\nShow ALL your working.",
          "modelWorking": "Total medals = 24\nCost per medal = $120\nTotal cost = 24 \u00d7 $120 = $2,880",
          "modelAnswer": "$2,880"
        }
      ]
    },
    {
      "num": 3,
      "title": "Drinks for Athletes",
      "context": "Each of the 60 athletes needs 3 cups of water during Sports Day. Each cup holds 200 ml.",
      "questions": [
        {
          "num": 5,
          "strand": "Measurement",
          "objective": "Solve problems involving capacity",
          "prompt": "What is the TOTAL volume of water needed for all athletes?\nGive your answer in millilitres (ml) AND litres (l).\n\nShow ALL your working.",
          "modelWorking": "Cups per athlete = 3\nTotal cups = 60 \u00d7 3 = 180 cups\nVolume per cup = 200 ml\nTotal volume = 180 \u00d7 200 = 36,000 ml\nConvert: 36,000 \u00f7 1,000 = 36 litres",
          "modelAnswer": "36,000 ml  OR  36 litres"
        }
      ]
    }
  ],
...
export default function MathPerfEasy3Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Easy 3",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Easy 3</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Easy 3</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Easy 3</h1>
