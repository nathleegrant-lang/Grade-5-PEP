...
const taskData = {
  "scenarioTitle": "End of Year School Store",
  "scenario": "The school store is closing for the year. You must calculate remaining stock, final sales, and total profit for the year.",
  "parts": [
    {
      "num": 1,
      "title": "Stock Remaining",
      "context": "Items in stock at the end of the year:\n\u2022 45 exercise books (cost price $80 each; selling price $120)\n\u2022 28 rulers (cost price $35 each; selling price $60)\n\u2022 16 pencil sets (cost price $120 each; selling price $185)",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Solve multi-step money problems \u2014 calculate potential revenue",
          "prompt": "Calculate the potential REVENUE if all remaining stock is sold.\n\nShow ALL your working.",
          "modelWorking": "Books: 45 \u00d7 $120 = $5,400\nRulers: 28 \u00d7 $60 = $1,680\nPencil sets: 16 \u00d7 $185 = $2,960\nTotal potential revenue = $5,400 + $1,680 + $2,960 = $10,040",
          "modelAnswer": "$10,040 potential revenue"
        }
      ]
    },
    {
      "num": 2,
      "title": "Cost of Remaining Stock",
      "context": "",
      "questions": [
        {
          "num": 2,
          "strand": "Number",
          "objective": "Calculate total cost of remaining inventory",
          "prompt": "What is the total COST of all remaining stock?\n\nShow ALL your working.",
          "modelWorking": "Books: 45 \u00d7 $80 = $3,600\nRulers: 28 \u00d7 $35 = $980\nPencil sets: 16 \u00d7 $120 = $1,920\nTotal cost = $3,600 + $980 + $1,920 = $6,500",
          "modelAnswer": "$6,500 cost of remaining stock"
        },
        {
          "num": 3,
          "strand": "Number",
          "objective": "Calculate potential profit on remaining stock",
          "prompt": "If all remaining stock is sold, what profit would be made?\n\nShow ALL your working.",
          "modelWorking": "Potential profit = Revenue \u2212 Cost = $10,040 \u2212 $6,500 = $3,540",
          "modelAnswer": "Potential profit = $3,540"
        }
      ]
    },
    {
      ...
      "context": "Throughout the year:\n\u2022 Total annual revenue: $185,600\n\u2022 Total annual expenses: $142,300",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Calculate annual profit and profit margin",
          "prompt": "(a) Calculate the annual profit.\n(b) Express the annual profit as a percentage of revenue.\n\nShow ALL your working.",
          "modelWorking": "(a) Annual profit = $185,600 \u2212 $142,300 = $43,300\n(b) Profit % = (43,300/185,600) \u00d7 100 = 23.3%",
          "modelAnswer": "(a) Annual profit = $43,300  (b) 23.3% profit margin"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Solve problems involving ratios \u2014 expenses:profit",
          "prompt": "Express the ratio of expenses to profit in its simplest form.\n\nShow ALL your working.",
          "modelWorking": "Expenses : Profit = $142,300 : $43,300\nDivide both by 100: 1423 : 433\nCheck GCF: 1423 \u00f7 433 = 3.28... not exact\n433 \u00d7 3 = 1299; 1423 \u2212 1299 = 124\n433 and 124: 433 \u00f7 124 = 3.49...; 124 \u00d7 3 = 372; 433 \u2212 372 = 61\n124 \u00f7 61 = 2.03...; 124 \u2212 122 = 2; 61 \u00f7 2 = not exact\nGCF = 1 (no common factor)\nRatio = 1423 : 433",
          "modelAnswer": "1423 : 433 (cannot be simplified further)"
        }
      ]
    }
  ],
...
export default function MathPerfMixed7Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Mixed 7",
          }),
        }).then(r => r.json())
      )
      ...
      try {
        ...
        if (user) {
          await supabase.from("student_test_results").insert({
            student_id: user.id,
            subject: "Mathematics",
            test_name: "Performance Task - Mixed 7",
            score: percentage,
            total_questions: 1,
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Mixed 7</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Mixed 7</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Mixed 7</h1>
