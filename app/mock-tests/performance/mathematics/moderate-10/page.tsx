...
const taskData = {
  "scenarioTitle": "Field Day Equipment",
  "scenario": "Your school is purchasing equipment for the annual field day. You must manage the ordering, costs, and distribution of equipment.",
  "parts": [
    {
      "num": 1,
      "title": "Equipment Needed",
      "context": "The school needs:\n\u2022 8 relay batons at $450 each\n\u2022 12 shot put balls at $1,800 each\n\u2022 6 long jump rakes at $650 each",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Solve multi-step problems involving money",
          "prompt": "Calculate the total cost of:\n(a) relay batons\n(b) shot put balls\n(c) long jump rakes\n(d) Grand total\n\nShow ALL your working.",
          "modelWorking": "(a) Batons: 8 \u00d7 $450 = $3,600\n(b) Shot put: 12 \u00d7 $1,800 = $21,600\n(c) Rakes: 6 \u00d7 $650 = $3,900\n(d) Total = $3,600 + $21,600 + $3,900 = $29,100",
          "modelAnswer": "(a) $3,600  (b) $21,600  (c) $3,900  (d) $29,100"
        },
        {
          "num": 2,
          "strand": "Number",
          "objective": "Solve problems involving fractions of totals",
          "prompt": "What fraction of the total cost do the shot put balls represent? Simplify.\n\nShow ALL your working.",
          "modelWorking": "Fraction = 21,600/29,100\nDivide by 300: 72/97\nGCF(72,97) = 1 (97 is prime)\nFraction = 72/97",
          "modelAnswer": "72/97"
        }
      ]
    },
    {
      "num": 2,
      "title": "Sharing Among Houses",
      "context": "Equipment is shared equally among 4 school houses.",
      "questions": [
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve division problems",
          "prompt": "(a) Relay batons per house? Any remainder?\n(b) Shot put balls per house? Any remainder?\n\nShow ALL your working.",
          "modelWorking": "(a) 8 \u00f7 4 = 2 batons each, no remainder\n(b) 12 \u00f7 4 = 3 balls each, no remainder",
          "modelAnswer": "(a) 2 batons each  (b) 3 balls each"
        }
      ]
    },
    {
      ...
      "context": "The field day budget is $35,000.",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Calculate remaining budget and further purchases",
          "prompt": "(a) Money remaining after equipment?\n(b) Whistles cost $280 each. How many can be bought?\n\nShow ALL your working.",
          "modelWorking": "(a) $35,000 \u2212 $29,100 = $5,900\n(b) $5,900 \u00f7 $280 = 21 remainder $20 \u2192 21 whistles",
          "modelAnswer": "(a) $5,900 remaining  (b) 21 whistles"
        },
        {
          "num": 5,
          "strand": "Statistics",
          "objective": "Calculate mean cost per item",
          "prompt": "Total items = 8 + 12 + 6 = 26 items. Total cost = $29,100.\nCalculate the mean cost per item.\n\nShow ALL your working.",
          "modelWorking": "Mean = $29,100 \u00f7 26 = $1,119.23 (to nearest cent)",
          "modelAnswer": "Mean \u2248 $1,119.23 per item"
        }
      ]
    }
  ],
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Moderate 10",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Moderate 10</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Moderate 10</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Moderate 10</h1>
