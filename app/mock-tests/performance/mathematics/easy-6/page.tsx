...
const taskData = {
  "scenarioTitle": "Birthday Treat Sharing",
  "scenario": "Miss Brown baked cupcakes for the class. She wants every student to get a fair share.",
  "parts": [
    {
      "num": 1,
      "title": "Sharing the Cupcakes",
      "context": "Miss Brown baked 84 cupcakes for 28 students.",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Solve problems requiring division",
          "prompt": "How many cupcakes does each student receive if the cupcakes are shared equally?\n\nShow ALL your working.",
          "modelWorking": "84 \u00f7 28 = 3 cupcakes each\nCheck: 28 \u00d7 3 = 84 \u2713",
          "modelAnswer": "3 cupcakes each"
        },
        {
          "num": 2,
          "strand": "Number",
          "objective": "Solve problems involving fractions",
          "prompt": "Miss Brown keeps 1/7 of the 84 cupcakes for the teachers.\nHow many cupcakes does she keep for the teachers?\n\nShow ALL your working.",
          "modelWorking": "1/7 of 84 = 84 \u00f7 7 = 12 cupcakes for teachers",
          "modelAnswer": "12 cupcakes for teachers"
        }
      ]
    },
    {
      "num": 2,
      "title": "Frosting the Cupcakes",
      "context": "Each cupcake needs 25 ml of frosting.",
      "questions": [
        {
          "num": 3,
          "strand": "Measurement",
          "objective": "Solve problems involving capacity and multiplication",
          "prompt": "How much frosting is needed for ALL 84 cupcakes?\nGive your answer in millilitres (ml) AND litres (l).\n\nShow ALL your working.",
          "modelWorking": "Total frosting = 84 \u00d7 25 ml = 2,100 ml\nConvert: 2,100 \u00f7 1,000 = 2.1 litres",
          "modelAnswer": "2,100 ml  OR  2.1 litres"
        }
      ]
    },
    {
      ...
      "context": "Miss Brown spent $65 on flour, $40 on butter, $28 on eggs, and $35 on sugar.",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve problems requiring addition of money",
          "prompt": "What was the TOTAL cost of Miss Brown's ingredients?\n\nShow ALL your working.",
          "modelWorking": "Total = $65 + $40 + $28 + $35\n     = $105 + $28 + $35\n     = $133 + $35\n     = $168",
          "modelAnswer": "$168"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Solve problems involving sharing costs equally",
          "prompt": "The 28 students want to repay Miss Brown for the ingredients by sharing the cost equally.\nHow much should each student contribute?\n\nShow ALL your working.",
          "modelWorking": "Total cost = $168\nNumber of students = 28\nCost per student = $168 \u00f7 28 = $6 each\nCheck: 28 \u00d7 $6 = $168 \u2713",
          "modelAnswer": "$6 per student"
        }
      ]
    }
  ],
...
export default function MathPerfEasy6Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Easy 6",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Easy 6</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Easy 6</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Easy 6</h1>
