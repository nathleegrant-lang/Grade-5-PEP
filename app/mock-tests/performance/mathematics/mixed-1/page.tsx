...
const taskData = {
  "scenarioTitle": "Community Hall Project",
  "scenario": "Your community is building a new hall for meetings and events. You are on the planning committee and must help with the measurements, materials, and budget.",
  "parts": [
    {
      "num": 1,
      "title": "Hall Dimensions",
      "context": "The rectangular hall measures 18 m long and 12 m wide.\nIt will have a tiled floor and a painted ceiling of the same dimensions.",
      "questions": [
        {
          "num": 1,
          "strand": "Measurement",
          "objective": "Calculate area and perimeter",
          "prompt": "Calculate:\n(a) the PERIMETER of the hall\n(b) the AREA of the floor\n\nShow ALL your working.",
          "modelWorking": "(a) Perimeter = 2 \u00d7 (18 + 12) = 2 \u00d7 30 = 60 m\n(b) Area = 18 \u00d7 12 = 216 m\u00b2",
          "modelAnswer": "(a) 60 m  (b) 216 m\u00b2"
        },
        {
          "num": 2,
          "strand": "Measurement",
          "objective": "Divide area; find number of tiles",
          "prompt": "Floor tiles measure 0.4 m \u00d7 0.4 m.\n(a) What is the area of ONE tile?\n(b) How many tiles are needed for the entire floor?\n\nShow ALL your working.",
          "modelWorking": "(a) Area of one tile = 0.4 \u00d7 0.4 = 0.16 m\u00b2\n(b) Number of tiles = 216 \u00f7 0.16 = 1,350 tiles",
          "modelAnswer": "(a) 0.16 m\u00b2  (b) 1,350 tiles"
        }
      ]
    },
    {
      ...
      "context": "Each floor tile costs $420.\nCeiling paint covers 12 m\u00b2 per tin and costs $1,850 per tin.",
      "questions": [
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve multi-step money problems",
          "prompt": "(a) Total cost of tiles for the floor\n(b) Number of tins of paint needed for the ceiling\n(c) Total cost of paint\n\nShow ALL your working.",
          "modelWorking": "(a) 1,350 \u00d7 $420 = $567,000\n(b) 216 m\u00b2 \u00f7 12 m\u00b2 per tin = 18 tins\n(c) 18 \u00d7 $1,850 = $33,300",
          "modelAnswer": "(a) $567,000  (b) 18 tins  (c) $33,300"
        }
      ]
    },
    {
      "num": 3,
      "title": "Budget and Contributions",
      "context": "The total project budget is $800,000.\nThe community has contributed $350,000 so far.",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve problems: compare spending with budget",
          "prompt": "(a) Total spending on tiles and paint\n(b) How much of the budget is left after tiles and paint?\n\nShow ALL your working.",
          "modelWorking": "(a) Total = $567,000 + $33,300 = $600,300\n(b) Remaining budget = $800,000 \u2212 $600,300 = $199,700",
          "modelAnswer": "(a) $600,300  (b) $199,700 remaining"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Calculate fraction still needed; percentage contributed",
          "prompt": "(a) What fraction of the $800,000 budget has the community contributed? Simplify.\n(b) What percentage of the $800,000 has been contributed?\n\nShow ALL your working.",
          "modelWorking": "(a) 350,000/800,000 = 35/80 = 7/16\n(b) 7/16 \u00d7 100 = 43.75%",
          "modelAnswer": "(a) 7/16  (b) 43.75%"
        }
      ]
    }
  ],
...
export default function MathPerfMixed1Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Mixed 1",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Mixed 1</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Mixed 1</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Mixed 1</h1>
