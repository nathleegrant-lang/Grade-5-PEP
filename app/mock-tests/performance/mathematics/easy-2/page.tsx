...
const taskData = {
  "scenarioTitle": "The School Tuck Shop",
  "scenario": "The school tuck shop sells snacks every day. You are helping the tuck shop keeper calculate sales, change, and restock needs for Friday.",
  "parts": [
    {
      "num": 1,
      "title": "Friday Sales",
      "context": "On Friday the tuck shop sold:\n\u2022 24 buns at $35 each\n\u2022 18 juices at $50 each\n\u2022 30 peanut drops at $15 each",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Solve problems requiring multiplication",
          "prompt": "Calculate the total amount of money collected from selling:\n(a) all the buns\n(b) all the juices\n(c) all the peanut drops\n\nShow ALL your working.",
          "modelWorking": "(a) Buns: 24 \u00d7 $35 = $840\n(b) Juices: 18 \u00d7 $50 = $900\n(c) Peanut drops: 30 \u00d7 $15 = $450",
          "modelAnswer": "(a) $840  (b) $900  (c) $450"
        },
        {
          "num": 2,
          "strand": "Number",
          "objective": "Solve problems requiring addition and multiplication",
          "prompt": "What was the TOTAL amount collected from ALL sales on Friday?\n\nShow ALL your working.",
          "modelWorking": "Total = $840 + $900 + $450\n     = $1,740 + $450\n     = $2,190",
          "modelAnswer": "$2,190"
        }
      ]
    },
    {
      "num": 2,
      "title": "Making Change",
      "context": "A student buys 2 buns and 1 juice. She pays with a $200 bill.",
      "questions": [
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve problems involving money and change",
          "prompt": "How much change should the student receive?\n\nShow ALL your working.",
          "modelWorking": "Cost of 2 buns = 2 \u00d7 $35 = $70\nCost of 1 juice = $50\nTotal spent = $70 + $50 = $120\nChange = $200 \u2212 $120 = $80",
          "modelAnswer": "$80 change"
        }
      ]
    },
    {
      "num": 3,
      "title": "Restocking",
      "context": "The tuck shop wants to restock buns. Buns are sold in packs of 12. The shop wants to have enough buns for 96 students.",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve problems requiring division",
          "prompt": "How many PACKS of buns should the tuck shop order?\n\nShow ALL your working.",
          "modelWorking": "96 students \u00f7 12 buns per pack = 8 packs exactly\n(8 \u00d7 12 = 96 buns)",
          "modelAnswer": "8 packs"
        },
        {
          "num": 5,
          ...
          "prompt": "Each pack of buns costs $350 wholesale.\nWhat is the TOTAL cost to buy 8 packs?\n\nShow ALL your working.",
          "modelWorking": "Total cost = 8 \u00d7 $350 = $2,800",
          "modelAnswer": "$2,800"
        }
      ]
    }
...
export default function MathPerfEasy2Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Easy 2",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Easy 2</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Easy 2</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Easy 2</h1>
