...
const taskData = {
  "scenarioTitle": "The Science Lab Experiment",
  "scenario": "Your class is doing a science experiment that requires precise measurement of liquids and solids.",
  "parts": [
    {
      "num": 1,
      "title": "Mixing Solutions",
      "context": "The experiment requires a mixture of three liquids:\n\u2022 Solution A: 350 ml\n\u2022 Solution B: 475 ml\n\u2022 Solution C: 225 ml",
      "questions": [
        {
          "num": 1,
          "strand": "Measurement",
          "objective": "Add decimal measurements of capacity",
          "prompt": "(a) What is the TOTAL volume of the mixture?\n(b) Convert to litres.\n\nShow ALL your working.",
          "modelWorking": "(a) Total = 350 + 475 + 225 = 1,050 ml\n(b) 1,050 \u00f7 1,000 = 1.05 litres",
          "modelAnswer": "(a) 1,050 ml  (b) 1.05 litres"
        },
        {
          "num": 2,
          "strand": "Measurement",
          "objective": "Solve problems involving fractions of liquids",
          "prompt": "Solution A makes up what fraction of the total mixture?\nSimplify your answer.\n\nShow ALL your working.",
          "modelWorking": "Fraction = 350/1050\nSimplify: GCF of 350 and 1050\n1050 \u00f7 350 = 3 exactly\nSo 350/1050 = 1/3",
          "modelAnswer": "1/3"
        }
      ]
    },
    {
      "num": 2,
      "title": "Dividing Among Groups",
      "context": "The class is divided into 7 equal groups. Each group receives an equal share of the total mixture.",
      "questions": [
        {
          "num": 3,
          "strand": "Measurement",
          "objective": "Divide to share equally; express as decimal",
          "prompt": "How many millilitres does each group receive?\n\nShow ALL your working.",
          "modelWorking": "Total mixture = 1,050 ml\n1,050 \u00f7 7 = 150 ml per group\nCheck: 7 \u00d7 150 = 1,050 \u2713",
          "modelAnswer": "150 ml per group"
        }
      ]
    },
    {
      "num": 3,
      "title": "Weighing Solids",
      "context": "Each group also needs 45.5 g of salt for their experiment.",
      "questions": [
        {
          "num": 4,
          "strand": "Measurement",
          "objective": "Multiply decimals \u2014 total mass",
          "prompt": "What is the total mass of salt needed for ALL 7 groups?\nGive your answer in grams (g) AND kilograms (kg).\n\nShow ALL your working.",
          "modelWorking": "Total salt = 7 \u00d7 45.5 g = 318.5 g\nConvert: 318.5 \u00f7 1,000 = 0.3185 kg",
          "modelAnswer": "318.5 g  OR  0.3185 kg"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Solve problems involving money \u2014 cost of materials",
          "prompt": "Salt costs $85 per 100 g.\n(a) How many 100 g portions are needed?\n(b) What is the total cost of the salt?\n\nShow ALL your working.",
          "modelWorking": "(a) Total salt needed = 318.5 g\n    318.5 \u00f7 100 = 3.185 portions\n    Must buy 4 portions (to have enough)\n    4 \u00d7 100 g = 400 g (with 81.5 g spare)\n(b) Cost = 4 \u00d7 $85 = $340",
          "modelAnswer": "(a) 4 portions of 100 g  (b) $340"
        }
      ]
    }
  ],
...
export default function MathPerfModerate8Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Moderate 8",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Moderate 8</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Moderate 8</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Moderate 8</h1>
