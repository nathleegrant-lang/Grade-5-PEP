...
const taskData = {
  "scenarioTitle": "The Computer Lab Budget",
  "scenario": "Your school is buying new computers for the lab. You are helping to plan the purchase and the room layout.",
  "parts": [
    {
      "num": 1,
      "title": "How Many Computers to Buy",
      "context": "The school has a budget of $750,000 for computers.\nEach computer costs $62,500.",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Solve problems requiring division \u2014 purchasing within a budget",
          "prompt": "(a) How many computers can the school buy within the budget?\n(b) How much money will be left over?\n\nShow ALL your working.",
          "modelWorking": "(a) $750,000 \u00f7 $62,500 = 12 computers\n    Check: 12 \u00d7 $62,500 = $750,000 \u2713\n(b) $750,000 \u2212 $750,000 = $0 remaining",
          "modelAnswer": "(a) 12 computers  (b) $0 remaining (exactly within budget)"
        }
      ]
    },
    {
      "num": 2,
      "title": "Room Layout",
      "context": "The computer lab is a rectangle 9 m \u00d7 7 m.\nEach computer station needs a space of 1.5 m \u00d7 1.2 m.",
      "questions": [
        {
          "num": 2,
          "strand": "Measurement",
          "objective": "Calculate area; compare with station requirements",
          "prompt": "(a) What is the area of the computer lab?\n(b) What is the area of ONE computer station?\n(c) Theoretically, how many stations fit in the lab by area alone?\n\nShow ALL your working.",
          "modelWorking": "(a) Lab area = 9 \u00d7 7 = 63 m\u00b2\n(b) Station area = 1.5 \u00d7 1.2 = 1.8 m\u00b2\n(c) 63 \u00f7 1.8 = 35 stations (theoretical maximum)",
          "modelAnswer": "(a) 63 m\u00b2  (b) 1.8 m\u00b2 per station  (c) Max 35 stations theoretically"
        },
        {
          "num": 3,
          "strand": "Number",
          "objective": "Interpret results practically",
          "prompt": "The school bought 12 computers.\nIf the 12 stations are arranged in 3 equal rows, how many stations are in each row?\n\nShow ALL your working.",
          "modelWorking": "12 stations \u00f7 3 rows = 4 stations per row\nCheck: 3 \u00d7 4 = 12 \u2713",
          "modelAnswer": "4 stations per row"
        }
      ]
    },
    {
      ...
      "context": "Each computer also needs:\n\u2022 1 mouse: $1,800\n\u2022 1 keyboard: $2,500\n\u2022 1 surge protector: $3,200\n\nThe school has an additional budget of $90,000 for accessories for all 12 computers.",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve multi-step problems involving money",
          "prompt": "What is the TOTAL cost of accessories for ONE computer?\n\nShow ALL your working.",
          "modelWorking": "Cost per computer = $1,800 + $2,500 + $3,200 = $7,500",
          "modelAnswer": "$7,500 per computer"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Multiply and compare with budget",
          "prompt": "(a) What is the TOTAL cost of accessories for all 12 computers?\n(b) Does it fit within the $90,000 accessory budget? How much is left (or over)?\n\nShow ALL your working.",
          "modelWorking": "(a) Total = 12 \u00d7 $7,500 = $90,000\n(b) $90,000 \u2212 $90,000 = $0 \u2014 exactly fits the budget with nothing remaining.",
          "modelAnswer": "(a) $90,000  (b) Exactly within budget \u2014 $0 remaining"
        }
      ]
    }
  ],
...
export default function MathPerfDifficult2Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Difficult 2",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Difficult 2</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Difficult 2</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Difficult 2</h1>
