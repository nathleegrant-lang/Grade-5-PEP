...
const taskData = {
  "scenarioTitle": "Market Day Profit and Loss",
  "scenario": "Students from Grade 5 are running market day stalls. You are the financial controller.",
  "parts": [
    {
      "num": 1,
      "title": "Setting Up Three Stalls",
      "context": "Three stalls each had different setup costs:\n\u2022 Stall A (jewellery): $3,200\n\u2022 Stall B (food): $5,800\n\u2022 Stall C (crafts): $2,900",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Solve problems requiring addition and comparison",
          "prompt": "(a) What was the TOTAL setup cost for all three stalls?\n(b) Which stall was the cheapest to set up?\n(c) By how much was Stall B more expensive than Stall C to set up?\n\nShow ALL your working.",
          "modelWorking": "(a) Total = $3,200 + $5,800 + $2,900 = $11,900\n(b) Cheapest: Stall C at $2,900\n(c) Difference = $5,800 \u2212 $2,900 = $2,900",
          "modelAnswer": "(a) $11,900  (b) Stall C  (c) $2,900 difference"
        }
      ]
    },
    {
      "num": 2,
      "title": "Revenue from Each Stall",
      "context": "Sales revenue:\n\u2022 Stall A: $8,750\n\u2022 Stall B: $14,300\n\u2022 Stall C: $6,500",
      "questions": [
        {
          "num": 2,
          "strand": "Number",
          "objective": "Calculate profit for each stall and total",
          "prompt": "(a) Calculate the individual profit for each stall.\n(b) What was the TOTAL profit from all three stalls?\n\nShow ALL your working.",
          "modelWorking": "(a) Stall A: $8,750 \u2212 $3,200 = $5,550 profit\n    Stall B: $14,300 \u2212 $5,800 = $8,500 profit\n    Stall C: $6,500 \u2212 $2,900 = $3,600 profit\n(b) Total profit = $5,550 + $8,500 + $3,600 = $17,650",
          "modelAnswer": "(a) A: $5,550 | B: $8,500 | C: $3,600  (b) Total = $17,650"
        },
        {
          "num": 3,
          "strand": "Number",
          "objective": "Express each stall's profit as percentage of total profit",
          "prompt": "What percentage of the total profit did each stall contribute?\n\nShow ALL your working.",
          "modelWorking": "Total profit = $17,650\nStall A: 5,550/17,650 \u00d7 100 \u2248 31.4%\nStall B: 8,500/17,650 \u00d7 100 \u2248 48.2%\nStall C: 3,600/17,650 \u00d7 100 \u2248 20.4%\nCheck: 31.4 + 48.2 + 20.4 = 100% \u2713",
          "modelAnswer": "Stall A \u2248 31.4% | Stall B \u2248 48.2% | Stall C \u2248 20.4%"
        }
      ]
    },
    {
      "num": 3,
      "title": "Sharing the Profits",
      "context": "The total profit of $17,650 is shared: 40% to the school, 60% shared equally among the 3 stalls.",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve problems involving percentages and equal sharing",
          "prompt": "(a) How much does the school receive?\n(b) How much does each stall receive from its share?\n\nShow ALL your working.",
          "modelWorking": "(a) School receives: 40% of $17,650 = 0.40 \u00d7 $17,650 = $7,060\n(b) Stalls share: 60% of $17,650 = 0.60 \u00d7 $17,650 = $10,590\n    Per stall = $10,590 \u00f7 3 = $3,530",
          "modelAnswer": "(a) School receives $7,060  (b) Each stall receives $3,530"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Solve problems involving ratio",
          "prompt": "Express the ratio of school share : each stall share in its simplest form.\n\nShow ALL your working.",
          "modelWorking": "School : each stall = $7,060 : $3,530\nDivide both by $3,530: 2 : 1",
          "modelAnswer": "2 : 1"
        }
      ]
    }
...
export default function MathPerfDifficult9Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Difficult 9",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Difficult 9</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Difficult 9</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Difficult 9</h1>
