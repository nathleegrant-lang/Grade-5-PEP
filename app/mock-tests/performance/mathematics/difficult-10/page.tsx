...
const taskData = {
  "scenarioTitle": "The Environmental Cleanup Project",
  "scenario": "Your school is organising a cleanup of a nearby river and its banks. You are the project coordinator managing area, volunteers, waste, and budget.",
  "parts": [
    {
      "num": 1,
      "title": "River Bank Area",
      "context": "The cleanup covers both sides of a 450 m stretch of river. Each bank is 3.5 m wide.",
      "questions": [
        {
          "num": 1,
          "strand": "Measurement",
          "objective": "Calculate total area",
          "prompt": "(a) Area of ONE river bank\n(b) Total area of BOTH banks\nConvert answers to hectares (1 ha = 10,000 m\u00b2).\n\nShow ALL your working.",
          "modelWorking": "(a) One bank: 450 \u00d7 3.5 = 1,575 m\u00b2 = 0.1575 ha\n(b) Both banks: 2 \u00d7 1,575 = 3,150 m\u00b2 = 0.315 ha",
          "modelAnswer": "(a) 1,575 m\u00b2 = 0.1575 ha  (b) 3,150 m\u00b2 = 0.315 ha"
        }
      ]
    },
    {
      ...
      "context": "85 volunteers are divided into teams of 5. Total bank length = 900 m (both sides).",
      "questions": [
        {
          "num": 2,
          "strand": "Number",
          "objective": "Divide volunteers into teams; find length per team",
          "prompt": "(a) How many teams of 5?\n(b) Approximately how many metres of bank does each team clean?\n\nShow ALL your working.",
          "modelWorking": "(a) 85 \u00f7 5 = 17 teams\n(b) 900 \u00f7 17 \u2248 52.9 m per team",
          "modelAnswer": "(a) 17 teams  (b) \u2248 52.9 m per team"
        },
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve ratio and money problems",
          "prompt": "Volunteers receive a $850 meal each.\n(a) Total meal cost for 85 volunteers?\n(b) Cost split school:sponsor = 2:3. How much each?\n\nShow ALL your working.",
          "modelWorking": "(a) Total = 85 \u00d7 $850 = $72,250\n(b) School (2/5) = $28,900; Sponsor (3/5) = $43,350",
          "modelAnswer": "(a) $72,250  (b) School: $28,900 | Sponsor: $43,350"
        }
      ]
    },
    {
      ...
      "context": "680 kg of waste collected: 45% recyclable, 30% organic, 25% landfill.",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Calculate percentages of quantities",
          "prompt": "Calculate the mass of each waste type.\n\nShow ALL your working.",
          "modelWorking": "Recyclable: 0.45 \u00d7 680 = 306 kg\nOrganic: 0.30 \u00d7 680 = 204 kg\nNon-recyclable: 0.25 \u00d7 680 = 170 kg\nCheck: 306+204+170 = 680 \u2713",
          "modelAnswer": "Recyclable: 306 kg | Organic: 204 kg | Non-recyclable: 170 kg"
        },
        {
          "num": 5,
          "strand": "Statistics",
          "objective": "Calculate mean waste per team",
          "prompt": "17 teams collected the 680 kg total.\nCalculate the MEAN waste per team.\n\nShow ALL your working.",
          "modelWorking": "Mean = 680 \u00f7 17 = 40 kg per team",
          "modelAnswer": "Mean = 40 kg per team"
        }
      ]
    }
  ],
...
export default function MathPerfDifficult10Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Difficult 10",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Difficult 10</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Difficult 10</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Difficult 10</h1>
