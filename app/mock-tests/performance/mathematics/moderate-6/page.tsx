...
const taskData = {
  "scenarioTitle": "The School Fence",
  "scenario": "Your school is building a fence around its rectangular sports field. You must calculate the materials needed.",
  "parts": [
    {
      "num": 1,
      "title": "Measurements of the Field",
      "context": "The rectangular sports field is 85 m long and 60 m wide.",
      "questions": [
        {
          "num": 1,
          "strand": "Measurement",
          ...
          "modelWorking": "(a) Perimeter = 2 \u00d7 (length + width) = 2 \u00d7 (85 + 60) = 2 \u00d7 145 = 290 m\n(b) Area = length \u00d7 width = 85 \u00d7 60 = 5,100 m\u00b2",
          "modelAnswer": "(a) Perimeter = 290 m  (b) Area = 5,100 m\u00b2"
        }
      ]
    },
    {
      "num": 2,
      "title": "Fence Posts",
      "context": "Fence posts are placed every 5 metres around the entire perimeter.",
      "questions": [
        {
          "num": 2,
          "strand": "Number",
          "objective": "Solve problems requiring division",
          "prompt": "How many fence posts are needed?\n\nHint: Divide the perimeter by 5. (Include the starting post.)\n\nShow ALL your working.",
          "modelWorking": "Number of spaces = 290 \u00f7 5 = 58 spaces\nFor a closed fence (rectangle), number of posts = number of spaces = 58 posts\nCheck: 58 \u00d7 5 m = 290 m \u2713",
          "modelAnswer": "58 fence posts"
        },
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve multi-step problems involving money",
          "prompt": "Each fence post costs $380.\nWhat is the total cost of all the fence posts?\n\nShow ALL your working.",
          "modelWorking": "Cost = 58 \u00d7 $380\n= 50 \u00d7 $380 + 8 \u00d7 $380\n= $19,000 + $3,040\n= $22,040",
          "modelAnswer": "$22,040"
        }
      ]
    },
    {
      "num": 3,
      "title": "Fencing Wire",
      "context": "Fencing wire covers the perimeter. Wire costs $195 per metre.",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve problems involving multiplication \u2014 cost per metre",
          "prompt": "What is the total cost of fencing wire for the entire perimeter?\n\nShow ALL your working.",
          "modelWorking": "Total cost = 290 m \u00d7 $195\n= 290 \u00d7 $200 \u2212 290 \u00d7 $5\n= $58,000 \u2212 $1,450\n= $56,550",
          "modelAnswer": "$56,550"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Solve problems requiring addition \u2014 grand total",
          "prompt": "What is the TOTAL cost of both the fence posts AND the fencing wire?\n\nShow ALL your working.",
          "modelWorking": "Posts = $22,040\nWire = $56,550\nGrand total = $22,040 + $56,550 = $78,590",
          "modelAnswer": "$78,590 total"
        }
      ]
    }
  ],
...
export default function MathPerfModerate6Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Moderate 6",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Moderate 6</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Moderate 6</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Moderate 6</h1>
