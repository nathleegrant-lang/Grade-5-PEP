...
const taskData = {
  "scenarioTitle": "The Lunch Programme",
  "scenario": "Your school serves 280 students lunch every day. You are managing the food ordering and cost.",
  "parts": [
    {
      "num": 1,
      "title": "Daily Food Requirements",
      "context": "Each student receives:\n\u2022 1 bread roll (80 g each)\n\u2022 1 cup of soup (250 ml)\n\u2022 1 juice box (200 ml)",
      "questions": [
        {
          "num": 1,
          "strand": "Measurement",
          "objective": "Multiply to find total mass and volume",
          "prompt": "For ALL 280 students, calculate the total:\n(a) mass of bread rolls in grams, then convert to kilograms\n(b) volume of soup in ml, then convert to litres\n\nShow ALL your working.",
          "modelWorking": "(a) Bread: 280 \u00d7 80 g = 22,400 g = 22.4 kg\n(b) Soup: 280 \u00d7 250 ml = 70,000 ml = 70 litres",
          "modelAnswer": "(a) 22,400 g = 22.4 kg  (b) 70,000 ml = 70 litres"
        },
        {
          "num": 2,
          "strand": "Measurement",
          "objective": "Divide to find containers needed",
          "prompt": "Soup is stored in 5-litre pots.\nHow many pots of soup are needed per day?\n\nShow ALL your working.",
          "modelWorking": "70 litres \u00f7 5 litres per pot = 14 pots\nCheck: 14 \u00d7 5 = 70 \u2713",
          "modelAnswer": "14 pots of soup per day"
        }
      ]
    },
    {
      "num": 2,
      "title": "Weekly Cost",
      "context": "Daily costs:\n\u2022 Bread rolls: $12 per kg\n\u2022 Soup ingredients: $850 per pot\n\u2022 Juice boxes: $45 each",
      "questions": [
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve multi-step money problems",
          "prompt": "Calculate the total DAILY cost of the lunch programme.\n\nShow ALL your working.",
          "modelWorking": "Bread: 22.4 kg \u00d7 $12 = $268.80\nSoup: 14 \u00d7 $850 = $11,900\nJuice: 280 \u00d7 $45 = $12,600\nTotal daily = $268.80 + $11,900 + $12,600 = $24,768.80",
          "modelAnswer": "$24,768.80 per day"
        },
        {
          "num": 4,
          "strand": "Number",
          "objective": "Multiply for weekly total; divide for per-student cost",
          "prompt": "(a) The school runs the programme 5 days per week.\n    What is the WEEKLY cost?\n(b) What is the cost per student per day?\n\nShow ALL your working.",
          "modelWorking": "(a) Weekly = $24,768.80 \u00d7 5 = $123,844\n(b) Per student = $24,768.80 \u00f7 280 = $88.46",
          "modelAnswer": "(a) $123,844 per week  (b) $88.46 per student per day"
        }
      ]
    },
    {
      ...
      "context": "Last year, the daily cost was $19,500 for the same number of students.",
      "questions": [
        {
          "num": 5,
          "strand": "Number",
          "objective": "Calculate increase; express as percentage",
          "prompt": "(a) By how much has the daily cost increased from last year?\n(b) Express this increase as a percentage of last year's cost.\n\nShow ALL your working.",
          "modelWorking": "(a) Increase = $24,768.80 \u2212 $19,500 = $5,268.80\n(b) % increase = 5268.80/19500 \u00d7 100 = 27.02%",
          "modelAnswer": "(a) Increased by $5,268.80  (b) \u2248 27.0% increase"
        }
      ]
    }
  ],
...
export default function MathPerfMixed3Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Mixed 3",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Mixed 3</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Mixed 3</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Mixed 3</h1>
