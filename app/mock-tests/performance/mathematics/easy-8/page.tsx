...
const taskData = {
  "scenarioTitle": "Water for the Athletes",
  "scenario": "Your school is hosting a community 5km road race. You are in charge of the water station.",
  "parts": [
    {
      "num": 1,
      "title": "Cups of Water Needed",
      "context": "There are 150 runners. Each runner will need 4 cups of water during the race.",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Solve problems requiring multiplication",
          "prompt": "How many cups of water are needed in TOTAL?\n\nShow ALL your working.",
          "modelWorking": "Total cups = 150 runners \u00d7 4 cups each\n           = 600 cups",
          "modelAnswer": "600 cups"
        }
      ]
    },
    {
      ...
      "context": "Each cup holds 300 ml of water.",
      "questions": [
        {
          "num": 2,
          "strand": "Measurement",
          "objective": "Solve problems involving capacity",
          "prompt": "(a) What is the total volume of water needed in millilitres?\n(b) Convert your answer to litres.\n\nShow ALL your working.",
          "modelWorking": "(a) Total ml = 600 cups \u00d7 300 ml = 180,000 ml\n(b) Convert: 180,000 \u00f7 1,000 = 180 litres",
          "modelAnswer": "(a) 180,000 ml  (b) 180 litres"
        },
        {
          "num": 3,
          "strand": "Measurement",
          "objective": "Solve problems involving capacity and division",
          "prompt": "Water is delivered in 20-litre containers.\nHow many containers are needed?\n\nUse your answer from Question 2.\n\nShow ALL your working.",
          "modelWorking": "Total water needed = 180 litres\n180 \u00f7 20 = 9 containers exactly\nCheck: 9 \u00d7 20 = 180 \u2713",
          "modelAnswer": "9 containers"
        }
      ]
    },
    {
      ...
      "context": "Each 20-litre container of water costs $450.\nThe school has a budget of $5,000 for water.",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve multi-step problems involving money",
          "prompt": "What is the total cost of all the water containers needed?\n\nShow ALL your working.",
          "modelWorking": "Number of containers = 9 (from Question 3)\nCost per container = $450\nTotal cost = 9 \u00d7 $450 = $4,050",
          "modelAnswer": "$4,050"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Solve problems involving money \u2014 compare with budget",
          "prompt": "How much money is left from the $5,000 budget after paying for the water?\n\nShow ALL your working.",
          "modelWorking": "Budget = $5,000\nTotal water cost = $4,050\nMoney remaining = $5,000 \u2212 $4,050 = $950",
          "modelAnswer": "$950 remaining"
        }
      ]
    }
  ],
...
export default function MathPerfEasy8Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Easy 8",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Easy 8</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Easy 8</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Easy 8</h1>
