...
const taskData = {
  "scenarioTitle": "The School Garden",
  "scenario": "Your school has a rectangular garden plot that will be used to grow vegetables. You are helping to plan the planting.",
  "parts": [
    {
      "num": 1,
      "title": "Planning the Garden",
      "context": "The rectangular garden measures 12 m long and 8 m wide.",
      "questions": [
        {
          "num": 1,
          "strand": "Measurement",
          "objective": "Calculate perimeter of rectangles",
          "prompt": "Calculate the PERIMETER of the garden.\n\nRemember: Perimeter = 2 \u00d7 (length + width)\n\nShow ALL your working.",
          "modelWorking": "Perimeter = 2 \u00d7 (length + width)\n           = 2 \u00d7 (12 + 8)\n           = 2 \u00d7 20\n           = 40 m",
          "modelAnswer": "40 m"
        },
        {
          "num": 2,
          "strand": "Measurement",
          "objective": "Calculate area of rectangles",
          "prompt": "Calculate the AREA of the garden.\n\nRemember: Area = length \u00d7 width\n\nShow ALL your working.",
          "modelWorking": "Area = length \u00d7 width\n     = 12 \u00d7 8\n     = 96 m\u00b2",
          "modelAnswer": "96 m\u00b2"
        }
      ]
    },
    {
      "num": 2,
      "title": "Planting Rows",
      "context": "The teacher divides the 96 m\u00b2 garden into equal sections:\n\u2022 1/4 for tomatoes\n\u2022 1/3 for callaloo\n\u2022 The rest for peppers",
      "questions": [
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve problems involving fractions of quantities",
          "prompt": "(a) What area is used for tomatoes?\n(b) What area is used for callaloo?\n\nShow ALL your working.",
          "modelWorking": "(a) Tomatoes: 1/4 of 96 = 96 \u00f7 4 = 24 m\u00b2\n(b) Callaloo: 1/3 of 96 = 96 \u00f7 3 = 32 m\u00b2",
          "modelAnswer": "(a) 24 m\u00b2 for tomatoes  (b) 32 m\u00b2 for callaloo"
        },
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve problems involving fractions and subtraction",
          "prompt": "What area is left for peppers?\n\nShow ALL your working.",
          "modelWorking": "Area for tomatoes = 24 m\u00b2\nArea for callaloo = 32 m\u00b2\nArea for peppers = 96 \u2212 24 \u2212 32 = 40 m\u00b2",
          "modelAnswer": "40 m\u00b2 for peppers"
        }
      ]
    },
    {
      "num": 3,
      "title": "Fencing Cost",
      "context": "The school needs to fence the perimeter of the garden. Fencing costs $350 per metre.",
      "questions": [
        {
          "num": 5,
          "strand": "Number",
          "objective": "Solve multi-step problems involving money and measurement",
          "prompt": "What is the total cost to fence the entire garden?\n\nUse your answer from Question 1.\n\nShow ALL your working.",
          "modelWorking": "Perimeter = 40 m (from Question 1)\nCost per metre = $350\nTotal cost = 40 \u00d7 $350 = $14,000",
          "modelAnswer": "$14,000"
        }
      ]
    }
...
export default function MathPerfEasy4Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Easy 4",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Easy 4</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Easy 4</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Easy 4</h1>
