...
const taskData = {
  "scenarioTitle": "The School Carnival",
  "scenario": "Your school is hosting a carnival to raise funds. You are managing the games, food, and finances.",
  "parts": [
    {
      "num": 1,
      "title": "Game Tickets",
      "context": "The carnival has 5 game booths. Each booth starts with 200 tickets.\nBy the end of the day, the remaining tickets are:\nBooth 1: 48, Booth 2: 35, Booth 3: 62, Booth 4: 19, Booth 5: 74",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Subtract to find tickets sold; add totals",
          "prompt": "(a) How many tickets were SOLD at each booth?\n(b) What was the TOTAL number of tickets sold across all booths?\n\nShow ALL your working.",
          "modelWorking": "(a) Booth 1: 200\u221248=152, Booth 2: 200\u221235=165, Booth 3: 200\u221262=138, Booth 4: 200\u221219=181, Booth 5: 200\u221274=126\n(b) Total = 152+165+138+181+126 = 762 tickets",
          "modelAnswer": "(a) 152, 165, 138, 181, 126  (b) 762 tickets total"
        },
        {
          "num": 2,
          "strand": "Statistics",
          "objective": "Calculate mean tickets sold per booth",
          "prompt": "Calculate the MEAN number of tickets sold per booth.\n\nShow ALL your working.",
          "modelWorking": "Mean = 762 \u00f7 5 = 152.4 tickets per booth",
          "modelAnswer": "Mean = 152.4 tickets per booth"
        }
      ]
    },
    {
      "num": 2,
      "title": "Food Sales",
      "context": "Food items sold and their prices:\n\u2022 Jerk chicken: 85 portions at $450 each\n\u2022 Snow cones: 130 at $120 each\n\u2022 Bag juice: 200 at $80 each",
      "questions": [
        {
          "num": 3,
          "strand": "Number",
          "objective": "Multiply and add to find total food revenue",
          "prompt": "Calculate the total revenue from food sales.\n\nShow ALL your working.",
          "modelWorking": "Jerk chicken: 85 \u00d7 $450 = $38,250\nSnow cones: 130 \u00d7 $120 = $15,600\nBag juice: 200 \u00d7 $80 = $16,000\nTotal = $38,250 + $15,600 + $16,000 = $69,850",
          "modelAnswer": "$69,850 from food sales"
        }
      ]
    },
    {
      "num": 3,
      "title": "Combining Revenue and Expenses",
      "context": "Each game ticket cost $50. Carnival expenses totalled $42,000.",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Calculate total revenue; then profit",
          "prompt": "(a) Total ticket revenue (762 tickets at $50 each)\n(b) Total revenue (tickets + food)\n(c) Profit = Total Revenue \u2212 Expenses\n\nShow ALL your working.",
          "modelWorking": "(a) Ticket revenue = 762 \u00d7 $50 = $38,100\n(b) Total = $38,100 + $69,850 = $107,950\n(c) Profit = $107,950 \u2212 $42,000 = $65,950",
          "modelAnswer": "(a) $38,100  (b) $107,950  (c) Profit = $65,950"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Express profit as percentage; solve ratio problem",
          "prompt": "(a) Express the profit as a percentage of total revenue (to 1 decimal place).\n(b) The profit is split 3:2 between the school fund and the PTA. How much does each receive?\n\nShow ALL your working.",
          "modelWorking": "(a) 65,950/107,950 \u00d7 100 = 61.1%\n(b) Total parts = 3+2 = 5\n    School fund: 3/5 \u00d7 $65,950 = $39,570\n    PTA: 2/5 \u00d7 $65,950 = $26,380",
          "modelAnswer": "(a) 61.1% profit margin  (b) School: $39,570 | PTA: $26,380"
        }
      ]
    }
  ],
...
export default function MathPerfMixed2Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Mixed 2",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Mixed 2</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Mixed 2</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Mixed 2</h1>
