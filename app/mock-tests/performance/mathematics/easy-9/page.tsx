...
const taskData = {
  "scenarioTitle": "The School Store",
  "scenario": "The school store sells stationery to students. You are helping to manage sales and stock at the end of the week.",
  "parts": [
    {
      "num": 1,
      "title": "Weekly Sales",
      "context": "This week the store sold:\n\u2022 65 pencils at $20 each\n\u2022 28 rulers at $75 each\n\u2022 40 exercise books at $120 each",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Solve problems requiring multiplication",
          "prompt": "Calculate the total money collected from selling:\n(a) all the pencils\n(b) all the rulers\n(c) all the exercise books\n\nShow ALL your working.",
          "modelWorking": "(a) Pencils: 65 \u00d7 $20 = $1,300\n(b) Rulers: 28 \u00d7 $75 = $2,100\n(c) Exercise books: 40 \u00d7 $120 = $4,800",
          "modelAnswer": "(a) $1,300  (b) $2,100  (c) $4,800"
        },
        {
          "num": 2,
          "strand": "Number",
          "objective": "Solve problems requiring addition",
          "prompt": "What was the TOTAL amount collected from all sales?\n\nShow ALL your working.",
          "modelWorking": "Total = $1,300 + $2,100 + $4,800\n     = $3,400 + $4,800\n     = $8,200",
          "modelAnswer": "$8,200"
        }
      ]
    },
    {
      "num": 2,
      "title": "Stock Check",
      "context": "The store started the week with 200 pencils. It received a new delivery of 150 pencils mid-week.",
      "questions": [
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve multi-step problems requiring addition and subtraction",
          "prompt": "After selling 65 pencils, how many pencils does the store have at the end of the week?\n\nShow ALL your working.",
          "modelWorking": "Starting stock = 200 pencils\nDelivery received = 150 pencils\nTotal stock = 200 + 150 = 350 pencils\nSold = 65 pencils\nEnd of week stock = 350 \u2212 65 = 285 pencils",
          "modelAnswer": "285 pencils remaining"
        }
      ]
    },
    {
      "num": 3,
      "title": "Ordering New Stock",
      "context": "Exercise books are ordered in boxes of 24. The store wants to order enough for 120 new exercise books.",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve problems requiring division",
          "prompt": "How many boxes of exercise books should the store order?\n\nShow ALL your working.",
          "modelWorking": "120 \u00f7 24 = 5 boxes exactly\nCheck: 5 \u00d7 24 = 120 \u2713",
          "modelAnswer": "5 boxes"
        },
        {
          "num": 5,
          ...
          "prompt": "Each box of 24 exercise books costs $2,400.\nWhat is the total cost to order 5 boxes?\n\nShow ALL your working.",
          "modelWorking": "Cost per box = $2,400\nNumber of boxes = 5\nTotal cost = 5 \u00d7 $2,400 = $12,000",
          "modelAnswer": "$12,000"
        }
      ]
    }
...
export default function MathPerfEasy9Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Easy 9",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Easy 9</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Easy 9</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Easy 9</h1>
