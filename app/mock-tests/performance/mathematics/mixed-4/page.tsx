...
const taskData = {
  "scenarioTitle": "The Science Fair",
  "scenario": "Your school is hosting a science fair. You are helping to plan the event logistics, judging, and budget.",
  "parts": [
    {
      "num": 1,
      "title": "Displaying Projects",
      "context": "There are 72 projects entered in the fair.\nProjects are displayed on tables. Each table holds 4 projects.",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Solve division problems; interpret remainder",
          "prompt": "(a) How many tables are needed for all 72 projects?\n(b) Will any table be only partly filled? Explain.\n\nShow ALL your working.",
          "modelWorking": "(a) 72 \u00f7 4 = 18 tables exactly\n(b) 18 \u00d7 4 = 72 \u2014 no table is only partly filled. All tables are completely full.",
          "modelAnswer": "(a) 18 tables  (b) No \u2014 all 18 tables are completely full"
        },
        {
          "num": 2,
          "strand": "Number",
          "objective": "Solve problems involving fractions",
          "prompt": "Projects are judged in three categories:\n\u2022 1/3 are Life Science projects\n\u2022 1/4 are Physical Science projects\n\u2022 The rest are Technology projects\n\n(a) How many Life Science projects are there?\n(b) How many Physical Science projects?\n(c) How many Technology projects?\n\nShow ALL your working.",
          "modelWorking": "(a) Life Science: 1/3 of 72 = 72 \u00f7 3 = 24 projects\n(b) Physical Science: 1/4 of 72 = 72 \u00f7 4 = 18 projects\n(c) Technology: 72 \u2212 24 \u2212 18 = 30 projects",
          "modelAnswer": "(a) 24 Life Science  (b) 18 Physical Science  (c) 30 Technology"
        }
      ]
    },
    {
      "num": 2,
      "title": "Prizes",
      "context": "Each category awards 1st, 2nd, and 3rd place prizes.\nPrize values: 1st = $5,000, 2nd = $3,000, 3rd = $1,500\nThere are 3 categories.",
      "questions": [
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve multi-step money problems",
          "prompt": "(a) How much prize money is awarded per category?\n(b) What is the TOTAL prize money for all categories?\n\nShow ALL your working.",
          "modelWorking": "(a) Per category = $5,000 + $3,000 + $1,500 = $9,500\n(b) Total = 3 \u00d7 $9,500 = $28,500",
          "modelAnswer": "(a) $9,500 per category  (b) $28,500 total"
        }
      ]
    },
    {
      "num": 3,
      "title": "Attendance and Budget",
      "context": "The science fair is open to the public. 385 visitors attended.\nAdmission: $200 per adult, $100 per child.\n240 of the 385 visitors were adults.",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve multi-step money problems",
          "prompt": "(a) How many children attended?\n(b) Calculate total revenue from admissions.\n\nShow ALL your working.",
          "modelWorking": "(a) Children = 385 \u2212 240 = 145 children\n(b) Adult revenue = 240 \u00d7 $200 = $48,000\n    Child revenue = 145 \u00d7 $100 = $14,500\n    Total = $48,000 + $14,500 = $62,500",
          "modelAnswer": "(a) 145 children  (b) $62,500 total"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Calculate net balance: revenue minus costs",
          "prompt": "Total fair costs: prizes ($28,500) + venue ($15,000) + other ($8,200) = $51,700.\n\n(a) What is the net balance (revenue \u2212 costs) from the fair?\n(b) Express the costs as a fraction of the revenue. Simplify.\n\nShow ALL your working.",
          "modelWorking": "(a) Net balance = $62,500 \u2212 $51,700 = $10,800\n(b) Fraction = 51,700/62,500\n    Divide both by 100: 517/625\n    Check GCF: 517 = 11 \u00d7 47; 625 = 5\u2074 \u2014 no common factors\n    Fraction = 517/625",
          "modelAnswer": "(a) Net balance = $10,800  (b) 517/625 of revenue spent on costs"
        }
      ]
    }
  ],
...
export default function MathPerfMixed4Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Mixed 4",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Mixed 4</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Mixed 4</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Mixed 4</h1>
