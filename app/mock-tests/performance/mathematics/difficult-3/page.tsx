...
const taskData = {
  "scenarioTitle": "The School Olympics",
  "scenario": "Your school is hosting a \"mini-Olympics\" with 6 events. You are helping to manage the results, scores, and statistics.",
  "parts": [
    {
      "num": 1,
      "title": "Shot Put Results",
      "context": "Six students threw the shot put. Their distances (in metres) were:\n3.4, 4.1, 3.8, 4.6, 3.9, 4.2",
      "questions": [
        {
          "num": 1,
          "strand": "Statistics",
          "objective": "Calculate mean, median, and range of a data set",
          "prompt": "For the shot put distances:\n(a) Calculate the MEAN distance\n(b) Find the RANGE\n(c) Find the MEDIAN distance (middle value when ordered)\n\nShow ALL your working.",
          "modelWorking": "Order the values: 3.4, 3.8, 3.9, 4.1, 4.2, 4.6\n\n(a) Mean = (3.4 + 3.8 + 3.9 + 4.1 + 4.2 + 4.6) \u00f7 6\n         = 24.0 \u00f7 6 = 4.0 m\n\n(b) Range = 4.6 \u2212 3.4 = 1.2 m\n\n(c) Median: 6 values \u2192 average the 3rd and 4th\n         = (3.9 + 4.1) \u00f7 2 = 8.0 \u00f7 2 = 4.0 m",
          "modelAnswer": "(a) Mean = 4.0 m  (b) Range = 1.2 m  (c) Median = 4.0 m"
        }
      ]
    },
    {
      "num": 2,
      "title": "Points System",
      "context": "Teams earn points for each event:\n1st place = 8 pts, 2nd = 5 pts, 3rd = 3 pts, 4th = 1 pt\n\nTeam Blue's placements across 6 events:\n1st, 3rd, 1st, 2nd, 4th, 2nd",
      "questions": [
        {
          "num": 2,
          "strand": "Number",
          "objective": "Solve multi-step problems \u2014 calculate total points",
          "prompt": "Calculate Team Blue's TOTAL points from all 6 events.\n\nShow ALL your working.",
          "modelWorking": "1st place: 8 points \u00d7 2 = 16\n3rd place: 3 points \u00d7 1 = 3\n2nd place: 5 points \u00d7 2 = 10\n4th place: 1 point \u00d7 1 = 1\nTotal = 16 + 3 + 10 + 1 = 30 points",
          "modelAnswer": "30 points total"
        },
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve problems involving fractions of totals",
          "prompt": "Team Red scored 45 points in total.\nExpress Team Blue's score as a fraction of Team Red's score.\nSimplify your answer.\n\nShow ALL your working.",
          "modelWorking": "Fraction = 30/45\nSimplify: GCF of 30 and 45 = 15\n30 \u00f7 15 = 2\n45 \u00f7 15 = 3\nFraction = 2/3",
          "modelAnswer": "2/3"
        }
      ]
    },
    {
      "num": 3,
      "title": "Medal Tally and Percentages",
      "context": "Across all 6 events, your school won:\n\u2022 2 gold medals\n\u2022 3 silver medals\n\u2022 4 bronze medals\nTotal medals won = 9",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Express quantities as percentages",
          "prompt": "What percentage of your school's medals were:\n(a) Gold?\n(b) Silver?\n(c) Bronze?\n\nShow ALL your working.",
          "modelWorking": "(a) Gold: 2/9 \u00d7 100 = 22.2%\n(b) Silver: 3/9 \u00d7 100 = 33.3%\n(c) Bronze: 4/9 \u00d7 100 = 44.4%\nCheck: 22.2 + 33.3 + 44.4 \u2248 99.9% \u2248 100% \u2713",
          "modelAnswer": "(a) \u224822.2% Gold  (b) \u224833.3% Silver  (c) \u224844.4% Bronze"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Solve problems involving ratio",
          "prompt": "Express the ratio of gold : silver : bronze medals in its simplest form.\n\nShow ALL your working.",
          "modelWorking": "Gold : Silver : Bronze = 2 : 3 : 4\nCheck if simplifiable: GCF of 2, 3, and 4 = 1\nRatio is already in simplest form.",
          "modelAnswer": "2 : 3 : 4"
        }
      ]
    }
...
export default function MathPerfDifficult3Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Difficult 3",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Difficult 3</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Difficult 3</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Difficult 3</h1>
