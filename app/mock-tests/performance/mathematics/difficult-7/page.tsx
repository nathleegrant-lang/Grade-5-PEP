...
const taskData = {
  "scenarioTitle": "Building the School Structure",
  "scenario": "Your school is building a new classroom block. You are helping to calculate materials and costs.",
  "parts": [
    {
      "num": 1,
      "title": "Floor Plan",
      "context": "The new classroom block will have 3 identical classrooms.\nEach classroom is a rectangle: 9.5 m long and 7.2 m wide.",
      "questions": [
        {
          "num": 1,
          "strand": "Measurement",
          "objective": "Calculate area and perimeter; multiply decimals",
          "prompt": "For ONE classroom, calculate:\n(a) the area of the floor\n(b) the perimeter of the room\n\nFor ALL 3 classrooms:\n(c) the total floor area\n\nShow ALL your working.",
          "modelWorking": "(a) Area of one = 9.5 \u00d7 7.2 = 68.4 m\u00b2\n(b) Perimeter of one = 2 \u00d7 (9.5 + 7.2) = 2 \u00d7 16.7 = 33.4 m\n(c) Total floor area = 3 \u00d7 68.4 = 205.2 m\u00b2",
          "modelAnswer": "(a) 68.4 m\u00b2  (b) 33.4 m  (c) 205.2 m\u00b2 total"
        }
      ]
    },
    {
      "num": 2,
      "title": "Floor Tiles",
      "context": "Square floor tiles measure 0.6 m \u00d7 0.6 m each. Tiles cost $285 each.",
      "questions": [
        {
          "num": 2,
          "strand": "Measurement",
          "objective": "Divide area to find number of tiles; solve money problems",
          "prompt": "(a) How many tiles are needed to cover ONE classroom floor?\n(b) What is the cost of tiling ONE classroom?\n(c) What is the total cost to tile all 3 classrooms?\n\nShow ALL your working.",
          "modelWorking": "(a) Area of one tile = 0.6 \u00d7 0.6 = 0.36 m\u00b2\n    Tiles for one room = 68.4 \u00f7 0.36 = 190 tiles\n    Check: 190 \u00d7 0.36 = 68.4 \u2713\n(b) Cost per room = 190 \u00d7 $285 = $54,150\n(c) Total = 3 \u00d7 $54,150 = $162,450",
          "modelAnswer": "(a) 190 tiles  (b) $54,150 per room  (c) $162,450 total"
        }
      ]
    },
    {
      "num": 3,
      "title": "Cement Blocks",
      "context": "Each wall of each classroom needs cement blocks.\nOne wall requires 240 blocks. Each classroom has 4 walls.\n(Windows and doors have already been accounted for.)",
      "questions": [
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve multi-step multiplication problems",
          "prompt": "(a) How many blocks are needed for ONE classroom (all 4 walls)?\n(b) How many blocks are needed for all 3 classrooms?\n\nShow ALL your working.",
          "modelWorking": "(a) Blocks per classroom = 4 \u00d7 240 = 960 blocks\n(b) Total blocks = 3 \u00d7 960 = 2,880 blocks",
          "modelAnswer": "(a) 960 blocks per classroom  (b) 2,880 blocks total"
        },
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve problems involving money \u2014 purchasing in bulk",
          "prompt": "Blocks are sold in pallets of 240. Each pallet costs $14,500.\n\n(a) How many pallets are needed?\n(b) What is the total cost of blocks?\n\nShow ALL your working.",
          "modelWorking": "(a) Pallets = 2,880 \u00f7 240 = 12 pallets exactly\n    Check: 12 \u00d7 240 = 2,880 \u2713\n(b) Cost = 12 \u00d7 $14,500 = $174,000",
          "modelAnswer": "(a) 12 pallets  (b) $174,000"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Calculate total construction cost; find difference from budget",
          "prompt": "Total construction budget is $500,000.\nSo far: Tiles = $162,450, Blocks = $174,000.\n\n(a) How much of the budget has been spent on tiles and blocks?\n(b) How much remains for other construction costs?\n\nShow ALL your working.",
          "modelWorking": "(a) Spent = $162,450 + $174,000 = $336,450\n(b) Remaining = $500,000 \u2212 $336,450 = $163,550",
          "modelAnswer": "(a) $336,450 spent  (b) $163,550 remaining"
        }
      ]
    }
  ],
...
export default function MathPerfDifficult7Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Difficult 7",
          }),
        }).then(r => r.json())
      )
      ...
      try {
        ...
        if (user) {
          await supabase.from("student_test_results").insert({
            student_id: user.id,
            subject: "Mathematics",
            test_name: "Performance Task - Difficult 7",
            score: percentage,
            total_questions: 1,
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Difficult 7</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Difficult 7</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Difficult 7</h1>
