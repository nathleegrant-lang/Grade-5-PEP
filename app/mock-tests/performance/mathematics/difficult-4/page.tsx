...
const taskData = {
  "scenarioTitle": "The Annual School Concert",
  "scenario": "Your school is hosting its annual concert. You are managing ticket sales, seating, and revenue.",
  "parts": [
    {
      "num": 1,
      "title": "Seating Plan",
      "context": "The auditorium has:\n\u2022 15 rows of seats in the Main Section: 24 seats per row\n\u2022 8 rows in the Balcony Section: 18 seats per row",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Solve problems requiring multiplication and addition",
          "prompt": "(a) How many seats are in the Main Section?\n(b) How many seats are in the Balcony Section?\n(c) What is the TOTAL seating capacity of the auditorium?\n\nShow ALL your working.",
          "modelWorking": "(a) Main: 15 \u00d7 24 = 360 seats\n(b) Balcony: 8 \u00d7 18 = 144 seats\n(c) Total = 360 + 144 = 504 seats",
          "modelAnswer": "(a) 360 seats  (b) 144 seats  (c) 504 total"
        }
      ]
    },
    {
      "num": 2,
      "title": "Ticket Prices and Sales",
      "context": "Ticket prices:\n\u2022 Main Section: $1,500\n\u2022 Balcony Section: $1,000\n\nThe concert sold out \u2014 all seats were sold.",
      "questions": [
        {
          "num": 2,
          "strand": "Number",
          "objective": "Solve multi-step problems involving money",
          "prompt": "Calculate:\n(a) Revenue from the Main Section\n(b) Revenue from the Balcony Section\n(c) TOTAL revenue\n\nShow ALL your working.",
          "modelWorking": "(a) Main revenue = 360 \u00d7 $1,500 = $540,000\n(b) Balcony revenue = 144 \u00d7 $1,000 = $144,000\n(c) Total = $540,000 + $144,000 = $684,000",
          "modelAnswer": "(a) $540,000  (b) $144,000  (c) $684,000 total"
        },
        {
          "num": 3,
          "strand": "Number",
          "objective": "Express as percentage; solve multi-step problems",
          "prompt": "What percentage of the total revenue came from the Balcony Section?\n\nShow ALL your working.",
          "modelWorking": "Percentage = (144,000 / 684,000) \u00d7 100\n= 0.21053... \u00d7 100\n\u2248 21.05%",
          "modelAnswer": "\u2248 21.05% of revenue from Balcony"
        }
      ]
    },
    {
      "num": 3,
      "title": "Concert Expenses",
      "context": "Expenses for the concert:\n\u2022 Performers: $185,000\n\u2022 Sound and lighting: $62,000\n\u2022 Programmes printed: $28,500\n\u2022 Decorations: $14,200",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Calculate profit after expenses",
          "prompt": "(a) What are the TOTAL expenses?\n(b) What PROFIT did the school make from the concert?\n\nShow ALL your working.",
          "modelWorking": "(a) Total expenses = $185,000 + $62,000 + $28,500 + $14,200 = $289,700\n(b) Profit = $684,000 \u2212 $289,700 = $394,300",
          "modelAnswer": "(a) $289,700 total expenses  (b) Profit = $394,300"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Express profit as percentage of revenue",
          "prompt": "Express the profit as a percentage of the total revenue.\n\nShow ALL your working.",
          "modelWorking": "Percentage = (394,300 / 684,000) \u00d7 100\n= 0.5764... \u00d7 100\n\u2248 57.6%",
          "modelAnswer": "\u2248 57.6% profit margin"
        }
      ]
    }
  ],
...
export default function MathPerfDifficult4Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Difficult 4",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Difficult 4</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Difficult 4</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Difficult 4</h1>
