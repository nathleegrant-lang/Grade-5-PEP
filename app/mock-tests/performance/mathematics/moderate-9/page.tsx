...
const taskData = {
  "scenarioTitle": "The Tuck Shop Profit Report",
  "scenario": "The school tuck shop is reviewing its monthly profit and loss report for March.",
  "parts": [
    {
      "num": 1,
      "title": "Revenue from Sales",
      "context": "In March, the tuck shop sold:\n\u2022 480 buns at $35 each\n\u2022 360 juices at $65 each\n\u2022 240 chips at $25 each",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Solve problems requiring multiplication and addition",
          "prompt": "Calculate the TOTAL revenue (total money received) from ALL sales in March.\n\nShow ALL your working.",
          "modelWorking": "Buns: 480 \u00d7 $35 = $16,800\nJuices: 360 \u00d7 $65 = $23,400\nChips: 240 \u00d7 $25 = $6,000\nTotal revenue = $16,800 + $23,400 + $6,000 = $46,200",
          "modelAnswer": "Total revenue = $46,200"
        },
        {
          "num": 2,
          "strand": "Number",
          "objective": "Solve problems involving fractions of totals",
          "prompt": "What fraction of the total revenue came from juice sales?\nSimplify your answer.\n\nShow ALL your working.",
          "modelWorking": "Juice revenue = $23,400\nTotal revenue = $46,200\nFraction = 23400/46200\nDivide both by 200: 117/231\nGCF of 117 and 231: 117 = 9\u00d713, 231 = 3\u00d777 = 3\u00d77\u00d711\nGCF of 117 and 231 = 3\n117 \u00f7 3 = 39; 231 \u00f7 3 = 77\nFraction = 39/77",
          "modelAnswer": "39/77"
        }
      ]
    },
    {
      "num": 2,
      "title": "Expenses in March",
      "context": "The tuck shop paid:\n\u2022 Wholesale stock: $28,500\n\u2022 Electricity: $3,200\n\u2022 Packaging: $1,850",
      "questions": [
        {
          "num": 3,
          "strand": "Number",
          "objective": "Calculate profit; subtract total expenses from revenue",
          "prompt": "(a) What were the TOTAL expenses?\n(b) What was the PROFIT in March? (Profit = Revenue \u2212 Expenses)\n\nShow ALL your working.",
          "modelWorking": "(a) Total expenses = $28,500 + $3,200 + $1,850 = $33,550\n(b) Profit = $46,200 \u2212 $33,550 = $12,650",
          "modelAnswer": "(a) $33,550 total expenses  (b) Profit = $12,650"
        }
      ]
    },
    {
      ...
      "context": "In February, the tuck shop made a profit of $9,800.",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Find difference between profits",
          "prompt": "By how much did the profit INCREASE from February to March?\n\nShow ALL your working.",
          "modelWorking": "Increase = $12,650 \u2212 $9,800 = $2,850",
          "modelAnswer": "Profit increased by $2,850"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Express increase as a fraction; simplify",
          "prompt": "Express the increase as a fraction of February's profit.\nSimplify your answer.\n\nShow ALL your working.",
          "modelWorking": "Fraction = 2850/9800\nDivide both by 50: 57/196\nGCF of 57 and 196: 57 = 3 \u00d7 19; 196 = 4 \u00d7 49 = 2\u00b2 \u00d7 7\u00b2\nNo common factors.\nFraction = 57/196",
          "modelAnswer": "57/196 (\u2248 29% increase)"
        }
      ]
    }
  ],
...
export default function MathPerfModerate9Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Moderate 9",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Moderate 9</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Moderate 9</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Moderate 9</h1>
