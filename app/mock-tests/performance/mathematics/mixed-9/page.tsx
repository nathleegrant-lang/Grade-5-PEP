...
const taskData = {
  "scenarioTitle": "Concert Ticket Sales",
  "scenario": "The school choir is putting on a concert. You are managing the ticket sales and venue planning.",
  "parts": [
    {
      "num": 1,
      "title": "Ticket Sales Target",
      "context": "The choir needs to raise $120,000 from ticket sales.\nTickets are sold at two prices: Adult $800, Child $400.",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Solve problems involving ratio and money",
          "prompt": "Tickets are sold in the ratio 3 adults for every 2 children.\nIf a total of 200 tickets are sold:\n(a) How many adult tickets are sold?\n(b) How many child tickets are sold?\n(c) What is the total revenue from 200 tickets?\n\nShow ALL your working.",
          "modelWorking": "(a) Ratio adults:children = 3:2, total parts = 5\nAdults = 3/5 \u00d7 200 = 120 adult tickets\n(b) Children = 2/5 \u00d7 200 = 80 child tickets\n(c) Revenue = 120 \u00d7 $800 + 80 \u00d7 $400\n           = $96,000 + $32,000 = $128,000",
          "modelAnswer": "(a) 120 adult tickets  (b) 80 child tickets  (c) $128,000 revenue"
        }
      ]
    },
    {
      "num": 2,
      "title": "Does the Revenue Meet the Target?",
      "context": "",
      "questions": [
        {
          "num": 2,
          "strand": "Number",
          "objective": "Compare with target; solve for shortfall or surplus",
          "prompt": "(a) Does the $128,000 revenue from Question 1 meet the $120,000 target?\n(b) By how much does it exceed (or fall short of) the target?\n(c) What percentage of the target was achieved?\n\nShow ALL your working.",
          "modelWorking": "(a) Yes \u2014 $128,000 > $120,000 \u2713\n(b) Surplus = $128,000 \u2212 $120,000 = $8,000 above target\n(c) 128,000/120,000 \u00d7 100 = 106.7% of target achieved",
          "modelAnswer": "(a) Yes \u2014 target met  (b) $8,000 surplus  (c) 106.7% of target"
        }
      ]
    },
    {
      "num": 3,
      "title": "Venue Seating",
      "context": "The venue has 180 seats arranged in rows of 15.",
      "questions": [
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve problems using division",
          "prompt": "(a) How many rows of seats are there?\n(b) 200 tickets were sold but the venue only holds 180. How many people cannot be seated?\n\nShow ALL your working.",
          "modelWorking": "(a) 180 \u00f7 15 = 12 rows\n(b) 200 \u2212 180 = 20 people cannot be seated",
          "modelAnswer": "(a) 12 rows  (b) 20 people cannot be seated"
        },
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve problems involving refunds",
          "prompt": "The 20 people who cannot be seated will receive a full refund.\nIf 12 are adults and 8 are children:\n(a) Total refund for adults\n(b) Total refund for children\n(c) Total refund amount\n\nShow ALL your working.",
          "modelWorking": "(a) Adult refunds = 12 \u00d7 $800 = $9,600\n(b) Child refunds = 8 \u00d7 $400 = $3,200\n(c) Total refund = $9,600 + $3,200 = $12,800",
          "modelAnswer": "(a) $9,600  (b) $3,200  (c) $12,800 total refund"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Calculate final profit after refunds and expenses",
          "prompt": "Expenses: $45,000. Revenue = $128,000. Refunds = $12,800.\n\n(a) Net revenue (after refunds)\n(b) Final profit (Net revenue \u2212 Expenses)\n\nShow ALL your working.",
          "modelWorking": "(a) Net revenue = $128,000 \u2212 $12,800 = $115,200\n(b) Profit = $115,200 \u2212 $45,000 = $70,200",
          "modelAnswer": "(a) Net revenue = $115,200  (b) Profit = $70,200"
        }
      ]
    }
  ],
...
export default function MathPerfMixed9Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Mixed 9",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Mixed 9</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Mixed 9</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Mixed 9</h1>
