...
const taskData = {
  "scenarioTitle": "The Annual Sports Banquet",
  "scenario": "The school is holding its annual sports awards banquet. You are helping to organise the seating, food, and costs.",
  "parts": [
    {
      "num": 1,
      "title": "Seating Arrangements",
      "context": "The banquet hall has 12 round tables.\nEach table seats 8 guests.",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Solve problems involving multiplication and addition",
          "prompt": "(a) What is the total seating capacity?\n(b) If 89 guests are invited, how many seats will be empty?\n\nShow ALL your working.",
          "modelWorking": "(a) Total seats = 12 \u00d7 8 = 96 seats\n(b) Empty = 96 \u2212 89 = 7 seats",
          "modelAnswer": "(a) 96 seats  (b) 7 seats empty"
        },
        {
          "num": 2,
          "strand": "Number",
          "objective": "Solve problems involving fractions of capacity",
          "prompt": "What fraction of the total seating capacity will be OCCUPIED?\nGive your answer in simplest form.\n\nShow ALL your working.",
          "modelWorking": "Fraction occupied = 89/96\nGCF of 89 and 96: 89 is prime; 96 = 2\u2075 \u00d7 3\n89 is not divisible by 2 or 3 \u2192 GCF = 1\nFraction = 89/96 (already in simplest form)",
          "modelAnswer": "89/96"
        }
      ]
    },
    {
      "num": 2,
      "title": "Banquet Meal Cost",
      "context": "Each guest receives a 3-course meal costing $1,850 per person.\nAthletes (32 of the 89 guests) get a free meal \u2014 the school covers their cost.",
      "questions": [
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve multi-step money problems",
          "prompt": "(a) What is the total cost of all 89 meals?\n(b) How much do the non-athlete guests pay between them (57 guests each pay their own)?\n(c) How much does the school pay for the 32 athletes?\n\nShow ALL your working.",
          "modelWorking": "(a) Total cost = 89 \u00d7 $1,850 = $164,650\n(b) Non-athletes: 57 \u00d7 $1,850 = $105,450\n(c) Athletes covered by school = 32 \u00d7 $1,850 = $59,200",
          "modelAnswer": "(a) $164,650  (b) $105,450 from non-athletes  (c) School pays $59,200"
        }
      ]
    },
    {
      ...
      "context": "25 trophies are awarded. Large trophies cost $3,800 each; small trophies cost $2,200 each.\n15 are large trophies and 10 are small.",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve multi-step money problems",
          "prompt": "(a) Total cost of large trophies\n(b) Total cost of small trophies\n(c) Grand total cost of all trophies\n\nShow ALL your working.",
          "modelWorking": "(a) Large: 15 \u00d7 $3,800 = $57,000\n(b) Small: 10 \u00d7 $2,200 = $22,000\n(c) Total = $57,000 + $22,000 = $79,000",
          "modelAnswer": "(a) $57,000  (b) $22,000  (c) $79,000"
        },
        {
          "num": 5,
          "strand": "Statistics",
          "objective": "Calculate mean cost per trophy",
          "prompt": "Calculate the MEAN cost per trophy across all 25 trophies.\n\nShow ALL your working.",
          "modelWorking": "Mean = $79,000 \u00f7 25 = $3,160 per trophy",
          "modelAnswer": "Mean = $3,160 per trophy"
        }
      ]
    }
  ],
...
export default function MathPerfMixed5Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Mixed 5",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Mixed 5</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Mixed 5</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Mixed 5</h1>
