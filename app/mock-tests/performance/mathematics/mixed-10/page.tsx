...
const taskData = {
  "scenarioTitle": "Community Sports Day",
  "scenario": "Your community is organising a sports day. You are handling the logistics, scoring, and budget.",
  "parts": [
    {
      "num": 1,
      "title": "Number of Participants",
      "context": "4 communities are competing. Each community has:\n\u2022 6 relay teams of 4 runners\n\u2022 12 individual event athletes",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Solve multi-step multiplication problems",
          "prompt": "(a) How many relay runners does ONE community have?\n(b) How many athletes total (relay + individual) does ONE community have?\n(c) What is the TOTAL number of athletes from ALL 4 communities?\n\nShow ALL your working.",
          "modelWorking": "(a) Relay runners = 6 teams \u00d7 4 runners = 24 runners per community\n(b) Total per community = 24 + 12 = 36 athletes\n(c) Grand total = 4 \u00d7 36 = 144 athletes",
          "modelAnswer": "(a) 24 relay runners  (b) 36 athletes per community  (c) 144 athletes total"
        }
      ]
    },
    {
      "num": 2,
      "title": "Event Scoring",
      "context": "Final scores for each community:\nBlue: 285 points\nRed: 342 points\nGreen: 267 points\nYellow: 306 points",
      "questions": [
        {
          "num": 2,
          "strand": "Statistics",
          "objective": "Calculate mean, range, and identify winner",
          "prompt": "(a) Calculate the MEAN score.\n(b) Calculate the RANGE of scores.\n(c) Which community won?\n\nShow ALL your working.",
          "modelWorking": "(a) Mean = (285+342+267+306) \u00f7 4 = 1200 \u00f7 4 = 300 points\n(b) Range = 342 \u2212 267 = 75 points\n(c) Winner: Red community with 342 points",
          "modelAnswer": "(a) Mean = 300 points  (b) Range = 75  (c) Red community won"
        },
        {
          "num": 3,
          "strand": "Number",
          "objective": "Express winner's score as fraction of total; simplify",
          "prompt": "Express the winning community's score as a fraction of the total points scored by all communities.\nSimplify your answer.\n\nShow ALL your working.",
          "modelWorking": "Winner (Red) = 342\nTotal = 285+342+267+306 = 1200\nFraction = 342/1200\nGCF of 342 and 1200:\n342 = 2 \u00d7 171 = 2 \u00d7 9 \u00d7 19\n1200 = 2\u2074 \u00d7 3 \u00d7 5\u00b2\nGCF = 2 \u00d7 3 = 6\n342 \u00f7 6 = 57; 1200 \u00f7 6 = 200\nFraction = 57/200",
          "modelAnswer": "57/200"
        }
      ]
    },
    {
      ...
      "context": "Budget: $95,000\nExpenses: Trophies $18,500, Food $24,300, Equipment $15,750, Venue $8,200",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Calculate total expenses and budget remaining",
          "prompt": "(a) Total expenses\n(b) Amount remaining from budget\n(c) Percentage of budget spent\n\nShow ALL your working.",
          "modelWorking": "(a) Total = $18,500 + $24,300 + $15,750 + $8,200 = $66,750\n(b) Remaining = $95,000 \u2212 $66,750 = $28,250\n(c) % spent = 66,750/95,000 \u00d7 100 = 70.3%",
          "modelAnswer": "(a) $66,750  (b) $28,250 remaining  (c) 70.3% of budget spent"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Solve ratio problem \u2014 share remaining budget",
          "prompt": "The remaining $28,250 will be donated to two local schools in the ratio 3:2.\n(a) How much does each school receive?\n\nShow ALL your working.",
          "modelWorking": "Total parts = 3 + 2 = 5\nLarger share (3 parts) = 3/5 \u00d7 $28,250 = $16,950\nSmaller share (2 parts) = 2/5 \u00d7 $28,250 = $11,300\nCheck: $16,950 + $11,300 = $28,250 \u2713",
          "modelAnswer": "School 1 receives $16,950 | School 2 receives $11,300"
        }
      ]
    }
  ],
...
export default function MathPerfMixed10Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Mixed 10",
          }),
        }).then(r => r.json())
      )
      ...
      try {
        ...
        if (user) {
          await supabase.from("student_test_results").insert({
            student_id: user.id,
            subject: "Mathematics",
            test_name: "Performance Task - Mixed 10",
            score: percentage,
            total_questions: 1,
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Mixed 10</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Mixed 10</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Mixed 10</h1>
