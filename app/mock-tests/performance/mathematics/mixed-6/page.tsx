...
const taskData = {
  "scenarioTitle": "The Charity Drive",
  "scenario": "Grade 5 students are running a charity drive to collect supplies for families affected by a flood.",
  "parts": [
    {
      "num": 1,
      "title": "Collecting Canned Goods",
      "context": "30 students each collected canned goods:\nClass A (15 students): average 18 cans each\nClass B (15 students): average 24 cans each",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Solve problems requiring multiplication and addition",
          "prompt": "(a) How many cans did Class A collect in total?\n(b) How many cans did Class B collect in total?\n(c) What is the grand total of all cans collected?\n\nShow ALL your working.",
          "modelWorking": "(a) Class A = 15 \u00d7 18 = 270 cans\n(b) Class B = 15 \u00d7 24 = 360 cans\n(c) Total = 270 + 360 = 630 cans",
          "modelAnswer": "(a) 270 cans  (b) 360 cans  (c) 630 cans total"
        },
        {
          "num": 2,
          "strand": "Statistics",
          "objective": "Calculate overall mean; compare with class means",
          "prompt": "(a) Calculate the MEAN number of cans per student for ALL 30 students.\n(b) Which class had the higher average? By how much?\n\nShow ALL your working.",
          "modelWorking": "(a) Mean = 630 \u00f7 30 = 21 cans per student\n(b) Class B mean (24) > Class A mean (18)\n    Difference = 24 \u2212 18 = 6 cans",
          "modelAnswer": "(a) Mean = 21 cans per student  (b) Class B by 6 cans"
        }
      ]
    },
    {
      "num": 2,
      "title": "Distributing the Cans",
      "context": "The 630 cans are distributed to affected families.\nEach family receives a box containing 14 cans.",
      "questions": [
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve division problems; interpret remainders",
          "prompt": "(a) How many complete boxes can be packed?\n(b) How many cans are left over (not enough for a complete box)?\n\nShow ALL your working.",
          "modelWorking": "(a) 630 \u00f7 14 = 45 boxes exactly\n    Check: 45 \u00d7 14 = 630 \u2713\n(b) 0 cans left over \u2014 all cans fit perfectly into boxes.",
          "modelAnswer": "(a) 45 complete boxes  (b) 0 cans left over"
        }
      ]
    },
    {
      ...
      "context": "A truck can carry 180 boxes in one trip.\nEach trip costs $3,500.",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve problems involving division; calculate cost",
          "prompt": "(a) How many truck trips are needed to deliver all 45 boxes?\n(b) What is the total transport cost?\n\nShow ALL your working.",
          "modelWorking": "(a) 45 \u00f7 180 = 0.25 \u2192 only 1 trip needed (45 boxes fit easily in one trip; 45 < 180)\n(b) Transport cost = 1 \u00d7 $3,500 = $3,500",
          "modelAnswer": "(a) 1 truck trip  (b) $3,500"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Solve multi-step problem involving fractions and money",
          "prompt": "The school fundraiser raised $12,000 to cover costs.\nTransport costs $3,500. The school also buys extra food parcels at $850 each.\n\nHow many food parcels can the school buy with the remaining money after paying for transport?\n\nShow ALL your working.",
          "modelWorking": "Money after transport = $12,000 \u2212 $3,500 = $8,500\nParcels = $8,500 \u00f7 $850 = 10 parcels exactly\nCheck: 10 \u00d7 $850 = $8,500 \u2713",
          "modelAnswer": "10 food parcels"
        }
      ]
    }
  ],
...
export default function MathPerfMixed6Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Mixed 6",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Mixed 6</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Mixed 6</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Mixed 6</h1>
