...
const taskData = {
  "scenarioTitle": "Farm to Market Day",
  "scenario": "The school farm is selling its produce at the community market. You are calculating production, packaging, and profit.",
  "parts": [
    {
      "num": 1,
      "title": "Harvest Weights",
      "context": "This season's harvest:\n\u2022 Sweet potatoes: 124.5 kg\n\u2022 Yams: 86.8 kg\n\u2022 Cho cho: 53.2 kg\n\u2022 Pumpkin: 97.4 kg",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Add decimal numbers; solve problems involving mass",
          "prompt": "(a) What is the TOTAL mass of all produce harvested?\n(b) Sweet potatoes are ____% of the total. Calculate this percentage.\n\nShow ALL your working.",
          "modelWorking": "(a) Total = 124.5 + 86.8 + 53.2 + 97.4\n         = 211.3 + 53.2 + 97.4\n         = 264.5 + 97.4\n         = 361.9 kg\n\n(b) Sweet potato % = (124.5 / 361.9) \u00d7 100\n                   = 0.3441 \u00d7 100\n                   \u2248 34.4%",
          "modelAnswer": "(a) 361.9 kg total  (b) Sweet potatoes \u2248 34.4% of harvest"
        }
      ]
    },
    {
      "num": 2,
      "title": "Packaging",
      "context": "Produce is packed in bags:\n\u2022 Sweet potatoes: 2.5 kg per bag\n\u2022 Yams: 1.8 kg per bag",
      "questions": [
        {
          "num": 2,
          "strand": "Number",
          "objective": "Divide decimals to find number of bags; interpret remainders",
          "prompt": "(a) How many COMPLETE bags of sweet potatoes can be packed from 124.5 kg?\n(b) How many COMPLETE bags of yams can be packed from 86.8 kg?\n(c) For each, how much produce is left over (not enough for a complete bag)?\n\nShow ALL your working.",
          "modelWorking": "(a) Sweet potatoes: 124.5 \u00f7 2.5 = 49.8 \u2192 49 complete bags\n    Left over: 124.5 \u2212 (49 \u00d7 2.5) = 124.5 \u2212 122.5 = 2.0 kg\n\n(b) Yams: 86.8 \u00f7 1.8 = 48.22... \u2192 48 complete bags\n    Left over: 86.8 \u2212 (48 \u00d7 1.8) = 86.8 \u2212 86.4 = 0.4 kg",
          "modelAnswer": "(a) 49 complete bags of sweet potatoes, 2.0 kg left over\n(b) 48 complete bags of yams, 0.4 kg left over"
        }
      ]
    },
    {
      "num": 3,
      "title": "Market Prices and Profit",
      "context": "Selling prices per bag:\n\u2022 Sweet potato bag (2.5 kg): $375\n\u2022 Yam bag (1.8 kg): $480\n\nProduction costs: $18,500",
      "questions": [
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve multi-step money problems",
          "prompt": "Calculate total revenue from selling:\n(a) 49 bags of sweet potatoes\n(b) 48 bags of yams\n(c) Total revenue\n\nShow ALL your working.",
          "modelWorking": "(a) Sweet potato revenue = 49 \u00d7 $375 = $18,375\n(b) Yam revenue = 48 \u00d7 $480 = $23,040\n(c) Total = $18,375 + $23,040 = $41,415",
          "modelAnswer": "(a) $18,375  (b) $23,040  (c) $41,415"
        },
        {
          "num": 4,
          "strand": "Number",
          "objective": "Calculate profit/loss",
          "prompt": "(a) Calculate the profit or loss from the market day.\n(b) Express the profit/loss as a fraction of total revenue.\n\nShow ALL your working.",
          "modelWorking": "(a) Profit = $41,415 \u2212 $18,500 = $22,915\n(b) Fraction = 22,915/41,415\n    Simplify: GCF of 22915 and 41415\n    Both divisible by 5: 4583/8283\n    Check: 4583 and 8283... GCF = 1\n    Fraction \u2248 0.5532 \u2248 55.3%",
          "modelAnswer": "(a) Profit = $22,915  (b) \u224855.3% of revenue"
        },
        {
          "num": 5,
          "strand": "Statistics",
          "objective": "Interpret data; calculate mean selling price per bag",
          "prompt": "The farm sold bags at two different prices ($375 and $480).\nCalculate the MEAN price per bag across ALL 97 bags sold.\n\nShow ALL your working.",
          "modelWorking": "Total revenue = $41,415\nTotal bags = 49 + 48 = 97\nMean price = $41,415 \u00f7 97 = $427.olean...\n= $426.96 (rounded to nearest cent)",
          "modelAnswer": "Mean price \u2248 $426.96 per bag"
        }
      ]
    }
  ],
...
export default function MathPerfDifficult5Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Difficult 5",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Difficult 5</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Difficult 5</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Difficult 5</h1>
