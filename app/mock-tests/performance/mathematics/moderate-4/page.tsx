...
const taskData = {
  "scenarioTitle": "Class Recipe Day",
  "scenario": "The class is making coconut drops. The recipe serves 20 students. You must scale it up to serve more people.",
  "parts": [
    {
      "num": 1,
      "title": "Scaling the Recipe",
      "context": "Original recipe for 20 students:\n\u2022 600 g grated coconut\n\u2022 400 g brown sugar\n\u2022 250 ml water\n\u2022 1 teaspoon ginger",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Solve problems involving ratio and proportion \u2014 scaling recipes",
          "prompt": "You need to make enough for 60 students (3 times the original recipe).\nCalculate the new amounts needed for:\n(a) grated coconut\n(b) brown sugar\n(c) water\n\nShow ALL your working.",
          "modelWorking": "Scale factor = 60 \u00f7 20 = 3\n(a) Coconut: 600 g \u00d7 3 = 1,800 g\n(b) Sugar: 400 g \u00d7 3 = 1,200 g\n(c) Water: 250 ml \u00d7 3 = 750 ml",
          "modelAnswer": "(a) 1,800 g coconut  (b) 1,200 g sugar  (c) 750 ml water"
        },
        {
          "num": 2,
          "strand": "Measurement",
          "objective": "Convert between grams and kilograms",
          "prompt": "Convert the amounts of coconut and sugar from Question 1 to kilograms.\n\nShow ALL your working.",
          "modelWorking": "Coconut: 1,800 g \u00f7 1,000 = 1.8 kg\nSugar: 1,200 g \u00f7 1,000 = 1.2 kg",
          "modelAnswer": "Coconut: 1.8 kg  |  Sugar: 1.2 kg"
        }
      ]
    },
    {
      ...
      "context": "Prices at the market:\n\u2022 Coconut: $280 per kg\n\u2022 Sugar: $190 per kg\n\u2022 Ginger (pack): $45",
      "questions": [
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve multi-step problems involving money and measurement",
          "prompt": "Calculate the TOTAL cost of ingredients for the scaled recipe (60 students).\n\nRemember: You need 1.8 kg coconut, 1.2 kg sugar, and 1 pack of ginger. (Water is free.)\n\nShow ALL your working.",
          "modelWorking": "Coconut: 1.8 kg \u00d7 $280 = $504\nSugar: 1.2 kg \u00d7 $190 = $228\nGinger: $45\nTotal = $504 + $228 + $45 = $777",
          "modelAnswer": "$777 total cost"
        }
      ]
    },
    {
      "num": 3,
      "title": "Selling the Coconut Drops",
      "context": "Each student gets 3 coconut drops. The class decides to sell extras at $15 each.\nIf the recipe makes 200 coconut drops total, and 60 students each take 3, the rest are sold.",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve problems requiring subtraction and multiplication",
          "prompt": "(a) How many coconut drops are taken by students?\n(b) How many are left to sell?\n\nShow ALL your working.",
          "modelWorking": "(a) Taken by students: 60 \u00d7 3 = 180 drops\n(b) Remaining to sell: 200 \u2212 180 = 20 drops",
          "modelAnswer": "(a) 180 drops taken  (b) 20 drops to sell"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Solve problems involving profit",
          "prompt": "(a) How much money is made from selling the extra 20 drops at $15 each?\n(b) What profit is made? (Profit = Sales \u2212 Cost of ingredients)\n\nShow ALL your working.",
          "modelWorking": "(a) Revenue from extras = 20 \u00d7 $15 = $300\n(b) Cost of ingredients = $777\n    Profit = $300 \u2212 $777 = \u2212$477 (a loss of $477)\n    Note: The class did not make a profit \u2014 the sale revenue ($300) was less than ingredient cost ($777).\n    To break even, they would need to charge at least $777 \u00f7 20 \u2248 $39 per extra drop.",
          "modelAnswer": "(a) $300 from sales  (b) Loss of $477 (no profit was made)"
        }
      ]
    }
  ],
...
export default function MathPerfModerate4Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Moderate 4",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Moderate 4</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Moderate 4</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Moderate 4</h1>
