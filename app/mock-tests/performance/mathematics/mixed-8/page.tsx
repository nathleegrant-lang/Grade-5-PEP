...
const taskData = {
  "scenarioTitle": "The Farm Expansion",
  "scenario": "The school farm is expanding to grow more crops and raise animals. You are helping to plan the expansion.",
  "parts": [
    {
      "num": 1,
      "title": "New Land Measurements",
      "context": "The expanded farm will have two sections:\n\u2022 Crop section: rectangle 25 m \u00d7 14 m\n\u2022 Animal section: rectangle 18 m \u00d7 12 m",
      "questions": [
        {
          "num": 1,
          "strand": "Measurement",
          "objective": "Calculate and compare areas",
          "prompt": "(a) Area of crop section\n(b) Area of animal section\n(c) Total area of the expanded farm\n(d) How much larger is the crop section than the animal section?\n\nShow ALL your working.",
          "modelWorking": "(a) Crop: 25 \u00d7 14 = 350 m\u00b2\n(b) Animal: 18 \u00d7 12 = 216 m\u00b2\n(c) Total = 350 + 216 = 566 m\u00b2\n(d) Difference = 350 \u2212 216 = 134 m\u00b2 larger",
          "modelAnswer": "(a) 350 m\u00b2  (b) 216 m\u00b2  (c) 566 m\u00b2  (d) 134 m\u00b2 larger"
        }
      ]
    },
    {
      "num": 2,
      "title": "Crop Planting",
      "context": "The 350 m\u00b2 crop section is divided:\n\u2022 2/5 for yams\n\u2022 3/10 for sweet potatoes\n\u2022 The remainder for corn",
      "questions": [
        {
          "num": 2,
          "strand": "Number",
          "objective": "Solve problems involving fractions of area",
          "prompt": "(a) Area for yams\n(b) Area for sweet potatoes\n(c) Area for corn\n\nShow ALL your working.",
          "modelWorking": "(a) Yams: 2/5 \u00d7 350 = 140 m\u00b2\n(b) Sweet potatoes: 3/10 \u00d7 350 = 105 m\u00b2\n(c) Corn: 350 \u2212 140 \u2212 105 = 105 m\u00b2",
          "modelAnswer": "(a) 140 m\u00b2 yams  (b) 105 m\u00b2 sweet potatoes  (c) 105 m\u00b2 corn"
        },
        {
          "num": 3,
          "strand": "Number",
          "objective": "Express as percentages",
          "prompt": "What percentage of the crop section is used for:\n(a) Yams?\n(b) Sweet potatoes?\n(c) Corn?\n\nShow ALL your working.",
          "modelWorking": "(a) Yams: 140/350 \u00d7 100 = 40%\n(b) Sweet potatoes: 105/350 \u00d7 100 = 30%\n(c) Corn: 105/350 \u00d7 100 = 30%\nCheck: 40 + 30 + 30 = 100% \u2713",
          "modelAnswer": "(a) 40% yams  (b) 30% sweet potatoes  (c) 30% corn"
        }
      ]
    },
    {
      "num": 3,
      "title": "Fencing the Expansion",
      "context": "Only the new sections need fencing (around their outer edges).\nFencing costs $425 per metre.",
      "questions": [
        {
          "num": 4,
          "strand": "Measurement",
          "objective": "Calculate perimeters and total fencing cost",
          "prompt": "(a) Perimeter of crop section\n(b) Perimeter of animal section\n(c) Total perimeter to be fenced\n(d) Total fencing cost\n\nShow ALL your working.",
          "modelWorking": "(a) Crop perimeter = 2(25+14) = 2\u00d739 = 78 m\n(b) Animal perimeter = 2(18+12) = 2\u00d730 = 60 m\n(c) Total = 78 + 60 = 138 m\n(d) Cost = 138 \u00d7 $425 = $58,650",
          "modelAnswer": "(a) 78 m  (b) 60 m  (c) 138 m  (d) $58,650"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Solve ratio and fraction problems",
          "prompt": "The $58,650 fencing cost is shared between the school and a sponsor in the ratio 2:1.\n(a) How much does the school pay?\n(b) How much does the sponsor pay?\n\nShow ALL your working.",
          "modelWorking": "Total parts = 2 + 1 = 3\nSchool (2 parts) = 2/3 \u00d7 $58,650 = $39,100\nSponsor (1 part) = 1/3 \u00d7 $58,650 = $19,550\nCheck: $39,100 + $19,550 = $58,650 \u2713",
          "modelAnswer": "(a) School pays $39,100  (b) Sponsor pays $19,550"
        }
      ]
    }
  ],
...
export default function MathPerfMixed8Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Mixed 8",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Mixed 8</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Mixed 8</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Mixed 8</h1>
