...
const taskData = {
  "scenarioTitle": "School Restaurant Day",
  "scenario": "Your school is holding a fundraising \"Restaurant Day.\" Students run the restaurant for one day. You are the manager.",
  "parts": [
    {
      "num": 1,
      "title": "Menu Planning and Portions",
      "context": "The restaurant will serve 3-course meals to 80 guests.\nEach guest gets:\n\u2022 Soup (350 ml per serving)\n\u2022 Main course (a chicken and rice plate)\n\u2022 Dessert (a slice of cake: each cake has 8 slices)",
      "questions": [
        {
          "num": 1,
          "strand": "Measurement",
          "objective": "Solve multi-step problems involving capacity",
          "prompt": "(a) What is the total volume of soup needed for all 80 guests?\n    Give your answer in ml and litres.\n(b) Soup is made in 10-litre pots. How many full pots are needed?\n\nShow ALL your working.",
          "modelWorking": "(a) Total soup = 80 \u00d7 350 ml = 28,000 ml\n    Convert: 28,000 \u00f7 1,000 = 28 litres\n(b) 28 \u00f7 10 = 2.8 pots\n    Round UP \u2192 3 pots needed (2 pots = 20 litres; not enough)",
          "modelAnswer": "(a) 28,000 ml = 28 litres  (b) 3 pots of soup"
        },
        {
          "num": 2,
          "strand": "Number",
          "objective": "Solve problems involving division and remainders",
          "prompt": "(a) How many cakes are needed to serve 80 guests one slice each?\n(b) How many slices will be left over?\n\nShow ALL your working.",
          "modelWorking": "(a) 80 \u00f7 8 slices per cake = 10 cakes exactly\n(b) 10 \u00d7 8 = 80 slices \u2014 no slices left over",
          "modelAnswer": "(a) 10 cakes  (b) 0 slices left over"
        }
      ]
    },
    {
      ...
      "context": "Costs:\n\u2022 Soup (per pot): $1,850\n\u2022 Chicken plates (each): $380\n\u2022 Cakes (each): $2,400\n\nThe meal is sold for $1,200 per person.",
      "questions": [
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve multi-step problems involving money",
          "prompt": "Calculate TOTAL costs:\n(a) 3 pots of soup\n(b) 80 chicken plates\n(c) 10 cakes\n(d) Grand total cost\n\nShow ALL your working.",
          "modelWorking": "(a) Soup: 3 \u00d7 $1,850 = $5,550\n(b) Chicken: 80 \u00d7 $380 = $30,400\n(c) Cakes: 10 \u00d7 $2,400 = $24,000\n(d) Total cost = $5,550 + $30,400 + $24,000 = $59,950",
          "modelAnswer": "(a) $5,550  (b) $30,400  (c) $24,000  (d) $59,950"
        }
      ]
    },
    {
      ...
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve problems involving revenue and profit",
          "prompt": "(a) What is the total revenue from selling 80 meals at $1,200 each?\n(b) What profit (or loss) does the school make?\n\nShow ALL your working.",
          "modelWorking": "(a) Revenue = 80 \u00d7 $1,200 = $96,000\n(b) Profit = Revenue \u2212 Cost = $96,000 \u2212 $59,950 = $36,050",
          "modelAnswer": "(a) Revenue = $96,000  (b) Profit = $36,050"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Express profit as a fraction of revenue; convert to percentage",
          "prompt": "(a) Express the profit as a fraction of the total revenue. Simplify.\n(b) Convert to a percentage.\n\nShow ALL your working.",
          "modelWorking": "(a) Fraction = 36,050/96,000\n    Divide both by 50: 721/1920\n    Check GCF: 721 = 7 \u00d7 103; 1920 = 2\u2077 \u00d7 3 \u00d7 5\n    No common factors. Fraction = 721/1920\n(b) 721 \u00f7 1920 = 0.3755...\n    \u2248 37.6%",
          "modelAnswer": "(a) 721/1920  (b) \u2248 37.6% profit margin"
        }
      ]
    }
  ],
...
export default function MathPerfDifficult1Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Difficult 1",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Difficult 1</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Difficult 1</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Difficult 1</h1>
