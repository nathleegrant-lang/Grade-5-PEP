...
const taskData = {
  "scenarioTitle": "The Class Trip",
  "scenario": "Your class is going on a trip to Hope Zoo in Kingston. You are helping to organise the cost and transport.",
  "parts": [
    {
      "num": 1,
      "title": "Bus Seats",
      "context": "The class has 42 students and 3 teachers. A bus holds 16 passengers.",
      "questions": [
        {
          "num": 1,
          "strand": "Number",
          "objective": "Solve problems requiring division with remainders",
          "prompt": "How many buses are needed to take all students AND teachers on the trip?\n\nShow ALL your working.",
          "modelWorking": "Total passengers = 42 students + 3 teachers = 45 people\n45 \u00f7 16 = 2 remainder 13\n2 buses carry 32 people \u2014 not enough.\nA 3rd bus is needed for the remaining 13 people.\nTotal = 3 buses needed.",
          "modelAnswer": "3 buses needed"
        }
      ]
    },
    {
      "num": 2,
      "title": "Entry Fees",
      "context": "Admission to Hope Zoo costs:\n\u2022 Students: $500 each\n\u2022 Teachers: $800 each",
      "questions": [
        {
          "num": 2,
          "strand": "Number",
          "objective": "Solve multi-step problems involving money",
          "prompt": "Calculate:\n(a) Total cost for all 42 students\n(b) Total cost for all 3 teachers\n(c) Grand total for everyone\n\nShow ALL your working.",
          "modelWorking": "(a) Students: 42 \u00d7 $500 = $21,000\n(b) Teachers: 3 \u00d7 $800 = $2,400\n(c) Grand total = $21,000 + $2,400 = $23,400",
          "modelAnswer": "(a) $21,000  (b) $2,400  (c) $23,400"
        },
        {
          "num": 3,
          "strand": "Number",
          "objective": "Solve problems involving money and fractions",
          "prompt": "The school has already collected $12,000 from students for the trip.\nWhat FRACTION of the grand total has been collected?\nGive your answer in simplest form.\n\nShow ALL your working.",
          "modelWorking": "Fraction collected = $12,000 / $23,400\nSimplify: GCF of 12,000 and 23,400\n12,000 \u00f7 200 = 60\n23,400 \u00f7 200 = 117\nFraction = 60/117\nGCF of 60 and 117: 60 = 3\u00d720, 117 = 3\u00d739 \u2192 GCF = 3\n60 \u00f7 3 = 20, 117 \u00f7 3 = 39\nFraction = 20/39",
          "modelAnswer": "20/39"
        }
      ]
    },
    {
      "num": 3,
      "title": "Lunch Budget",
      "context": "Each student receives $350 for lunch at the zoo.",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve problems requiring multiplication",
          "prompt": "What is the total amount given to ALL 42 students for lunch?\n\nShow ALL your working.",
          "modelWorking": "Total lunch money = 42 \u00d7 $350\n= 40 \u00d7 $350 + 2 \u00d7 $350\n= $14,000 + $700\n= $14,700",
          "modelAnswer": "$14,700"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Solve multi-step problems involving money",
          "prompt": "A student spends $180 on food and $95 on a souvenir.\nHow much money does she have left from her $350?\n\nShow ALL your working.",
          "modelWorking": "Total spent = $180 + $95 = $275\nMoney remaining = $350 \u2212 $275 = $75",
          "modelAnswer": "$75 remaining"
        }
      ]
    }
  ],
...
export default function MathPerfEasy7Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Easy 7",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Easy 7</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Easy 7</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Easy 7</h1>
