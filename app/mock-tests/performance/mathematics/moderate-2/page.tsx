...
const taskData = {
  "scenarioTitle": "The Athletics Championship",
  "scenario": "Your school is competing in the parish athletics championship. You are helping to analyse the results.",
  "parts": [
    {
      "num": 1,
      "title": "Race Times",
      "context": "The 100m sprint results for the top 5 finishers were:\n1st: 13.2 sec   2nd: 13.8 sec   3rd: 14.1 sec   4th: 14.5 sec   5th: 15.0 sec",
      "questions": [
        {
          "num": 1,
          "strand": "Statistics",
          "objective": "Calculate the mean (average) of a set of data",
          "prompt": "Calculate the MEAN (average) finishing time for the top 5 runners.\n\nShow ALL your working.",
          "modelWorking": "Sum of times = 13.2 + 13.8 + 14.1 + 14.5 + 15.0\n= 27.0 + 14.1 + 14.5 + 15.0\n= 41.1 + 14.5 + 15.0\n= 55.6 + 15.0\n= 70.6 seconds\nMean = 70.6 \u00f7 5 = 14.12 seconds",
          "modelAnswer": "Mean = 14.12 seconds"
        },
        {
          "num": 2,
          "strand": "Statistics",
          "objective": "Find range of a data set",
          "prompt": "What is the RANGE of the finishing times?\n\nRange = Maximum value \u2212 Minimum value\n\nShow ALL your working.",
          "modelWorking": "Maximum time = 15.0 sec\nMinimum time = 13.2 sec\nRange = 15.0 \u2212 13.2 = 1.8 seconds",
          "modelAnswer": "Range = 1.8 seconds"
        }
      ]
    },
    {
      "num": 2,
      "title": "Long Jump Results",
      "context": "Three students jumped:\nStudent A: 3.45 m\nStudent B: 3.72 m\nStudent C: 3.58 m",
      "questions": [
        {
          "num": 3,
          "strand": "Measurement",
          "objective": "Compare and order decimal measurements",
          "prompt": "(a) Which student jumped the FURTHEST?\n(b) What is the difference in distance between the furthest and shortest jump?\n\nShow ALL your working.",
          "modelWorking": "(a) Compare: 3.45, 3.58, 3.72\n    Ordering: 3.72 > 3.58 > 3.45\n    Student B jumped furthest (3.72 m)\n(b) Difference = 3.72 \u2212 3.45 = 0.27 m",
          "modelAnswer": "(a) Student B (3.72 m)  (b) 0.27 m difference"
        }
      ]
    },
    {
      "num": 3,
      "title": "Team Scores",
      "context": "Points are awarded for each event: 1st = 5 pts, 2nd = 3 pts, 3rd = 1 pt\nYour school placed: 1st in 4 events, 2nd in 3 events, 3rd in 5 events",
      "questions": [
        {
          "num": 4,
          "strand": "Number",
          "objective": "Solve multi-step problems requiring multiplication and addition",
          "prompt": "Calculate your school's TOTAL points for the championship.\n\nShow ALL your working.",
          "modelWorking": "Points for 1st places = 4 \u00d7 5 = 20\nPoints for 2nd places = 3 \u00d7 3 = 9\nPoints for 3rd places = 5 \u00d7 1 = 5\nTotal points = 20 + 9 + 5 = 34 points",
          "modelAnswer": "34 points"
        },
        {
          "num": 5,
          "strand": "Number",
          "objective": "Solve problems involving fractions of totals",
          "prompt": "The rival school scored 48 points.\nWhat fraction of the rival school's score did your school achieve?\nSimplify your answer.\n\nShow ALL your working.",
          "modelWorking": "Your school = 34 points\nRival school = 48 points\nFraction = 34/48\nGCF of 34 and 48: 34 = 2 \u00d7 17, 48 = 2 \u00d7 24 \u2192 GCF = 2\n34 \u00f7 2 = 17\n48 \u00f7 2 = 24\nFraction = 17/24",
          "modelAnswer": "17/24"
        }
      ]
    }
...
export default function MathPerfModerate2Page() {
      ...
      const calls = allQuestions.map((q: any, i: number) =>
        fetch("/api/mark-response", {
          ...
          body: JSON.stringify({
            ...
            taskTitle: "Performance Task - Moderate 2",
          }),
        }).then(r => r.json())
      )
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-2xl text-white">Mathematics Performance Task Moderate 2</CardTitle>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto max-w-4xl border-blue-300 shadow-lg">
          <CardHeader className="bg-blue-700 text-center rounded-t-lg">
            ...
            <CardTitle className="text-xl text-white">Model Answers & AI Feedback — Mathematics Performance Task Moderate 2</CardTitle>
          </CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-slate-50">
      ...
      <header className="bg-blue-700 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm">Mathematics Performance Task Moderate 2</h1>
