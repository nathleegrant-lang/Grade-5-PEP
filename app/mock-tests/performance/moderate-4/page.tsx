        ...
        <main className="container mx-auto px-4 py-10">
          ...
          <Card className="mx-auto max-w-3xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              <CardTitle className="text-2xl text-amber-800">Grade 5 Performance Task Moderate 4</CardTitle>
              <p className="text-slate-600">Topic: School Vegetable Garden Initiative</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
              <div className="rounded-lg border border-amber-200 bg-white p-4">
                <h3 className="mb-2 font-semibold text-slate-800">Task Overview</h3>
                <p className="text-slate-700">Your school is considering starting a vegetable garden. Read the information below, answer the questions, and complete the writing task to share your recommendations.</p>
              </div>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-amber-200 shadow-lg">
            <CardHeader className="bg-amber-50 text-center">
              ...
              <p className="text-slate-600">Grade 5 Performance Task Moderate 4</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mx-auto max-w-4xl space-y-6">
          <div className="flex items-center justify-between rounded-lg bg-slate-800 p-4 text-white">
            <div>
              <h1 className="font-bold">Grade 5 Performance Task Moderate 4</h1>
          ...
          <Card className="border-blue-200">
            ...
            <CardContent className="space-y-4 p-6 text-slate-700">
              <p>Growing vegetables at school has become increasingly popular across Jamaica. A school garden gives students the opportunity to learn about plants, healthy food, and environmental responsibility in a practical, hands-on way. Studies show that students who grow their own food are more willing to eat vegetables and develop a better understanding of where food comes from.</p>
              <p>A successful school garden requires planning and cooperation. The garden needs a suitable location with good sunlight and access to water. Teachers can integrate the garden into lessons — for example, measuring plant growth in Mathematics, studying plant biology in Science, and writing garden journals in Language Arts. Students can take turns caring for the plants before and after school.</p>
              <p>The vegetables grown in a school garden can supplement the meals served in the school canteen, reducing costs and improving nutrition. Surplus produce can be sold at a small market to raise funds for the school. Parents and community volunteers can also support the garden by donating tools, seeds, and time, strengthening the link between the school and its community.</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-purple-200">
            ...
            <CardContent className="space-y-4 p-6">
              <p className="text-slate-700">Write a proposal to your school principal recommending that the school start a vegetable garden. Include at least TWO benefits of the garden and explain how students, teachers, and parents can each play a role in making it successful.</p>
