...
const g5MathDiff8Questions: Question[] = [
  {
    id: 1,
    type: "number",
    skill: "Discriminant",
...
export default function G5MathDiff8MockTest() {
  ...
  const availableQuestions = isPremium ? g5MathDiff8Questions : g5MathDiff8Questions.slice(0, FREE_QUESTION_LIMIT)
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-slate-200 shadow-lg">
          <CardHeader className="bg-slate-50 text-center">
            ...
            <CardTitle className="text-2xl text-slate-800">Mathematics Difficult 8</CardTitle>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-slate-200 shadow-lg">
            <CardHeader className="bg-slate-50 text-center">
              ...
              <p className="text-slate-600">Mathematics Difficult 8</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
      ...
      <header className="bg-slate-800 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div><h1 className="text-lg font-bold">Mathematics Difficult 8</h1><p className="text-sky-100 text-xs">Question {currentQuestion + 1} of {totalQuestions}</p></div>
          </div>
