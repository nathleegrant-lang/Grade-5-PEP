...
const g5MathDiff6Questions: Question[] = [
  {
    id: 1,
    type: "number",
    skill: "Discriminant",
  ...
  },
  {
    ...
    type: "number",
    skill: "Simultaneous",
    question: `x+y=7 and 2x-y=5. Find x.`,
    options: [
      "3",
      "4",
      "5",
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: `2.4÷6=0.4. 10⁵÷10²=10³. 0.4×10³=4×10². Answer=4×10².`
  },
  {
    id: 4,
    type: "number",
  ...
  },
  {
    id: 17,
    type: "measurement",
    skill: "Work Done Together",
    question: `A finishes job in 10 days, B in 15 days. Together they finish in:`,
    options: [
      "6 days",
      "7 days",
      "8 days",
    ...
    correctAnswer: 0,
    explanation: `Rate=1/10+1/15=5/30=1/6. Time=6 days.`
  },
  {
    id: 18,
    type: "measurement",
    skill: "Bearing Distance",
    question: `Ship: 240° for 80km then 330° for 60km. These directions are perpendicular (angle between=90°). Distance from start =`,
    options: [
      "80 km",
      "90 km",
      "100 km",
    ...
    correctAnswer: 2,
    explanation: `√(80²+60²)=√10,000=100 km.`
  },
  {
    id: 19,
    type: "measurement",
    skill: "Annual Depreciation",
    question: `Car $15,000 → $10,935 after 3 years. Approximate annual depreciation rate =`,
    options: [
      "8%",
      "10%",
      "12%",
    ...
    correctAnswer: 1,
    explanation: `(10935/15000)^(1/3)≈0.9=1-0.1=10%.`
  },
  {
    id: 20,
    type: "measurement",
  ...
  },
  {
    ...
    question: `Cube 4cm side, hemisphere r=2cm on top. Total SA (π=3.14):`,
    options: [
      "91.12 cm²",
      "95.12 cm²",
      "108.56 cm²",
    ...
    correctAnswer: 2,
    explanation: `Cube=6×16=96. Remove top circle: -π×4=-12.56. Add hemi curved: 2π×4=25.12. Total=96-12.56+25.12=108.56 cm².`
  },
  {
    id: 26,
    type: "geometry",
  ...
  },
  {
    id: 33,
    type: "geometry",
    skill: "Intersecting Chords Angle",
    question: `Two chords intersect inside circle. Angle=60°. One arc=100°. Other arc =`,
    options: [
      "20°",
      "30°",
      "40°",
    ...
    correctAnswer: 0,
    explanation: `Angle=½(arc1+arc2). 60=½(100+arc2). arc2=20°.`
  },
  {
    id: 34,
    type: "statistics",
  ...
  },
  {
    ...
    question: `Sample mean=50, SD=8, n=64. 95% CI (z=1.96):`,
    options: [
      "48.04 to 51.96",
      "46.32 to 53.68",
      "47.04 to 52.96",
    ...
    correctAnswer: 0,
    explanation: `SE=8/√64=1. 50±1.96=48.04 to 51.96.`
  },
  {
    id: 37,
    type: "statistics",
...
export default function G5MathDiff6MockTest() {
  ...
  const availableQuestions = isPremium ? g5MathDiff6Questions : g5MathDiff6Questions.slice(0, FREE_QUESTION_LIMIT)
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-slate-200 shadow-lg">
          <CardHeader className="bg-slate-50 text-center">
            ...
            <CardTitle className="text-2xl text-slate-800">Mathematics Difficult 6</CardTitle>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-slate-200 shadow-lg">
            <CardHeader className="bg-slate-50 text-center">
              ...
              <p className="text-slate-600">Mathematics Difficult 6</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
      ...
      <header className="bg-slate-800 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div><h1 className="text-lg font-bold">Mathematics Difficult 6</h1><p className="text-sky-100 text-xs">Question {currentQuestion + 1} of {totalQuestions}</p></div>
          </div>
