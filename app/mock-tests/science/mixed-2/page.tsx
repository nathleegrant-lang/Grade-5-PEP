...
const g5ScMix2Questions: Question[] = [
  {
    id: 1,
    type: "living",
  ...
  },
  {
    ...
    question: `A doctor uses an AI system to help diagnose cancer from medical images. The AI has 95% accuracy. What does this mean in practice, and what concern remains?`,
    options: [
      "95% is perfect — no concern",
      "The AI is useless at 95%",
      "95% accuracy means 5% of diagnoses are wrong — in a cancer screening context, false negatives (missing cancer) and false positives (diagnosing cancer when none exists) both cause harm. The remaining 5% error rate requires human physician oversight and cannot be eliminated purely by AI",
      "Only false positives matter",
    ],
    correctAnswer: 2,
    explanation: `Error rate analysis in medical AI: 5% error rate seems small, but at scale it is significant. False negatives (missed cancers) delay life-saving treatment. False positives cause unnecessary anxiety, procedures, and costs. Medical AI should augment rather than replace physician judgement — the human provides the contextual reasoning and accountability that AI cannot.`
  },
  {
    id: 37,
    type: "technology",
...
export default function G5ScMix2MockTest() {
  ...
  const availableQuestions = isPremium ? g5ScMix2Questions : g5ScMix2Questions.slice(0, FREE_QUESTION_LIMIT)
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-purple-200 shadow-lg">
          <CardHeader className="bg-purple-50 text-center">
            ...
            <CardTitle className="text-2xl text-purple-800">Science Mixed 2</CardTitle>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-purple-200 shadow-lg">
            <CardHeader className="bg-purple-50 text-center">
              ...
              <p className="text-slate-600">Science Mixed 2</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
      ...
      <header className="bg-purple-800 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div><h1 className="text-lg font-bold">Science Mixed 2</h1><p className="text-purple-100 text-xs">Question {currentQuestion + 1} of {totalQuestions}</p></div>
          </div>
