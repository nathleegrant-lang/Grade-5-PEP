...
const g5ScMod3Questions: Question[] = [
  {
    id: 1,
    type: "living",
    skill: "Applying Ecology",
    question: `A pond has algae, water beetles, small fish, and herons. A drought reduces the pond's water level significantly. List the cascade of effects.`,
    options: [
      "Everything is equally affected",
      "Only herons are affected",
      "Water area shrinks → algae crowd and deplete nutrients → beetles and fish have less space and food → heron food (fish) becomes scarce → heron population declines or leaves",
      "Nothing changes since the water is still there",
    ],
    correctAnswer: 2,
    explanation: `Environmental change cascades through ecosystems: reduced water → reduced habitat for all → increased competition for resources → smaller populations at all levels → apex predator (heron) suffers last but most visibly.`
  },
  {
    id: 2,
    type: "living",
    skill: "Cause & Effect",
    question: `A child is given an antibiotic for a viral cold. Why is this NOT effective?`,
    options: [
      "Antibiotics are only for children",
      "The child took the antibiotic incorrectly",
      "Antibiotics kill bacteria — viruses have completely different structures (no cell wall, no ribosomes that antibiotics target) so antibiotics have no effect on viral infections",
      "Antibiotics only work in hospitals",
    ],
    correctAnswer: 2,
    explanation: `Antibiotics specifically target bacterial structures (cell walls, protein synthesis machinery). Viruses are not cells — they are nucleic acid inside a protein coat and use host cell machinery. Antibiotics have no target in viruses.`
  },
  {
    id: 3,
    type: "living",
    skill: "Data Interpretation",
    question: `A student grows beans in three soils: sand, clay, and loam. After 3 weeks: Sand — 8 cm, Clay — 5 cm, Loam — 15 cm. WHY did beans grow BEST in loam?`,
    options: [
      "Loam is the most modern soil",
      "Loam is a dark colour",
      "Loam has a balanced mixture of sand (drainage), silt, clay, and humus — providing optimal water retention, drainage, aeration, and nutrients for plant root growth",
      "Loam contains more worms than other soils",
    ],
    correctAnswer: 2,
    explanation: `Loam's balanced texture provides what plants need: enough drainage to prevent waterlogging (from the sand fraction); enough water and nutrient retention (from clay and silt); and organic matter from humus. Sandy soil drains too fast; clay becomes waterlogged and poorly aerated.`
  },
  {
    id: 4,
    type: "living",
    skill: "Applying Genetics",
    question: `A pure-breeding red flower plant is crossed with a pure-breeding white flower plant. All offspring are pink. This result demonstrates:`,
    options: [
      "Red and white are both dominant",
      "Only red is dominant",
      "Incomplete dominance — neither allele is fully dominant, and the heterozygous offspring shows an intermediate (blended) phenotype",
      "A mutation occurred in the laboratory",
    ],
    correctAnswer: 2,
    explanation: `Incomplete dominance produces intermediate phenotypes in heterozygotes. Neither allele completely masks the other — red + white = pink. This is distinct from complete dominance (where one allele fully masks the other).`
  },
  {
    id: 5,
    type: "living",
    skill: "Applying Adaptation",
    question: `Arctic animals often have WHITE FUR in winter and BROWN FUR in summer. This seasonal colour change is an adaptation for:`,
    options: [
      "Temperature regulation only",
      "Attracting mates in different seasons",
      "Camouflage in changing environments — white fur blends with snow in winter; brown fur blends with bare ground and vegetation in summer, reducing predation year-round",
      "Fashion purposes",
    ],
    correctAnswer: 2,
    explanation: `Seasonal camouflage is an evolved adaptation matching background colour changes. White against snow in winter and brown against vegetation/rock in summer reduces visibility to both predators (prey species) and prey (predator species).`
  },
  {
    id: 6,
    type: "living",
    skill: "Applying Human Biology",
    question: `A student checks her pulse before exercise (70 bpm) and immediately after running (145 bpm). What does this increase tell us?`,
    options: [
      "Her heart became stronger during running",
      "She is ill",
      "Her muscles need more oxygen during exercise — the heart beats faster to deliver oxygenated blood and remove CO2 more quickly to meet the increased metabolic demand of working muscles",
      "Running has no effect on heart rate",
    ],
    correctAnswer: 2,
    explanation: `Heart rate increases during exercise because: muscles working harder need more oxygen for aerobic respiration; the heart must pump faster to deliver oxygen-rich blood and remove CO2-rich blood from active muscles. Heart rate is a direct indicator of exercise intensity.`
  },
  {
    id: 7,
    type: "living",
    skill: "Cause & Effect",
    question: `OVERUSE of ANTIBIOTICS in livestock farming is concerning because:`,
    options: [
      "Antibiotics make livestock stronger",
      "Antibiotics improve the taste of meat",
      "Bacteria in livestock develop resistance to antibiotics — resistant strains can transfer to humans, making common infections harder to treat with existing antibiotics",
      "Antibiotics make livestock larger than natural",
    ],
    correctAnswer: 2,
    explanation: `Agricultural antibiotic overuse promotes resistance: bacteria exposed to low-level antibiotics evolve resistance through natural selection. Resistant strains can spread to humans via food chains or direct contact, creating public health risks.`
  },
  {
    id: 8,
    type: "living",
    skill: "Interpreting Data",
    question: `A student exposes pond water containing green algae to different light colours and measures O2 production: Red light — 8 ml, Orange — 5 ml, Yellow — 4 ml, Green — 1 ml, Blue — 7 ml. Which conclusion is MOST valid?`,
    options: [
      "All light colours are equally effective",
      "Green light is best for photosynthesis",
      "Red and blue light are most effective for photosynthesis in these algae — green light is least effective because chlorophyll reflects (not absorbs) green wavelengths",
      "Orange light should never be used",
    ],
    correctAnswer: 2,
    explanation: `Chlorophyll absorbs red and blue wavelengths most strongly (hence these drive photosynthesis best) and reflects green light (hence plants appear green — they reflect unused green light). This classic absorption spectrum experiment confirms this.`
  },
  {
    id: 9,
    type: "living",
    skill: "Applying Ecology",
    question: `A species of plant produces sweet berries eaten by birds, which then deposit seeds in their droppings far from the parent plant. This relationship BENEFITS:`,
    options: [
      "Only the birds",
      "Only the plant",
      "Both species — birds get nutrition from berries (mutualism); plant gets seeds dispersed over a wider area, increasing colonisation chances",
      "Neither species — it is a neutral interaction",
    ],
    correctAnswer: 2,
    explanation: `This is mutualistic seed dispersal — both species benefit: birds gain food; plants gain dispersal (seeds in droppings germinate away from parent, reducing competition and expanding range). Co-evolution drives this relationship.`
  },
  {
    id: 10,
    type: "living",
    skill: "Cause & Effect",
    question: `What happens to a cell if it is placed in a solution with a VERY HIGH SALT CONCENTRATION?`,
    options: [
      "The cell expands and grows",
      "The cell produces more salt to compensate",
      "Water moves out of the cell by osmosis — the cell shrinks and becomes dehydrated as water leaves to equalise concentration",
      "The cell absorbs salt through its membrane",
    ],
    correctAnswer: 2,
    explanation: `Osmosis: water moves from low concentration (inside the cell) to high concentration (the salty solution) across the semi-permeable membrane. The cell loses water, shrinks, and may die — this is why salt preserves food (dehydrating bacteria).`
  },
  {
    id: 11,
    type: "physical",
...
export default function G5ScMod3MockTest() {
  ...
  const availableQuestions = isPremium ? g5ScMod3Questions : g5ScMod3Questions.slice(0, FREE_QUESTION_LIMIT)
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-purple-200 shadow-lg">
          <CardHeader className="bg-purple-50 text-center">
            ...
            <CardTitle className="text-2xl text-purple-800">Science Moderate 3</CardTitle>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-purple-200 shadow-lg">
            <CardHeader className="bg-purple-50 text-center">
              ...
              <p className="text-slate-600">Science Moderate 3</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
      ...
      <header className="bg-purple-800 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div><h1 className="text-lg font-bold">Science Moderate 3</h1><p className="text-purple-100 text-xs">Question {currentQuestion + 1} of {totalQuestions}</p></div>
          </div>
