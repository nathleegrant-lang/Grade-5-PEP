...
const g5ScMix8Questions: Question[] = [
  {
    id: 1,
    type: "living",
...
export default function G5ScMix8MockTest() {
  ...
  const availableQuestions = isPremium ? g5ScMix8Questions : g5ScMix8Questions.slice(0, FREE_QUESTION_LIMIT)
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-purple-200 shadow-lg">
          <CardHeader className="bg-purple-50 text-center">
            ...
            <CardTitle className="text-2xl text-purple-800">Science Mixed 8</CardTitle>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-purple-200 shadow-lg">
            <CardHeader className="bg-purple-50 text-center">
              ...
              <p className="text-slate-600">Science Mixed 8</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
      ...
      <header className="bg-purple-800 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div><h1 className="text-lg font-bold">Science Mixed 8</h1><p className="text-purple-100 text-xs">Question {currentQuestion + 1} of {totalQuestions}</p></div>
          </div>
