...
const technologyPassage = `Read the passage then answer the question.

"When tablets arrived at Fairfield Primary, some pupils thought every lesson would become a game. Mr. Henry explained that technology was a tool, not a replacement for careful thinking. During science, pupils used the tablets to watch a short video of how roots absorb water. Then they drew labelled diagrams in their notebooks and compared their ideas with a partner. In mathematics, an app gave instant feedback on fractions, but pupils still had to show their working on paper before moving to the next activity.

The devices were most helpful when they allowed pupils to explore information that was difficult to see in the classroom. For a social studies project, groups viewed maps of Jamaican parishes and researched how roads, rivers, and mountains affect communities. However, Mr. Henry set clear rules. Pupils had to use trusted websites, record sources, and close unrelated pages. If the internet became slow, groups continued with textbooks and discussion questions. By the end of the term, pupils understood that technology could make learning richer when used responsibly. It helped them practise, investigate, and present ideas, but success still depended on reading carefully, asking questions, and working steadily."`;

const citizenshipPassage = `Read the passage then answer the question.

"Before Grade 5 began its online research project, Mrs. Morgan taught a lesson on digital citizenship. She wrote three words on the board: safe, respectful, and truthful. Pupils discussed why these words mattered whenever they used a phone, tablet, or computer. One group explained that personal information, such as an address or password, should never be shared in a class chat. Another group said that jokes online can hurt people because the reader cannot always hear a friendly tone.

Mrs. Morgan gave the class sample messages and asked them to decide which ones were responsible. A message that thanked a partner for help was approved. A message that copied a whole paragraph from a website without naming the source was rejected. The class learned that digital citizens give credit for information and check facts before passing them on. Later that week, Dena saw a rumour about a cancelled sports day in a group chat. Instead of forwarding it, she asked her teacher, who confirmed that sports day was still planned. Dena's choice prevented confusion. The lesson helped pupils see that being online is not separate from real life; their words and choices can protect or harm others."`;

const g5LaModerate3Questions: Question[] = [
  {
    id: 1,
    type: "reading",
    skill: "Main Idea",
...
export default function G5LaModerate3MockTest() {
  ...
  const sourceQuestions = isPremium
    ? g5LaModerate3Questions
    : g5LaModerate3Questions.slice(0, FREE_QUESTION_LIMIT);
      ...
      <header className="bg-blue-800 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold">Language Arts Moderate 3</h1>
