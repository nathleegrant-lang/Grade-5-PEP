...
const leadershipPassage = `Read the passage then answer the question.

"When Hope Valley Primary was invited to send eight pupils to the parish Student Leadership Conference, the Grade 5 class felt excited but nervous. The conference would be held at the civic centre in May Pen, and each school had to prepare a short presentation about solving a school problem. Instead of choosing only the pupils who spoke the loudest, Mrs. Brown asked classmates to nominate students who listened carefully, kept promises, and encouraged others. The selected team met during lunch for two weeks to plan their presentation on keeping the school compound safe and welcoming.

At the conference, pupils from many schools shared ideas about conflict resolution, clean classrooms, and respectful communication. Hope Valley's team explained how a suggestion box and weekly class monitors could help pupils report concerns before small problems became serious. During a group activity, the team had to work with unfamiliar pupils to design a poster about responsible leadership. Marlon, who was usually shy, offered the slogan, "Leaders serve before they shine." The judges praised the team because every member contributed. When they returned to school, the pupils did not simply display their certificates. They organised a mini-assembly to teach others that leadership is shown through service, fairness, and dependable action."`;

const mentorshipPassage = `Read the passage then answer the question.

"At Seaview Primary, several Grade 4 pupils were struggling to read long instructions and complete homework on time. The guidance counsellor, Miss Reid, suggested a peer mentorship programme in which responsible Grade 5 pupils would support younger students twice each week. Before the programme began, mentors attended a training session. They learned that a mentor should not do another child's work. Instead, mentors should ask helpful questions, model good habits, and praise genuine effort.

Each Tuesday and Thursday afternoon, pairs met under the almond tree near the library. Some mentors helped mentees break assignments into smaller steps, while others practised spelling words or read short passages aloud. At first, a few younger pupils felt embarrassed, so Miss Reid reminded everyone that asking for help was a sign of courage, not weakness. After a month, teachers noticed that homework books were neater and more pupils were raising their hands during lessons. The mentors also benefited. They became more patient, improved their own explanations, and learned to celebrate small progress. At the closing meeting, one mentee said, "My mentor did not give me answers; she helped me believe I could find them." The programme showed that learning grows when older and younger pupils respect one another."`;

const g5LaModerate2Questions: Question[] = [
  {
    id: 1,
    type: "reading",
    skill: "Main Idea",
    question: `${leadershipPassage}\n\nWhat is the main idea of the student leadership conference passage?`,
    options: [
      ...
      "Pupils learn useful lessons while taking part in student leadership conference.",
    ],
    correctAnswer: 3,
    explanation: `The passage focuses on pupils participating in student leadership conference and learning important habits and ideas.`,
  },
  {
    id: 2,
    type: "reading",
  ...
  },
  {
    ...
    type: "reading",
    skill: "Theme",
    question: `${mentorshipPassage}\n\nWhich theme is most strongly shown in the peer mentorship programme passage?`,
    options: [
...
export default function G5LaModerate2MockTest() {
  ...
  const sourceQuestions = isPremium
    ? g5LaModerate2Questions
    : g5LaModerate2Questions.slice(0, FREE_QUESTION_LIMIT);
      ...
      <header className="bg-blue-800 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold">Language Arts Moderate 2</h1>
