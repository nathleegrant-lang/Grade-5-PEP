...
const g5LaMod7Questions: Question[] = [
  {
    id: 1,
    type: "reading",
    skill: "Inference",
...
"For many young Jamaicans who grow up abroad, questions of identity are never simple. They are Jamaican by heritage but British or American or Canadian by birth or upbringing. They may speak English without an accent, know every verse of the national anthem, and yet feel a distance from a home they have visited but never fully lived in. Some describe a feeling of 'standing between two worlds' — belonging fully to neither. Yet others find that this in-between space is not a weakness but a gift. Exposure to multiple cultures, languages, and ways of thinking equips them with a flexibility and empathy that those who grew up in only one culture may not develop. Identity, for these young people, is not a fixed address — it is a fluid, evolving conversation."
...
What does the passage IMPLY about the importance of this topic to Jamaican society?`,
  ...
  },
  {
    ...
    question: `In the passage about migration and identity, the writer uses extended description to suggest that:`,
    options: [
      "The topic is boring",
...
export default function G5LaMod7MockTest() {
  ...
  const availableQuestions = isPremium ? g5LaMod7Questions : g5LaMod7Questions.slice(0, FREE_QUESTION_LIMIT)
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-200 shadow-lg">
          <CardHeader className="bg-blue-50 text-center">
            ...
            <CardTitle className="text-2xl text-blue-800">Language Arts Moderate 7</CardTitle>
      ...
      <header className="bg-blue-800 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div><h1 className="text-lg font-bold">Language Arts Moderate 7</h1><p className="text-blue-100 text-xs">Question {currentQuestion + 1} of {totalQuestions}</p></div>
          </div>
