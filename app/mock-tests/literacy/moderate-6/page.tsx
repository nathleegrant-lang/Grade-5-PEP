...
const g5LaMod6Questions: Question[] = [
  {
    id: 1,
    type: "reading",
    skill: "Inference",
...
"When sixteen-year-old Maya returned to Jamaica after spending three years abroad, she barely recognised the river near her old primary school. Where she had once waded and caught crayfish, she now found plastic bags, rusting metal, and murky water so polluted that no fish could survive. Instead of accepting what she saw, Maya chose to act. She organised a community clean-up, partnered with a local environmental NGO, and began documenting the pollution on social media. Within six months, the campaign had attracted national attention, corporate sponsors, and government commitments to begin river restoration. Maya later reflected, 'The river did not look like a problem that could be fixed. But the more people you involve, the more possible the impossible becomes.'"
...
What does the passage IMPLY about the importance of this topic to Jamaican society?`,
  ...
  },
  {
    ...
    question: `In the passage about environmental activism, the writer uses extended description to suggest that:`,
    options: [
      "The topic is boring",
...
export default function G5LaMod6MockTest() {
  ...
  const availableQuestions = isPremium ? g5LaMod6Questions : g5LaMod6Questions.slice(0, FREE_QUESTION_LIMIT)
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-200 shadow-lg">
          <CardHeader className="bg-blue-50 text-center">
            ...
            <CardTitle className="text-2xl text-blue-800">Language Arts Moderate 6</CardTitle>
      ...
      <header className="bg-blue-800 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div><h1 className="text-lg font-bold">Language Arts Moderate 6</h1><p className="text-blue-100 text-xs">Question {currentQuestion + 1} of {totalQuestions}</p></div>
          </div>
