...
What is the MAIN idea of Passage 1?`,
  ...
  },
  {
    ...
    options: [
      "Learning to care for and protect nature",
      "Winning every competition",
      "Avoiding all ocean activities",
      "Keeping schoolwork secret",
    ],
    correctAnswer: 0,
    explanation: `The students learn about responsible fishing and protecting sea life, so the passage shows the importance of caring for nature.`
  },
  {
    id: 10,
    type: "reading",
    ...
    options: [
      ...
      "The students recorded notes",
      "Mr. Grant checked his nets at sunrise",
    ],
    correctAnswer: 1,
...
What is the MAIN purpose of the letter?`,
  ...
  },
  {
    ...
    options: [
      "Before beginning, organise the materials required for the activity.",
      "Pupils should ensure that all instructions are followed carefully.",
      "First, take your pencil and write your name.",
      "Begin by recording your full name in the space provided.",
    ],
    correctAnswer: 2,
...
export default function G5LaEasy1MockTest() {
  ...
  const startTest = () => {
    const preparedQuestions = isPremium
      ? prepareAssessment(g5LaEasy1Questions)
      : preparePreview(g5LaEasy1Questions, FREE_QUESTION_LIMIT)
  ...
  return <FocusedActiveRunner
    assessmentName="Language Arts Easy 1"
    question={q}
    ...
    onPrevious={() => setCurrentQuestion((previous) => previous - 1)}
    onNext={() => setCurrentQuestion((previous) => previous + 1)}
