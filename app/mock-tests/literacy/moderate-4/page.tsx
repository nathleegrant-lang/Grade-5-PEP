...
const g5LaModerate4Questions: Question[] = [
  {
    ...
    type: "reading",
    skill: "Main Idea",
    question: `${hurricanePassage}\n\nWhat is the main idea of the hurricane preparedness passage?`,
    options: [
      ...
      "Pupils learn useful lessons while taking part in hurricane preparedness.",
    ],
    correctAnswer: 3,
    explanation: `The passage focuses on pupils participating in hurricane preparedness and learning important habits and ideas.`,
  },
  {
    id: 2,
    type: "reading",
  ...
  },
  {
    ...
    type: "reading",
    skill: "Theme",
    question: `${resiliencePassage}\n\nWhich theme is most strongly shown in the community resilience passage?`,
    options: [
  ...
  },
  {
    ...
    question: `Which topic sentence best begins a paragraph about hurricane preparedness?`,
    options: [
      "Hurricane Preparedness taught pupils several important lessons.",
