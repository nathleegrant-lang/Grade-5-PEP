...
const g5LaDiff5Questions: Question[] = [
  {
    id: 1,
    type: "reading",
...
"There is a particular kind of loneliness that comes not from being alone, but from being surrounded and unseen. Amara had experienced this in London when she arrived at sixteen, her Jamaican accent marking her as foreign even among other Black students. She had experienced it again when she returned to Jamaica at twenty-two, and her British vowels made people laugh and call her 'foreign.' Belonging, she decided, was not a place. It was not even a community. It was a feeling she would have to build for herself — brick by brick, conversation by conversation — because no geography had reserved it for her. She was too much of one place for the other, and so she would have to become her own country."
...
export default function G5LaDiff5MockTest() {
  ...
  const availableQuestions = isPremium ? g5LaDiff5Questions : g5LaDiff5Questions.slice(0, FREE_QUESTION_LIMIT)
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-200 shadow-lg">
          <CardHeader className="bg-blue-50 text-center">
            ...
            <CardTitle className="text-2xl text-blue-800">Language Arts Difficult 5</CardTitle>
      ...
      <header className="bg-blue-800 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div><h1 className="text-lg font-bold">Language Arts Difficult 5</h1><p className="text-blue-100 text-xs">Question {currentQuestion + 1} of {totalQuestions}</p></div>
          </div>
