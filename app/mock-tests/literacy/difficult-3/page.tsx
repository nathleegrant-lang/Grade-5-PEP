...
const g5LaDiff3Questions: Question[] = [
  {
    id: 1,
    type: "reading",
...
"Language is never neutral. Every word we choose carries with it a history — of who used it, how, and against whom. When colonial administrators described indigenous lands as 'empty' or 'unclaimed,' they were not making an observation; they were performing an act of erasure. To name something is to claim authority over it. To rename it — as colonised people did when they gave their own names to mountains, rivers, and streets — is to reclaim that authority. This is why debates about language are never merely academic. They are debates about power, identity, and whose version of reality gets to be written down."
...
export default function G5LaDiff3MockTest() {
  ...
  const availableQuestions = isPremium ? g5LaDiff3Questions : g5LaDiff3Questions.slice(0, FREE_QUESTION_LIMIT)
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-200 shadow-lg">
          <CardHeader className="bg-blue-50 text-center">
            ...
            <CardTitle className="text-2xl text-blue-800">Language Arts Difficult 3</CardTitle>
      ...
      <header className="bg-blue-800 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div><h1 className="text-lg font-bold">Language Arts Difficult 3</h1><p className="text-blue-100 text-xs">Question {currentQuestion + 1} of {totalQuestions}</p></div>
          </div>
