...
const g5LaMod10Questions: Question[] = [
  {
    id: 1,
    type: "reading",
    skill: "Inference",
...
"Non-communicable diseases — including hypertension, diabetes, and heart disease — are responsible for approximately seventy percent of deaths in Jamaica each year. Unlike infectious diseases, they cannot be passed between people, but they can be prevented or managed through lifestyle choices. Research consistently shows that regular physical activity, a balanced diet rich in local fruits and vegetables, adequate sleep, and the management of stress significantly reduce a person's risk of developing these conditions. Yet despite this knowledge, many Jamaicans struggle to maintain healthy habits, often citing the pressures of work, financial constraints, and limited access to healthcare. Public health experts argue that solving this crisis requires not just individual effort but structural change — making healthy choices easier and more affordable for everyone."
...
What does the passage IMPLY about the importance of this topic to Jamaican society?`,
  ...
  },
  {
    ...
    question: `In the passage about health and non-communicable diseases, the writer uses extended description to suggest that:`,
    options: [
      "The topic is boring",
...
export default function G5LaMod10MockTest() {
  ...
  const availableQuestions = isPremium ? g5LaMod10Questions : g5LaMod10Questions.slice(0, FREE_QUESTION_LIMIT)
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-200 shadow-lg">
          <CardHeader className="bg-blue-50 text-center">
            ...
            <CardTitle className="text-2xl text-blue-800">Language Arts Moderate 10</CardTitle>
      ...
      <header className="bg-blue-800 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div><h1 className="text-lg font-bold">Language Arts Moderate 10</h1><p className="text-blue-100 text-xs">Question {currentQuestion + 1} of {totalQuestions}</p></div>
          </div>
