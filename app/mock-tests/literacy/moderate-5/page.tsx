...
const g5LaMod5Questions: Question[] = [
  {
    id: 1,
    type: "reading",
    skill: "Inference",
...
"Every Saturday morning, the Coronation Market in Kingston transforms into a living spectacle of colour, sound, and humanity. Vendors arrive before dawn to secure the best spots, arranging towers of yam, dasheen, plantain, and callaloo with artistic precision. Mothers bargain with practiced confidence; children weave between market carts; and the smell of fried food mingles with the sharp perfume of scotch bonnet pepper. Yet beneath the vibrant surface, the market tells a deeper story. For many vendors, this Saturday income is the difference between paying school fees or going without, between buying medicine or hoping illness passes. The market is not just commerce — it is resilience, community, and survival, wrapped in colour and noise."
...
What does the passage IMPLY about the importance of this topic to Jamaican society?`,
  ...
  },
  {
    ...
    question: `In the passage about the Jamaican market, the writer uses extended description to suggest that:`,
    options: [
      "The topic is boring",
...
export default function G5LaMod5MockTest() {
  ...
  const availableQuestions = isPremium ? g5LaMod5Questions : g5LaMod5Questions.slice(0, FREE_QUESTION_LIMIT)
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-blue-200 shadow-lg">
          <CardHeader className="bg-blue-50 text-center">
            ...
            <CardTitle className="text-2xl text-blue-800">Language Arts Moderate 5</CardTitle>
      ...
      <header className="bg-blue-800 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div><h1 className="text-lg font-bold">Language Arts Moderate 5</h1><p className="text-blue-100 text-xs">Question {currentQuestion + 1} of {totalQuestions}</p></div>
          </div>
