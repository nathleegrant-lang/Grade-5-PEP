...
const g5SsMod2Questions: Question[] = [
  {
    id: 1,
    type: "history",
    skill: "Cause & Effect",
    question: `WHAT caused the British to change Jamaica's status from a self-governing colony to a Crown Colony after 1865?`,
    options: [
      "The Maroon Peace Treaties",
      "The abolition of slavery",
      "The Morant Bay Rebellion forced Britain to take direct control, ostensibly to restore order and implement reforms",
      "Marcus Garvey's activism",
    ],
    correctAnswer: 2,
    explanation: `The rebellion's violence and the execution of Gordon (a legislator) shocked Britain. Changing to Crown Colony rule allowed direct British management — a setback for Jamaican self-governance.`
  },
  {
    id: 2,
    type: "history",
    skill: "Analysis",
    question: `WHY is Nanny of the Maroons described as a military genius?`,
    options: [
      "She owned the most land in Jamaica",
      "She was the first woman to lead Jamaicans",
      "She used guerrilla warfare tactics in the mountains — using superior knowledge of the terrain to defeat much larger British forces",
      "She negotiated the best treaty terms",
    ],
    correctAnswer: 2,
    explanation: `Nanny's Windward Maroons used the Blue Mountains to their advantage — ambushing British soldiers in narrow passes, retreating into the forest, and maintaining freedom for decades.`
  },
  {
    id: 3,
    type: "history",
  ...
  },
  {
    ...
    type: "history",
    skill: "Impact",
    question: `HOW did Universal Adult Suffrage in 1944 change Jamaican politics?`,
    options: [
      "It gave only men the right to vote",
      "It had no impact on political participation",
      "For the first time, ALL adult Jamaicans could vote — giving ordinary poor people real political power and transforming the political landscape",
      "It only changed which party was in power",
    ],
    correctAnswer: 2,
    explanation: `Before 1944, only those who met property and literacy requirements could vote. Universal suffrage democratised politics — mass political parties and grassroots campaigning became essential.`
  },
  {
    id: 5,
    type: "history",
    skill: "Evaluating Significance",
    question: `Which of the following BEST explains WHY Jamaicans celebrate August 1 as Emancipation Day?`,
    options: [
      "Because it is a public holiday with no school",
      "Because it commemorates the end of legal slavery — one of the most significant moments in Jamaica's history — and honours the resilience of African Jamaicans",
      "Because Jamaica won independence on that date",
      "Because Bustamante was born on August 1",
    ],
    correctAnswer: 1,
    explanation: `August 1, 1838, was the moment full freedom from slavery came — after centuries of brutal exploitation. It is remembered not just as a date but as a symbol of survival and resistance.`
  },
  {
    id: 6,
    type: "history",
    skill: "Cultural Continuity",
    question: `How does the ANANSI storytelling tradition connect Jamaica to its AFRICAN heritage?`,
    options: [
      "Anansi stories were created in Jamaica",
      "They were invented by the British",
      "Anansi originated in Akan (Ghanaian) culture and was brought to Jamaica by enslaved Africans — surviving as a cultural thread connecting Jamaica to West Africa",
      "Anansi stories only exist in Jamaica",
    ],
    correctAnswer: 2,
    explanation: `The spider trickster figure is rooted in Akan mythology — its survival in Jamaican culture represents the resilience of African cultural identity under slavery and colonialism.`
  },
  {
    id: 7,
    type: "history",
    skill: "Cause & Effect",
    question: `What was the EFFECT of the abolition of the slave trade in 1807 on Jamaica's enslaved population?`,
    options: [
      "All enslaved people were freed in 1807",
      "No enslaved people could be brought to Jamaica after 1807 — but those already enslaved remained so, and conditions sometimes worsened as planters sought to extract more from existing workers",
      "Slavery ended immediately",
      "Planters immediately began freeing enslaved people",
    ],
    correctAnswer: 1,
    explanation: `The 1807 act stopped the transatlantic trade but did not end slavery itself — those already enslaved remained so, sometimes under harsher conditions as planters could no longer replace those who died.`
  },
  {
    id: 8,
    type: "history",
    skill: "Comparing Leaders",
    question: `What do Norman Manley and Alexander Bustamante have in common, despite being political rivals?`,
    options: [
      "They founded the same party",
      "They agreed on all political issues",
      "Both made extraordinary contributions to Jamaican independence and workers' rights — they were cousins who built the two dominant political parties",
      "They both served as Prime Minister for the same length of time",
    ],
    correctAnswer: 2,
    explanation: `Despite bitter rivalry, both Manley (PNP) and Bustamante (JLP) are recognised as National Heroes — their combined efforts built Jamaica's democratic political system and independence.`
  },
  {
    id: 9,
    type: "history",
    skill: "Historical Thinking",
    question: `A historian argues that 'colonialism was economically beneficial for Jamaica.' Which evidence BEST challenges this claim?`,
    options: [
      "Jamaica has beautiful beaches",
      "Jamaica has a large diaspora",
      "Wealth from Jamaican sugar plantations went almost entirely to British planters and merchants — Jamaicans (especially enslaved people) received no economic benefit",
      "Sugar is still produced in Jamaica",
    ],
    correctAnswer: 2,
    explanation: `The colonial economy was extractive — designed to benefit the metropole. Jamaica's workers were unpaid (enslaved) or underpaid, and profits left the island. This directly challenges the 'beneficial' claim.`
  },
  {
    id: 10,
    type: "history",
    skill: "Legacy",
    question: `How does Jamaica's national motto 'Out of Many, One People' reflect the country's HISTORY?`,
    options: [
      "It reflects Jamaica's geography",
      "It suggests Jamaica has only one ethnic group",
      "It acknowledges the diverse ethnic origins — African, European, East Indian, Chinese, Taino — of the Jamaican people, united under one national identity",
      "It means Jamaica has one political party",
    ],
    correctAnswer: 2,
    explanation: `The motto directly references Jamaica's multicultural heritage — the product of colonialism, the slave trade, indentureship, and migration — transformed into a source of national pride and unity.`
  },
  {
    id: 11,
    type: "geography",
...
export default function G5SsMod2MockTest() {
      ...
      <main className="container mx-auto px-4 py-10">
        ...
        <Card className="mx-auto max-w-3xl border-green-200 shadow-lg">
          <CardHeader className="bg-green-50 text-center">
            ...
            <CardTitle className="text-2xl text-green-800">Social Studies Moderate 2</CardTitle>
        ...
        <main className="container mx-auto px-4 py-10">
          <Card className="mx-auto max-w-4xl border-green-200 shadow-lg">
            <CardHeader className="bg-green-50 text-center">
              ...
              <p className="text-slate-600">Social Studies Moderate 2</p>
            </CardHeader>
            <CardContent className="space-y-6 p-6">
      ...
      <header className="bg-green-800 text-white sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div><h1 className="text-lg font-bold">Social Studies Moderate 2</h1><p className="text-green-100 text-xs">Question {currentQuestion + 1} of {totalQuestions}</p></div>
          </div>
